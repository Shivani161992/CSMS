...
public partial class Admin_Expire_RO_Details : System.Web.UI.Page
{
    ...
    void fillgrid()
    {
        ...
        string qry = "SELECT RO_of_FCI.*,districtsmp.district_name from dbo.RO_of_FCI left join pds.districtsmp on RO_of_FCI.Distt_Id=districtsmp.district_code   where RO_of_FCI.IsExpire='Y'";
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string disid = GridView1.SelectedRow.Cells[0].Text;
     
        string distname = GridView1.SelectedRow.Cells[1].Text;
        string rono = GridView1.SelectedRow.Cells[2].Text;
        Session["disid"] = disid;
        Session["distname"] =distname;
        Session["rono"] = rono;
        Response.Redirect("../Admin/UpdateValidity.aspx");
    }
