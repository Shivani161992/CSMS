...
Partial Class Agency_RO_AllotLift_HO
...
#End Region
    ...
    Private Sub get_Data(ByVal Month As String, ByVal Year As String)
        ...
        ' For Report
        If ReportViewer1.ServerReport.ReportPath = folder & "RO_Graph_Region" Then
    ...
    Protected Sub LinkButton1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LinkButton1.Click
        ...
        If ReportViewer1.ServerReport.ReportPath = folder & "RO_Graph_Region" Then
            ReportViewer1.PerformBack()
        Else
            Response.Redirect("~/Agency/frmReports.aspx")
