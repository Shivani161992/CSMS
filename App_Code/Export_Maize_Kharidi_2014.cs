...
[WebService(Namespace = "http://microsoft.co.in/", Name = "Export_Maize_Kharidi_2014", Description = "Export Data from Offline Software to online database (upload data on server)/Date:15/10/2014")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]


public class Export_Maize_Kharidi_2014 : System.Web.Services.WebService {
   ...
   private SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Appconstr_MPMS2014_15"].ToString());
    ...
    string Query = "";
    public Export_Maize_Kharidi_2014()
    {
    ...
    public sec_Maize_Export_Kharidi_2014 sec_Maize_Export_Kharidi_2014;
    [SoapHeader("sec_Maize_Export_Kharidi_2014")]
    [WebMethod(Description = "This Method Is Used For Security Check in")]
    public bool chkSecurityExport(sec_Maize_Export_Kharidi_2014 S)
    {
        bool rtev = false;
        try
        {
...
public class sec_Maize_Export_Kharidi_2014 : System.Web.Services.Protocols.SoapHeader
{
