...
[WebService(Namespace = "http://microsoft.co.in/", Name = "Export_Wheat_Kharidi_2014_NewFT", Description = "Export Data from Offline Software to online database (upload data on server)/Date:28/05/2014")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]


public class Export_Wht_Kharidi_2014_NewFT : System.Web.Services.WebService 
{
    ...
    string Query = "";
    public Export_Wht_Kharidi_2014_NewFT () {
    ...
    public sec_Wheat_Export_Kharidi_2014_New sec_Wheat_Export_Kharidi_2014_New;
    [SoapHeader("sec_Wheat_Export_Kharidi_2014_New")]
    [WebMethod(Description = "This Method Is Used For Security Check in")]
    public bool chkSecurityExport(sec_Wheat_Export_Kharidi_2014_New S)
    {
        bool rtev = false;
        try
        {
                ...
                if (dsCommodityReceipt.Tables[0].Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dsCommodityReceipt.Tables[0].Rows)
                    {
                        ...
                        try
                        {
                            ...
                            string Society_Id = dr["Society_Id"].ToString();
                            //2805
                            if (District_Id == "2301" || District_Id == "2323" || District_Id == "2325" || District_Id == "2312" || District_Id == "2315" || District_Id == "2350" || District_Id == "2345")
                            {
                                Query = "select count(*) from CommodityReceivedFromFarmerAfter28052014 where District_Id='" + District_Id + "'  and  Society_Id='" + Society_Id + "' and Farmer_Id= '" + Farmer_Id + "' and ReceivedID='" + ReceivedID + "'";
                                cmd = new SqlCommand(Query, connection, trans);
                                Int64 res = Convert.ToInt64(cmd.ExecuteScalar());
                                cmd.Dispose();
                                if (res <= 0)
                                {
                                    ...
                                    cmd.CommandType = CommandType.StoredProcedure;
                                    cmd.CommandText = "Proc_InsertCommodityReceivedFromFarmerAfter28052014";
...
public class sec_Wheat_Export_Kharidi_2014_New : System.Web.Services.Protocols.SoapHeader
{
