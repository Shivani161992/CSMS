...
public class FRDataMaize2013 : System.Web.Services.WebService
{
    private SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["con_Proc_online_MPMS2013"].ToString());
    private SqlCommand command;
    public SecuredWebServiceHeader spAHeader;
    public FRDataMaize2013()
    {
    ...
    public DataSet GetFRData_FarmerRegistration(string dcode, string SCode)
    {
        ...
        try
        {
            if (con != null)
            {
                ...
                command.CommandText = "GetFRData_FarmerRegistration";
    ...
    public DataSet GetFRData_LandRecord(string dcode, string SCode)
    {
        ...
        try
        {
            if (con != null)
            {
                ...
                command.CommandType = CommandType.StoredProcedure;
                command.Connection = con;
                command.CommandText = "GetFRData_Farmer_LandRecordDescription";
                command.Parameters.AddWithValue("@District_Id", dcode.ToString());
                command.Parameters.AddWithValue("@Procured_SocietyID", SCode.ToString());
