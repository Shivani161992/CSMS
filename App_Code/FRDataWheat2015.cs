...
using System.Configuration;
 //<summary>
//Summary description for FRDataWheat2015
 //</summary>
[WebService(Namespace = "http://tempuri.org/", Name = "FRDataWheat2015", Description = "FRData For WPMS 2015-16,Date:08/01/2015")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
public class FRDataWheat2015 : System.Web.Services.WebService
{
    private  SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["con_Proc_online_WPMS2015"].ToString());
    private  SqlCommand command;
    public   SecuredWebServiceHeader spAHeader;
    
    public FRDataWheat2015 () {

        //Uncomment the following line if using designed components 
        //InitializeComponent(); 
    }
    [WebMethod]
    public DataSet GetFRData2015_FarmerRegLandRecord(string dcode, string SCode)
    {
    ...
    public DataSet Get_Society(string Did)
    {
        ...
        try
        {
            if (con != null)
            {
                ...
                command.Connection = con;
                command.CommandText = "Get_Society2015";
