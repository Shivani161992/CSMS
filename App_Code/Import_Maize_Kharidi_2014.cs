...
[WebService(Namespace = "http://microsoft.co.in/", Name = "Import_Maize_Kharidi_2014", Description = "Import Data from Offline Software to Online Database (upload data on server)/Date: 15/10/2014")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]

public class Import_Maize_Kharidi_2014 : System.Web.Services.WebService {

    public SqlConnection conware = new SqlConnection(ConfigurationManager.ConnectionStrings["connstorage"].ToString());
    private SqlConnection connection = new SqlConnection(ConfigurationManager.AppSettings["Appconstr_MPMS2014_15"].ToString());
    ...
    public Import_Maize_Kharidi_2014 () {
    ...
    public sec_Maize_Kharidi_2014 sec_Maize_Kharidi_2014;
    [SoapHeader("sec_Maize_Kharidi_2014")]

    [WebMethod(Description = "This Method Is Used For Security Check in")]
    public bool chkSecurityImport(sec_Maize_Kharidi_2014 S)
    {
        bool rtev = false;
        try
        {
    ...
    public DataSet OpSocietyLoan(string districtid, string societyid, string farmerids)
    {
        ...
        try
        {
            ...
            cmd.Parameters.Clear();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from SocietyLoanOfFarmer where  District_Id='" + districtid + "' and PC_ID='" + societyid + "'";
            dataAdapter = new SqlDataAdapter(cmd);
            dataAdapter.Fill(dataset);
            cmd.Dispose();
            trans.Commit();
    ...
    public DataSet OpDCCBLoan(string districtid, string dccbloanids)
    {
        ...
        try
        {
            ...
            cmd.Parameters.Clear();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from DCCBLoanOfFarmer where District_Id ='" + districtid + "' and Farmer_Id in (select Farmer_Id from FarmerRegistration where Procured_SocietyID='" + dccbloanids + "')";
            dataAdapter = new SqlDataAdapter(cmd);
            dataAdapter.Fill(dataset);
            cmd.Dispose();
            trans.Commit();
    ...
    public DataSet OpIrrigationLoan(string districtid, string irriloafarmerids)
    {
        ...
        try
        {
            ...
            cmd.Parameters.Clear();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from IrrLoanOfFarmer where IrrLoanOfFarmer.District_Id='" + districtid + "' and Farmer_Id in (select Farmer_Id from FarmerRegistration where Procured_SocietyID='" + irriloafarmerids + "')";
            dataAdapter = new SqlDataAdapter(cmd);
            dataAdapter.Fill(dataset);
            cmd.Dispose();
            trans.Commit();
    ...
    [WebMethod(Description = "This Method Is Used For Transport Truck number for offline database ")]
    public DataSet OpTransportTruckNO(string districtid, string societyid)
    {
        dataset = new DataSet();
        try
        {
            ...
            cmd.Parameters.Clear();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from View_TransportTruckInfo where  View_TransportTruckInfo.SocietyCode='" + societyid + "'";
            dataAdapter = new SqlDataAdapter(cmd);
            dataAdapter.Fill(dataset);
            cmd.Dispose();
            trans.Commit();
    ...
    [WebMethod(Description = "This Method Is Used For check Farmer Registration Noline ")]
    public DataSet OP_New_Farmer_Basic_Info(string D, string S, string F_IDS)
    {
        dataset = new DataSet();
        try
        {
            ...
            cmd.Parameters.Clear();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from FarmerRegistration where FarmerRegistration.District_Id='" + D + "' and FarmerRegistration.Procured_SocietyID='" + S + "' and FarmerRegistration.Farmer_Id Not IN (" + F_IDS + ")";
            dataAdapter = new SqlDataAdapter(cmd);
            dataAdapter.Fill(dataset);
            cmd.Dispose();
            trans.Commit();
    ...
    [WebMethod(Description = "This Method Is Used For Check Farmer Land Rc Noline ")]
    public DataSet OP_New_Farmer_Land_Info(string D, string S, string F_IDS)
    {
        dataset = new DataSet();
        try
        {
            ...
            cmd.Parameters.Clear();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "SELECT Farmer_LandRecordDescription.* from   Farmer_LandRecordDescription  inner join FarmerRegistration on FarmerRegistration.Farmer_Id=Farmer_LandRecordDescription.Farmer_Id  where  District_Id='" + D + "' and Procured_SocietyID ='" + S + "' and Farmer_LandRecordDescription.TransID Not IN (" + F_IDS + ")";
            dataAdapter = new SqlDataAdapter(cmd);
            dataAdapter.Fill(dataset);
            cmd.Dispose();
            trans.Commit();
...
public class sec_Maize_Kharidi_2014 : System.Web.Services.Protocols.SoapHeader
{
