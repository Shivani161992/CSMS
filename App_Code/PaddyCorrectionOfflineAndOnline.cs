...
/// <summary>
/// Summary description for PaddyCorrectionOfflineAndOnline
/// </summary>
[WebService(Namespace = "http://tempuri.org/", Name = "PaddyCorrectionOfflineAndOnline", Description = "PaddyCorrectionOfflineAndOnline Date:27/11/2014")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
// [System.Web.Script.Services.ScriptService]
public class PaddyCorrectionOfflineAndOnline : System.Web.Services.WebService {

    private SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["con_Proc_online_PPMS2014"].ToString());
    private SqlCommand command;
    public SecuredWebServiceHeader spAHeader;
    public PaddyCorrectionOfflineAndOnline()
    {
    ...
    public int Pro_Correc_Update_IssueToSangrahanaKendra(string District_Id, string Society_Id, string IssueID, string Bags, string QtyTransffer, string DateOfIssue, string TaulPtrakNo, string TransporterId, string TruckChalanNo, string TruckNo, string DriverName,string UpdatedDate, string UpdatedBy, string UserId)
    {
        ...
        try
        {
            if (con != null)
            {
                ...
                command.CommandText = "update IssueToSangrahanaKendra set Bags='" + Bags + "',QtyTransffer='" + QtyTransffer + "' ,DateOfIssue ='" + getDate_YMd(DateOfIssue) + "' ,TaulPtrakNo='" + TaulPtrakNo + "',  TransporterId='" + TransporterId + "',TruckNo='" + TruckNo + "',DriverName='" + DriverName + "' ,UpdatedDate =getDate(), UpdatedBy='" + UpdatedBy + "' , UserId='" + UserId + "' where  DistrictId='" + District_Id + "' and SocietyId='" + Society_Id + "' and IssueID='" + IssueID + "'";
                command.CommandTimeout = 0;
                res = command.ExecuteNonQuery();
                trans.Commit();
                command.Dispose();
    ...
    [WebMethod]
    public bool Check_PaidReceivedID(string District_Id, string Society_Id, string ReceivedID)
    {
        bool chkRid = false;
        try
        {
            if (con != null)
            {
                ...
                command.CommandType = CommandType.Text;
                command.Connection = con;
                command.CommandText = "select count(ReceivedID) from TBL_R_PaidToFarmer where District_Id ='" + District_Id.ToString() + "' and Society_Id='" + Society_Id.ToString() + "' and ReceivedID='" + ReceivedID + "'";
                command.CommandTimeout = 0;
                string res = command.ExecuteScalar().ToString();
                command.Dispose();
                if (Convert.ToInt32(res) > 0)
    ...
    [WebMethod]
    public int Pro_Correc_Update_PaidToFarmer(string District_ID, string Society_Id, string ReceivedID, string PaidToFarmer, string PaidDate, string CheckNumber, string localip)
    {
        int res = 0, res1 = 0;
        SqlTransaction trans = null;
        try
        {
            if (con != null)
            {
                ...
                command.Connection = con;
                command.CommandText = "";
                command.CommandText = "insert into TBL_R_PaidToFarmer_log  select * from  TBL_R_PaidToFarmer  where  District_ID='" + District_ID + "' and Society_Id='" + Society_Id + "' and ReceivedID='" + ReceivedID + "'";
                command.CommandTimeout = 0;
                res1 = command.ExecuteNonQuery();

                command.CommandText = "";
                command.CommandText = "update  TBL_R_PaidToFarmer set PaidToFarmer='" + PaidToFarmer + "' , PaidDate='" + getDate_YMd(PaidDate) + "' , CheckNumber='" + CheckNumber + "' , Date_Of_Updation=getdate() ,UserId='"+localip+"'  where  District_ID='" + District_ID + "' and Society_Id='" + Society_Id + "' and ReceivedID='" + ReceivedID + "' ";
    ...
    [WebMethod]
    public int Pro_Correc_Delete_PaidToFarmer(string District_ID, string Society_Id, string ReceivedID, string localip)
    {
        int res = 0, res1 = 0;
        SqlTransaction trans = null;
        try
        {
            if (con != null)
            {
                ...
                command.Connection = con;
                command.CommandText = "";
                command.CommandText = "insert into Del_TBL_R_PaidToFarmer_log  SELECT [Id] ,[District_Id] ,[Society_Id] ,[ReceivedID] ,[FarmerId]  ,[PaidToFarmer] ,[PaidDate ,[Date_Of_Creation] ,GETDATE(),[UserId],[CheckNumber] ,'" + localip + "'  FROM [TBL_R_PaidToFarmer] where  District_ID='" + District_ID + "' and Society_Id='" + Society_Id + "' and ReceivedID='" + ReceivedID + "' ";
                command.CommandTimeout = 0;
                res1 = command.ExecuteNonQuery();
                ...
                command.CommandType = CommandType.Text;
                command.CommandText = "";
                command.CommandText = "delete from TBL_R_PaidToFarmer where  District_ID='" + District_ID + "' and Society_Id='" + Society_Id + "' and ReceivedID='" + ReceivedID + "' ";
                res = command.ExecuteNonQuery();
                trans.Commit();
                command.Dispose();
