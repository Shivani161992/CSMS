<%@ Page Title="" Language="C#" MasterPageFile="~/CSMSSurveyorLogin/Godown_SurveyorMaster.master" AutoEventWireup="true" CodeFile="GodownSurveyor_ChangePassword.aspx.cs" Inherits="CSMSSurveyorLogin_GodownSurveyor_ChangePassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <table style="width: 100%; font-size: 12px;">
            <tr>
                ...
                <td style="text-align: right; width: 10%">
                    <a href="GodownSurveyor_ChangePassword.aspx" class="sign">&#8635 New
                    </a>
                </td>
            </tr>
        </table>
     ...
     <div class="Box">
         ...
         <h2 style="color:#e67e22; font-size: 20px; font-family: 'Bellefair'; letter-spacing: 4px; text-decoration-style: wavy; text-align:center;">Change Password</h2>
