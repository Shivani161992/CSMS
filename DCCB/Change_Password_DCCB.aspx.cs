...
public partial class DCCB_Change_Password_DCCB : System.Web.UI.Page
{
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
        ...
        string qry = "SELECT Password FROM dbo.DCCB_Login where District_ID='" + distid + "'";
        ...
        else
        {
            ...
            if (mpwd == moldpwd)
            {
                ...
                string qryupdate = "Update  dbo.DCCB_Login set Password='" + mnewpwd + "' where District_ID='" + distid + "'";
                string qryins = "Insert into  dbo.Login_MP_Log(Login_ID,Password,updated_By,updated_date,HostName,DynamicIP,UserAgent,Role)values('" + distid + "','" + mnewpwd + "','" + ip + "',getdate(),'" + HostName + "','" + addr[0].ToString() + "','" + useragent + "','DCCB')";
                cmd.Connection = con;
