<%@ Page Language="C#" MasterPageFile="~/MasterPage/DCCB_Master.master" AutoEventWireup="true" CodeFile="dccb_permit.aspx.cs" Inherits="District_dccb_permit" Title="DCCB Permit" %>
				...
				'controlname': 'ctl00_ContentPlaceHolder1_tx_permit_date'
                        ...
                        <tr>
                            ...
                            <td style="width: 140px; font-size: 10pt; color: red; position: static;" align="left">
                                <asp:TextBox ID="tx_do_no" runat="server" Width="125px" MaxLength="15" Visible="False"></asp:TextBox>*</td>
	...
	new tcal ({
				...
				'controlname': 'ctl00_ContentPlaceHolder1_tx_do_date'
                            ...
                            <td style="width: 113px; font-size: 10pt; color: red;" align="left">
                                <asp:TextBox ID="tx_do_validity" runat="server" Width="95px" MaxLength="2" Visible="False"></asp:TextBox>*</td>
                        ...
                        <tr>
                            ...
                            <td colspan="6" style="font-size: 10pt; background-color: #ffcccc;" align="left">
                                <asp:DropDownList ID="ddl_fps_name" runat="server" Font-Names="DVBW-TTYogeshEN" Width="304px" Font-Size="Medium" AutoPostBack="True" OnSelectedIndexChanged="ddl_fps_name_SelectedIndexChanged">
                        ...
                        <tr>
                            <td align="left" colspan="7" style="font-size: 10pt; background-color: #ffcccc;">
                                Total Quantity
                    ...
                    <table style="width: 688px">
                        <tr>
                            <td style="font-size: 10pt; color: black; height: 27px;" align="left">
                                Payment Mode</td>
                            <td style="font-size: 10pt; height: 27px; color: black;" align="left"><asp:DropDownList ID="ddl_pmode" runat="server" Width="104px" AutoPostBack="True" OnSelectedIndexChanged="ddl_pmode_SelectedIndexChanged">
