<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SCSC_master.master" AutoEventWireup="true" CodeFile="DeleteProcAcpt_DistHome.aspx.cs" Inherits="District_DeleteProcAcpt_DistHome" %>
                ...
                <table style="background-color: #cfdcdc; border-right: navy 1px double; border-top: navy 1px double; font-size: 10pt; border-left: navy 1px double; border-bottom: navy 1px double; position: static;" border="1" cellpadding="0" cellspacing="0">
                    <tr>
                        <td colspan="2" style="color: #0066ff; font-style: italic; height: 36px; background-color: lightslategray;">
                            <asp:Label ID="lbldotype" runat="server" Text="Please select Commodity For Delete Acceptance Note Procurement" Font-Size="14px" Font-Bold="True" Font-Italic="True" ForeColor="White"></asp:Label></td>
                    </tr>
                    <tr>
