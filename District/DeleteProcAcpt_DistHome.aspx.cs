...
public partial class District_DeleteProcAcpt_DistHome : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void btnok_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("~/District/DelAcceptance.aspx");
        }
        else if (ddlcomdty.SelectedValue.ToString() != "28") //Kharif 2016
        {
            Response.Redirect("~/District/DelProcAcpt_Kharif2016.aspx");
        }
    }
}