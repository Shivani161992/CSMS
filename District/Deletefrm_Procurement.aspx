<%@ Page Language="C#" MasterPageFile="~/MasterPage/SCSC_master.master" AutoEventWireup="true" CodeFile="Deletefrm_Procurement.aspx.cs" Inherits="District_Deletefrm_Procurement" Title="Untitled Page" %>
 ...
 <center>
    <table style="width: 740px; height: 420px; border-right: black thin groove; border-top: black thin groove; border-left: black thin groove; border-bottom: black thin groove;">
        ...
        <tr>
            ...
            <td style="height: 1px; border-right: black thin groove; border-bottom: black thin groove;" colspan="2">
                <asp:DropDownList ID="ddlissuecenter" runat="server" Width="166px">
                </asp:DropDownList></td>
        </tr>
        <tr>
