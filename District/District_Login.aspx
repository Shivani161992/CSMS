<%@ Page Language="C#" AutoEventWireup="true" CodeFile="District_Login.aspx.cs" Inherits="District_District_Login" %>
...
<head runat="server">
    ...
    <style>
        ...
        .DistLoginMenutable
        {
            ...
            border-radius: 32px;
            background: linear-gradient(#2c3e50, yellow, #2c3e50);
            font-family: 'Bellefair';
            letter-spacing: 2px;
        }
...
<body>
        ...
        <div>
            <center>
                  <table class="DistLoginheader">
                                    <tr>
                        <td style="height:10px; width:30%; text-align:left; font-size:12px;">
                            <a href="Dist_Welcome.aspx" class="sign">&#9754 Back
                    </a>
                          
                        </td>
                        <td style="height:10px;  width:40%; text-align:center; font-size:12px;">
                           
                        </td>
                        <td style="height:10px;  width:30%; text-align:right; font-size:12px;">
...
&nbsp;Madhya Pradesh State Civil Supplies Corporation Ltd. </td>
        ...
        <div class="box">
            <h2 style="color: #e74c3c; font-size: 50px; font-family: sans-serif; letter-spacing: 4px;">Login</h2>
            <form runat="server" id="form2">
                <div class="inputBox">
                    <asp:TextBox ID="txtuser" runat="server" CssClass="txt" AutoComplete="off" enabled="false"></asp:TextBox>
                    <%-- <label id="lbluser" class="lbl">Username</label>--%>
                    <asp:Label runat="server" Text="Label" ID="lbluser" class="lbl lbluser"> Username</asp:Label>
            ...
            <asp:Button ID="bttsub" runat="server" Text="Button" CssClass="bttsub" OnClick="bttsub_Click" />
                 </center>
            </form>
        </div>
