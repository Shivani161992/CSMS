    ...
    public void GetDeliveryChallan()
    {
        ...
        using (con = new SqlConnection(strcon))
        {
            try
            {
                ...
                string select = "Select DC_MO,REPLACE(CONVERT(NVARCHAR,CreatedDate, 111), '/', '-') + ' ' + CONVERT(varchar(35),CreatedDate,114) As CreatedDate From DeliveryChallan_MO where ModeofDispatch='12' and FrmDist='" + Dist_Id + "'  and (IsReceived='N' and ((DATEADD(DAY,250,CreatedDate))>=Getdate())) and CreatedDate>='2015-10-1' and DC_MO NOT IN (Select challan_no From tbl_Receipt_Details where Dist_Id='" + Dist_Id + "' and S_of_arrival='02' and challan_no LIKE 'MORD%') and DC_MO NOT IN (Select DC_MO From DivertRecieved_MO where  DC_MO LIKE 'MORD%') order by DC_MO";
                            ...
                            if (ViewState["hdfModeofDispatch"].ToString() == "12") //Received By Road
                            {
                                ...
                                else
                                {
                                    ...
                                    //instr += "Insert Into [DivertRecieved_MO]([MoveOrdernum],[DivMoveOrdernum],[DC_No],[DC_MO],[ReceiptID],[Div_RecDistrict],[Div_RecBranch],[Div_RecGodown],[Div_RecIssue_Center],[Div_RecDate],[IP]) values('" + txtMONo.Text + "','" + lblMovmentNumber.Text + "', '" + ViewState["hdfDC_No"].ToString() + "','" + ddlChallanNo.SelectedItem.ToString() + "','" + ReceivedRecptID + "','" + ddldistrict.SelectedItem.Text + "','" + ddlBranch.SelectedItem.Text + "','" + ddlGodown.SelectedItem.Text + "','" + ddlIssueCentre.SelectedItem.Text + "','" + IssuedDate + "','" + GetIp + "')";
                                     "Insert Into [DivertRecieved_MO]([MoveOrdernum],[DivMoveOrdernum],[SMO],[TO_No],[DC_No],[Transporter_ID],[FrmDist],[ToDist],[Commodity],[CropYear],[TOEndDate],[ModeofDispatch],[DC_MO],[ReceiptID],[SendingIssue_Center],[SendingBranch],[SendingGodown],[SendingQty],[SendingBags],[SendingDate],[SendingBags_Type],[SendingTruck_No],[Div_RecDistrict],[Div_RecBranch],[Div_RecGodown],[Div_RecIssue_Center],[Div_RecDate],[IP]) values('" + txtMONo.Text + "','" + lblMovmentNumber.Text + "','" + ViewState["hdfSMO"].ToString() + "','" + txtTONo.Text + "','" + ViewState["hdfDC_No"].ToString() + "','" + ViewState["hdfTransporter_ID"].ToString() + "','" + ViewState["hdfFrmDist"].ToString() + "','" + ViewState["hdfToDist"] + "','" + ViewState["hdfCommodity"].ToString() + "','" + txtCropYear.Text + "','" + ViewState["hdfTOEndDate"].ToString() + "','" + ViewState["hdfModeofDispatch"].ToString() + "','" + ddlChallanNo.SelectedItem.ToString() + "','" + ReceivedRecptID + "','" + ViewState["hdfSendIssue_Center"].ToString() + "','" + strSendChange_Branch + "','" + strSendChange_Godown + "','" + SendQty + "','" + txtSendBags.Text + "','" + ViewState["hdfTranspDate"].ToString() + "','" + hdfBagsType.Value + "','" + txtTruckNo.Text + "','" + ddldistrict.SelectedValue.ToString() + "','" + ddlBranch.SelectedValue.ToString() + "','" + ddlGodown.SelectedValue.ToString() + "','" + ddlIssueCentre.SelectedValue.ToString() + "','" + IssuedDate + "','" + GetIp + "')";
                                    instr += "update DeliveryChallan_MO set IsDiverted='Y', ToDist='" + ddldistrict.SelectedValue.ToString() + "' ,RecIC='" + ddlIssueCentre.SelectedValue.ToString() + "', RecBranch='" + ddlBranch.SelectedValue.ToString() + "', RecGodown='" + ddlGodown.SelectedValue.ToString() + "' where DC_MO='" + ddlChallanNo.SelectedItem.Text + "'";
                                   
                                    instr += "update DeliveryChallan_MO_WODiv set IsDiverted='Y' where DC_MO='" + ddlChallanNo.SelectedItem.Text + "'";
