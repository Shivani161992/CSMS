...
public partial class District_Doorstep_Transporter : System.Web.UI.Page
{
 ...
 public SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
        ...
        if (txtmobile.Text == "")
        {
            Page.RegisterClientScriptBlock("mymsg1", "<script language=javascript> alert('Please enter mobile no.'); </script> ");
        }
        if (txttadd.Text == "")
        {
            Page.RegisterClientScriptBlock("mymsg1", "<script language=javascript> alert('Please Enter Address'); </script> ");
        }
        if (txtrate.Text == "")
        {
            Page.RegisterClientScriptBlock("mymsg1", "<script language=javascript> alert('Please Enter rate pe qtls'); </script> ");
        }
        ...
        else
        {
            ...
            // Change here because this is visible false at runtime and default value goes to 0
               ...
               // Change after edit, previously dropdown of Transporter type value inserted (anurag 28-10-2013)
                ...
                string qry = "insert into dbo.Transporter_Table (State_Id,Distt_ID,Transporter_ID,Transporter_Name,Address,MobileNo,Transport_ID,Lead,Quantity,Rate,Valid_Upto,Created_Date,IsActive,fps_Block,IP,OperatorID) values('" + state + "','" + sid + "','" + gatepass + "','" + mtname + "','" + madd + "','" + mobile + "','7','" + mlead + "',''," + rate + ",'" + validuoto + "',getdate(),'" + isactive + "','" + block + "','" + ip + "','" + opid + "')";
                cmd.CommandText = qry;
                cmd.Connection = con;
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //GridView1.SelectedRow.BackColor = System.Drawing.Color.CadetBlue ;
        DaintyDate1.Text = GridView1.SelectedRow.Cells[6].Text.Trim();
        txttname.BackColor = System.Drawing.Color.Wheat;
        tname=GridView1.SelectedRow.Cells [2].Text.Trim();
        tid = GridView1.SelectedRow.Cells[1].Text;
        txtrate.Text = GridView1.SelectedRow.Cells[5].Text;
        ...
        txtmobile.Text = GridView1.SelectedRow.Cells[3].Text.Trim ();
        txttname.Text = tname;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        GridView1.Columns[1].Visible = true;
            ...
            con.Open();
            string log = "insert into Transporter_Table_Editlog select *from Transporter_Table where  Transport_ID='7' and  Transporter_ID='" + GridView1.SelectedRow.Cells[1].Text + "' and Distt_ID='" + sid + "' ";
            cmd.CommandText = log;
            cmd.Connection = con;
            ...
            string qry = "Update  dbo.Transporter_Table set fps_Block='"+ ddlBlock.SelectedValue.ToString() +"', Transporter_Name='" + mtname + "',Rate= " + rate + ",MobileNo='" + mobile + " ',Transport_ID='7',Lead='" + ddllead.SelectedValue.ToString() + "',Address='" + madd + "',Valid_Upto='" + validity + "'  where Distt_ID='" + sid + "'and Transporter_ID='" + GridView1.SelectedRow.Cells[1].Text + "'";
