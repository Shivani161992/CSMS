<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FIN_Print_WheatDCP.aspx.cs" Inherits="District_FIN_Print_WheatDCP" %>
...
<body>
    ...
    <table cellpadding="0" cellspacing="0"   style="background-color:#ecf5d5; width:100%; border:double;border-color:#868f6f">
        ...
        जिले की स्टॉक की जानकारी (गेहूँ)</span></td>
        </tr>
    <tr>
