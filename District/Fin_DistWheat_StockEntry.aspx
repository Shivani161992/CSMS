<%@ Page Language="C#" MasterPageFile="~/MasterPage/SCSC_master.master" AutoEventWireup="true" CodeFile="Fin_DistWheat_StockEntry.aspx.cs" Inherits="District_DistWheatDCP_RMS_entry" Title="Wheat DCP RMS" %>
       ...
       <td style="border-color: #999966; border-width: thin; width: 415px; border-right-style: groove; border-bottom-style: groove; height: 1px;">
        ...
        <tr>
            <td colspan="2" style="height: 1px">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/District/FIN_WheatDCPAllotment.aspx"
                    Width="296px">Click Here for Entry Wheat Monthly Allotment</asp:HyperLink></td>
        </tr>
        <tr>
