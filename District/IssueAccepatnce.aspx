<%@ Page Language="C#" MasterPageFile="~/MasterPage/SCSC_master.master" AutoEventWireup="true" CodeFile="IssueAccepatnce.aspx.cs" Inherits="District_IssueAccepatnce" Title="Untitled Page" %>
     ...
     <tr>
         <td class="tdmarginro" style="background-color: #cfdcdc; font-size: 10pt; position: static;" colspan="4">
            ...
            <Columns>
              ...
              <ItemStyle  />
                    <HeaderStyle/>
                   <asp:TextBox ID="txtrcBags" runat="server"  Text='<%# Bind("Recd_Bags") %>' ReadOnly="false"  BorderColor="Black" Width="50px" OnTextChanged = "txtrcBags_TextChanged" AutoPostBack="true" OnKeyPress=" return IsNumericProcQty(this);"> </asp:TextBox>
             ...
             <table border="1" cellpadding="0" cellspacing="0" style="padding:1; BORDER-COLLAPSE: collapse;  border-right: navy 3px double; border-top: navy 3px double; border-left: navy 3px double; border-bottom: navy 3px double; width: 750px;" id="Table1" onclick="return Table1_onclick()" >
                 <tr>
                     ...
                     <td class="tdmarginro" style="font-size: 10pt; width: 90px; border-bottom: black thin groove;
                         position: static; height: 17px; background-color: #cfdcc8">
                         <asp:Label ID="Label7" runat="server" Text="Stencile Bags (Bad)" Width="167px" Font-Bold="True"></asp:Label></td>
                     <td class="tdmarginro" style="font-size: 10pt; border-bottom: black thin groove;
                         position: static; height: 17px; background-color: #cfdcc8">
                 ...
                 <tr>
                     ...
                     <td class="tdmarginro" style="font-size: 10pt; width: 90px; border-bottom: black thin groove;
                         position: static; height: 17px; background-color: #cfdcc8">
                         <asp:Label ID="Label9" runat="server" Text="Stiching Bags (Bad)" Width="170px" Font-Bold="True"></asp:Label></td>
                     <td class="tdmarginro" style="font-size: 10pt; border-bottom: black thin groove;
                         position: static; height: 17px; background-color: #cfdcc8">
