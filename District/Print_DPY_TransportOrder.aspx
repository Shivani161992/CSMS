<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print_DPY_TransportOrder.aspx.cs" Inherits="District_Print_DPY_TransportOrder" %>
    ...
    <a style="cursor: pointer" onclick="javascript:CallPrint('printdiv')">
        ...
        <div id="printdiv">
            <center>
                                ...
                                <table style="width: 770px">
                                    ...
                                    <tr>
                                        <td colspan="2" style="text-align: left">
                                            ...
                                            <span style="font-size: 11pt">
                                            <asp:Label ID="lblSector" runat="server" Font-Size="11pt"></asp:Label>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="770px"
                                                FooterStyle-ForeColor="green" OnRowDataBound="GridView2_RowDataBound" 
              ...
              <asp:TemplateField HeaderText="भुगतान का प्रकार" SortExpression="Payment_mode">
               <ItemTemplate>
              <ItemStyle />
                    <HeaderStyle/>
                    
                   <asp:Label ID="lblpaytype" runat="server" Text='<%# Bind("Payment_mode") %>'> </asp:Label>
                     
                 </ItemTemplate>
                 
                 <FooterTemplate>
                                   
                    <asp:Label ID="lbl_paytype" runat="server"  ForeColor="Black" Font-Names="Vani" Text = "Grand Total"></asp:Label>
          ...
          <asp:TemplateField HeaderText="गेहूँ" SortExpression="Wheat">
               <ItemTemplate>
              <ItemStyle />
                    <HeaderStyle/>
          ...
          <asp:TemplateField HeaderText="चावल" SortExpression="Rice">
               <ItemTemplate>
              <ItemStyle />
                    <HeaderStyle/>
           ...
           <asp:TemplateField HeaderText="शक्कर" SortExpression="Sugar">
               <ItemTemplate>
              <ItemStyle />
                    <HeaderStyle/>
      ...
      <asp:TemplateField HeaderText="नमक" SortExpression="Salt">
               <ItemTemplate>
              <ItemStyle />
                    <HeaderStyle/>
                    
                   <asp:Label ID="lblSalt" runat="server" Text='<%# Bind("Salt") %>'> </asp:Label>
             ...
             <asp:TemplateField HeaderText="मक्का" SortExpression="Maize">
               <ItemTemplate>
              <ItemStyle />
                    <HeaderStyle/>
