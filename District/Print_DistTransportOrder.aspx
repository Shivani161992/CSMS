<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print_DistTransportOrder.aspx.cs" Inherits="District_Print_DistTransportOrder" %>
    ...
    <form id="form1" runat="server">
        <div class="A4">
            ...
            <table align="center" class="auto-style1">
                ...
                <tr>
                    <td style="text-align: center" class="auto-style3"><strong>&lt;&lt; <span class="auto-style2"><asp:Label ID="lblPDS" runat="server" Text=""></asp:Label>&nbsp;TRANSPORT ORDER </span> &gt;&gt; </strong></td>
            ...
            <table align="center" class="auto-style1">
                <tr>
                    <td colspan="2" style="text-align:center;  ">
                        <asp:Label ID="lbldist" runat="server" Font-Bold="true" Font-Size="Large" Text=""></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: left">ट्रांसपोर्ट ऑर्डर क्रमांक : ....<asp:Label ID="lblMovmtNo" runat="server" Text=""></asp:Label>....</td>
                    <td style="text-align: right">ट्रांसपोर्ट ऑर्डर दिनांक : ....<asp:Label ID="lblDate" runat="server"></asp:Label>....</td>
                </tr>
                    ...
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="Black" BorderStyle="Solid" BorderWidth="2px" CellPadding="4" EnableModelValidation="True" ShowFooter="True" OnRowDataBound="GridView1_RowDataBound" Width="100%">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="प्रेषण कर्ता प्रदाय केंद्र">
                                    <HeaderStyle Font-Bold="True" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="प्राप्तकर्ता प्रदाय केंद्र" DataField="ReceiveICName">
                                    <HeaderStyle Font-Bold="True" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
