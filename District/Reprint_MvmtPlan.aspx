<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SCSC_master.master" AutoEventWireup="true" CodeFile="Reprint_MvmtPlan.aspx.cs" Inherits="District_Reprint_MvmtPlan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table align="center" style="width: 600px; border-style: solid; border-width: 1px; text-align: left" border="1" cellspacing="0" cellpadding="6">
        <tr>
            <td colspan="5" style="text-align: center; font-size: large; text-decoration: underline; color: #CC6600; font-weight: bold">Reprint Movement Plan Against HO PDS Movement Order</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"><strong>Movement Order Number</strong>
                <asp:DropDownList ID="ddlMvmtNumber" runat="server" Width="150px" Style="margin-left: 10px" AutoPostBack="True">
                </asp:DropDownList>
            </td>
            <td>
