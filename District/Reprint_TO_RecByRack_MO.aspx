<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SCSC_master.master" AutoEventWireup="true" CodeFile="Reprint_TO_RecByRack_MO.aspx.cs" Inherits="District_Reprint_TO_RecByRack_MO" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table align="center" style="width: 600px; border-style: solid; border-width: 1px; text-align: left" border="1" cellspacing="0" cellpadding="6">
        <tr>
            <td colspan="3" style="text-align:center"><span style=" font-size: large; text-decoration: underline; color: #CC6600; font-weight: bold">Reprint TO Against HO PDS Movement Order</span> <span style="font-size: large; " class="auto-style4">(Receiving District By Rack)</span></td>
        </tr>
        <tr>
