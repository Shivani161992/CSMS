...
public partial class District_Reprint_TO_RecByRack_MO : System.Web.UI.Page
{
    SqlConnection con;
    SqlDataAdapter da;
    DataSet ds;
    ...
    public void GetTONumber()
    {
        ...
        using (con = new SqlConnection(strcon))
        {
            try
            {
                ...
                string select = string.Format("SELECT distinct TO_No,FrmDist FROM TO_AgainstHO_MO where CreatedDate between '" + ConvertFromDate + " 00:00:00' and '" + ConvertToDate + " 23:59:59' and FrmDist='" + districtid + "' and ModeofDispatch='13' and ToDist='00' order by TO_No");
                ...
                if (ds != null)
                {
                    if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        ddlTONumber.DataValueField = "TO_No";
