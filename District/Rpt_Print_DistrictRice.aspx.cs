...
public partial class District_Rpt_Report_DistrictRice : System.Web.UI.Page
{
     ...
     private void get_Data(string distId, string month, string year)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "Rpt_DistrictReport_Rice";
