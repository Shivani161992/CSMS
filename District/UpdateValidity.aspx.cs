...
public partial class District_UpdateValidity : System.Web.UI.Page

{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DaintyDate2.Attributes.Add("onkeypress", "CheckCalDate(this)");
    ...
    void GetName()
    {
        ...
        else
        {
            ...
            lbldistrict.Text = drd["district_name"].ToString();
    ...
    {
        mobj = new MoveChallan(ComObj);
        string qry = "SELECT RO_of_FCI.*,districtsmp.district_name from dbo.RO_of_FCI left join pds.districtsmp on RO_of_FCI.Distt_Id=districtsmp.district_code   where RO_of_FCI.Distt_Id='"+distid +"' and RO_of_FCI.RO_No='"+rono +"'" ;
    ...
    protected void btnGet_Click(object sender, EventArgs e)
    {
        ...
        mobj = new MoveChallan(ComObj);
        string qryv = "SELECT * from dbo.RO_of_FCI where Distt_Id='" + distid + "' and RO_No='" + rono + "'";
        ...
        //fdate = Convert.ToDateTime(DaintyDate2.SelectedDate );
        ...
        //{
            ...
            string update = "Update RO_of_FCI set RO_Validity ='" + vdate + "',IsExpire='N'  where Distt_Id='" + distid + "'and RO_No='" + rono + "'";
            cmd.Connection = con;
    ...
    {
        ComObj.CloseConnection();
        Response.Redirect("~/District/Expire_RO_Details.aspx");
    }
}
