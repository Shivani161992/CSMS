<%@ Page Title="Distance Master" Language="C#" MasterPageFile="~/MasterPage/SCSC_master.master" AutoEventWireup="true" CodeFile="godown_distance_Master.aspx.cs" Inherits="District_PCcenterto_godown_distance" %>
   ...
   <center>
        ...
        <tr id="trBranch" runat="server" visible="false">
            <td style="width: 341px; height: 1px; text-align: center; font-family: Calibri;">
                Branch</td>
            <td style="width: 230px; height: 1px; text-align: left">
                <asp:DropDownList ID="ddlBranch" runat="server" Width="194px" 
