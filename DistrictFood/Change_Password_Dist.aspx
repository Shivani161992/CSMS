<%@ Page Language="C#" MasterPageFile="~/MasterPage/DF_MPSCSC.master" AutoEventWireup="true" CodeFile="Change_Password_Dist.aspx.cs" Inherits="District_Change_Password_Dist" Title="Change Password District Food" %>
...
<td align="left">
    ...
    <asp:Button ID="btnadd" runat="server" Text="Save" OnClick="btnadd_Click" Width="74px" ValidationGroup="1" /></td>
        <td align="left">
            <asp:Button ID="btnclose" runat="server" Text="Close" Width="119px" OnClick="btnclose_Click" /></td>
    </tr>
    <tr>
        <td colspan="2">
