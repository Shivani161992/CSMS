<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Current_Balance_rpt.aspx.vb" Inherits="ReportForms_District_Current_Balance_rpt"  Title="Current Balance Of Stock"%>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 823px; background-color: #ece9d8;" id="">
            ...
            <tr>
                ...
                <td style="width: 100px; height: 24px">
                    <asp:Label ID="Label3" runat="server" Font-Bold="True" ForeColor="MediumBlue" Width="98px"></asp:Label></td>
