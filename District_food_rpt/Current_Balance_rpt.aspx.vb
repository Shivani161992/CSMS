...
Partial Class ReportForms_District_Current_Balance_rpt
...
#End Region
    ...
    Private Sub get_Data(ByVal DistID As String)
        Dim folder As String = ConfigurationManager.ConnectionStrings("rptfolder").ProviderName


        ' For Report
        If ReportViewer1.ServerReport.ReportPath = folder & "CurrentBalance_IC" Then
        ...
        Else
            ...
            ReportViewer1.ServerReport.ReportPath = folder & "Current_Balance"
