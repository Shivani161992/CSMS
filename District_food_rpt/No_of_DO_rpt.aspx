<%@ Page Language="VB" AutoEventWireup="false" CodeFile="No_of_DO_rpt.aspx.vb" Inherits="No_of_IssedDO_rpt" %>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 800px; background-color: #ece9d8;" id="">
            ...
            <tr>
                ...
                <td style="width: 100px; height: 23px;">
                    ...
                    <asp:TextBox ID="tx_from_date" runat="server" Width="127px"></asp:TextBox>
                      <script type  ="text/javascript">
                                                	new tcal ({
                                                	'formname': 'form1',
