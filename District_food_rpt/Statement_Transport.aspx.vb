...
Partial Class ReportForms_District_Statement_Transport
...
#End Region
    ...
    Private Sub get_Data(ByVal Month As String, ByVal Year As String, ByVal DistID As String)
        Dim folder As String = ConfigurationManager.ConnectionStrings("rptfolder").ProviderName


        ' For Report
        If ReportViewer1.ServerReport.ReportPath = folder & "Truck_Movement_analysis" Then
        ...
        Else
            ...
            ReportViewer1.ServerReport.ReportPath = folder & "StatementOf_Transportation"
