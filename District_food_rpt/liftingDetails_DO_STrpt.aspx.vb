...
#End Region
    ...
    Private Sub get_Data(ByVal from_date As String, ByVal to_date As String)
        ...
        If ReportViewer1.ServerReport.ReportPath = folder & "liftedDO_againstDO" Then
            ReportViewer1.PerformBack()
        ElseIf ReportViewer1.ServerReport.ReportPath = folder & "drilldownDoRpt" Then
            ReportViewer1.PerformBack()
        Else
            ' For Report
    ...
    Protected Sub LinkButton1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LinkButton1.Click
        ...
        ElseIf ReportViewer1.ServerReport.ReportPath = folder & "drilldownDoRpt" Then
            ReportViewer1.PerformBack()
        Else
            Response.Redirect("~/DistrictFood/frmReports.aspx")
        End If
    End Sub
End Class
