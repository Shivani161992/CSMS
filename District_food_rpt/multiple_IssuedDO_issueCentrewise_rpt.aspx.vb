...
Partial Class multiple_IssuedDO_issueCentrewise_rpt
...
#End Region
    ...
    Private Sub get_Data(ByVal from_date As String, ByVal to_date As String)
        ...
        ReportViewer1.ServerReport.ReportPath = folder & "multiple_issueedDo_issuecentrewise"
        ...
        paramList.Add(New ReportParameter("issueCode", ddl_issuename.SelectedItem.Value, False))
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        If ddl_issuename.SelectedIndex = 0 Then
            Page.RegisterClientScriptBlock("asdsad", " <script language=javascript > alert('Please Select IssueCentre ...');</script>")
        Else
