...
public partial class Division_Report_Accep_division : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        getData(fdate, tdate, Region_id);
    }

    private void getData(string fdate, string tdate, string Region_id)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "Acceptnote_Division";
        ReportViewer1.ServerReport.ReportServerCredentials = new ReportServerNetworkCredentials();
        ReportParameterInfoCollection pInfo = default(ReportParameterInfoCollection);
        System.Collections.Generic.List<ReportParameter> paramList = new System.Collections.Generic.List<ReportParameter>();


        paramList.Add(new ReportParameter("Division_code", Region_id, false));
