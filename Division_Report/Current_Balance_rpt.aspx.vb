...
Partial Class Division_Report_Current_Balance_rpt
...
#End Region
    ...
    Private Sub get_Data(ByVal Division As String)
        ...
        If ReportViewer1.ServerReport.ReportPath = folder & "Current_Balance" Or ReportViewer1.ServerReport.ReportPath = folder & "CurrentBalance_IC" Then
        ...
        Else
            ...
            ReportViewer1.ServerReport.ReportPath = folder & "Curren_Balance_Region_rpt"
