...
Partial Class Division_Report_District_Alloc_Lift
...
#End Region
    ...
    Private Sub get_Data(ByVal Month As String, ByVal Year As String, ByVal Division As String)
        ...
        If ReportViewer1.ServerReport.ReportPath = folder & "Allotment_Comdty_Schm" Then
        ...
        Else
            ...
            ReportViewer1.ServerReport.ReportPath = folder & "Release_Order_Analsys"
