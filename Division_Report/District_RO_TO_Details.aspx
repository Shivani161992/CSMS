<%@ Page Language="VB" AutoEventWireup="false" CodeFile="District_RO_TO_Details.aspx.vb" Inherits="Division_Report_District_RO_TO_Details" %>
...
<head id="Head1" runat="server">
    <title>Summary Report(District Wise) </title>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 823px; background-color: #ece9d8;" id="">
            ...
            <tr>
                ...
                <td align="center" colspan="4" style="height: 23px; color: teal;">
                    <strong>Summary Report(District Wise) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; </strong>
                </td>
            ...
            <tr>
                ...
                <td style="width: 100px; height: 23px;">
                    &nbsp;<asp:Label ID="Label3" runat="server" Font-Bold="True" ForeColor="MediumBlue"
