...
public partial class Reports_State_MovmtOrderRackStatus_Rpt : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    {
        if (Session["Region_id"] != null || Session["dist_id"] != null)
        {
            if (!IsPostBack)
            {
    ...
    private void getData(string Comdty, string FrmDate, string ToDate, string DistCode)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "MovmtOrderRackStatusRM";
