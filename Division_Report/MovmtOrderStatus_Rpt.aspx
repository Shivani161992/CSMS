<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MovmtOrderStatus_Rpt.aspx.cs" Inherits="Reports_State_MovmtOrderStatus_Rpt" %>
        ...
        <div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3; padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%; background-color: lavender;"
                ...
                <tr style="text-align: center">
                    <td colspan="11" class="auto-style1" style="color: #CC6600; background-color:#FFCCFF">PDS Movement Order Status (By Road)</td>
                </tr>
                <tr>
                      <td>
                        <asp:Label ID="lblDist" runat="server" Style="font-weight: 700; font-size: large;" Text="District" ></asp:Label>
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlDist" runat="server" Width="173px" >
