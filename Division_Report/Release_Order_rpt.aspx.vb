...
Partial Class ReportForms_District_Release_Order_rpt
...
#End Region
    ...
    Private Sub get_Data(ByVal Month As String, ByVal Year As String, ByVal Division As String)
        ...
        ' For Report
        If ReportViewer1.ServerReport.ReportPath = folder & "Release_Order_rpt" Then
        ...
        Else
            ...
            If (chkg.Checked = True) Then
                ReportViewer1.ServerReport.ReportPath = folder & "RO_Graph_Region"
            Else
                ReportViewer1.ServerReport.ReportPath = folder & "Release_Order_ROwise_rpt"
