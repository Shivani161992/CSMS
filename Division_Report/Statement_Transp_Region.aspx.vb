...
Partial Class Division_Report_Statement_Transp_Region
...
#End Region
    ...
    Private Sub get_Data(ByVal Month As String, ByVal Year As String, ByVal Division As String)
        ...
        If ReportViewer1.ServerReport.ReportPath = folder & "StatementOf_Transportation" Or ReportViewer1.ServerReport.ReportPath = folder & "Truck_Movement_analysis" Then
        ...
        Else
            ...
            ReportViewer1.ServerReport.ReportPath = folder & "Statement_Transport_Region"
