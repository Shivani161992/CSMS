...
Partial Class Division_Report_Stock_Region_rpt
...
#End Region
    ...
    Private Sub get_Data(ByVal Month As String, ByVal Year As String, ByVal Commodity As String, ByVal Scheme As String, ByVal Division As String)
        Dim folder As String = ConfigurationManager.ConnectionStrings("rptfolder").ProviderName

        If ReportViewer1.ServerReport.ReportPath = folder & "Stock_Registor_rpt" Then
        ...
        Else
            ...
            ReportViewer1.ServerReport.ReportPath = folder & "Stock_Register_ROwise_rpt"
            ...
            paramList.Add(New ReportParameter("DistName", Label3.Text.Trim(), False))
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        get_Data(month, year, Commodity, Scheme, Division)
