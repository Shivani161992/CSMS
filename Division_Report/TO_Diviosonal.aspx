<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TO_Diviosonal.aspx.vb" Inherits="Division_Report_TO_Diviosonal" %>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 800px; background-color: #ece9d8;" id="">
            ...
            <tr>
                ...
                <td>
                     ...
                     <asp:TextBox ID="tx_from_date" runat="server" Width="114px"></asp:TextBox>
                ...
                <td>
                      <asp:TextBox ID="tx_to_date" runat="server" Width="149px"></asp:TextBox>
                      <script type  ="text/javascript">
                                                	new tcal ({
				'formname': 'form1',
