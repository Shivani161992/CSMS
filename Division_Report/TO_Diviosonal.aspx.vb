...
Partial Class Division_Report_TO_Diviosonal
...
#End Region
    ...
    Private Sub get_Data(ByVal FromDate As String, ByVal Todate As String, ByVal Division As String)
        ...
        ' For Report
        If ReportViewer1.ServerReport.ReportPath = folder & "Transport_Order_rpt" Then
        ...
        Else
            ...
            ReportViewer1.ServerReport.ReportPath = folder & "Transport_Order_Regional_rpt"
            ...
            paramList.Add(New ReportParameter("DistName", Label3.Text, False))
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        get_Data(fdate, todate, Division)
