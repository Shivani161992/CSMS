...
Partial Class Division_Report_Truck_Movement_Region
...
#End Region
    ...
    Private Sub get_Data(ByVal FromDate As String, ByVal Todate As String, ByVal Division As String)
        ...
        ' For Report
        If ReportViewer1.ServerReport.ReportPath = folder & "Truck_Movement" Then
        ...
        Else
            ...
            ReportViewer1.ServerReport.ReportPath = folder & "Truck_Movement_Region"
