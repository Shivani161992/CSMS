<%@ Page Language="VB" AutoEventWireup="false" CodeFile="graphical_DO_divisionRpt.aspx.vb" Inherits="liftingDetails_DO_divisionRpt" %>
...
<body>
    <form id="form1" runat="server">
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 808px; background-color: #ece9d8;" id="">
            ...
            <tr>
                <td style="vertical-align: middle; width: 133px; height: 23px">
                    Month</td>
            ...
            <tr>
                <td style="width: 133px; height: 23px; vertical-align: middle;">
                    </td>
                <td style="width: 100px; height: 23px;">
                    &nbsp;</td>
