...
<body>
    <form id="form1" runat="server">
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 856px; background-color: #ece9d8;" id="">
            ...
            <tr>
                <td style="vertical-align: middle; width: 178px; height: 24px">
                    Division Logged In</td>
                <td style="width: 178px; height: 24px">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="#0000C0"></asp:Label></td>
            ...
            <tr>
                <td style="width: 178px; height: 23px; vertical-align: middle;">
                    From Date</td>
                <td style="width: 178px;">
                      <asp:TextBox ID="tx_from_date" runat="server" Width="122px"></asp:TextBox>
                ...
                <td>
                       ...
                       <asp:TextBox ID="tx_to_date" runat="server" Width="123px"></asp:TextBox>
                      <script type  ="text/javascript">
                                                	new tcal ({
				'formname': 'form1',
