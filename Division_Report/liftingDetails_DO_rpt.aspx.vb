...
Partial Class liftingDetails_DO_rpt
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            ...
            End Try
            Label1.Text = Session("Region_name").ToString()
            get_distname()
...
#End Region
    ...
    Private Sub get_Data(ByVal from_date As String, ByVal to_date As String)
        ...
        If ReportViewer1.ServerReport.ReportPath = folder & "drilldownDoRpt" Then
        ...
        Else
            ...
            ReportViewer1.ServerReport.ReportPath = folder & "liftedDO_againstDO"
    ...
    Protected Sub get_distname()
        Dim division_code As String = Session("Region_id").ToString()
        ddl_dist.Items.Clear()
        cmd.CommandText = "select * from pds.districtsmp where district_code<>'99' and Division_code='" & division_code & "' order by Division_code"
        cmd.Connection = con
        con.Open()
