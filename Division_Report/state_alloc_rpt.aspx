<%@ Page Language="VB" AutoEventWireup="false" CodeFile="state_alloc_rpt.aspx.vb" Inherits="Division_Report_state_alloc_rpt" %>
...
<head id="Head1" runat="server">
    <title>State Allocation Details</title>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 823px; background-color: #ece9d8;" id="">
            <tr>
                <td align="center" colspan="5" style="font-weight: bolder; font-size: 15pt; color: teal">
                    State Allocation Details</td>
            </tr>
            <tr>
                <td style="vertical-align: middle; width: 124px; height: 23px">
                    Division:</td>
                <td style="height: 23px" colspan="3">
                    <asp:Label ID="Label3" runat="server" Font-Bold="True" ForeColor="MediumBlue" Width="275px"></asp:Label></td>
                <td align="left" style="width: 417px; height: 23px">
                    </td>
            </tr>
            <tr>
                <td style="width: 124px; height: 23px; vertical-align: middle;">
                    Month</td>
            ...
            <tr>
                <td colspan="3" style="height: 25px">
                    <asp:Label ID="lbldiv" runat="server" ForeColor="Red" Text="Label" Visible="False"
