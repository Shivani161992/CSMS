...
<body leftmargin=0 topmargin=0 bgcolor="#ffffff"> 
  ...
  <tr>
	...
	<table width="780" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td align="center">
                <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/404.jpg" /></td>
        </tr>
        <tr>
            <td align="center" style="color: white; background-color: firebrick">
                <asp:HyperLink ID="HyperLink2" runat="server" Font-Bold="True" Font-Italic="True"
                    ForeColor="White" Height="21px" NavigateUrl="~/MainLogin.aspx" Width="191px">Go To The Login Page</asp:HyperLink></td>
        </tr>
      </table>
