...
public partial class GunnyBags_Gunny_Bags_GodownToSocietyMappingUpdate_Collector : System.Web.UI.Page
{
    ...
    public void GetSociety()
    {
        ...
        using (con = new SqlConnection(strcon))
        {
            try
            {
                ...
                string select = string.Format("select Society_Id, '('+ Society_Id +')'+',' + Society_Name_Eng as Society_Name_Eng from Society2017 where IsPaddy='Y' and DistrictId='23" + DistCode + "' order by Society_Name_Eng ");
                ...
                if (ds != null)
                {
                    ...
                    else 
                    {
                     ...
                     //   ddlMSeason.SelectedValue = "0";
                      ...
                      //  string qrey = "select MAX(Priority) MaxPriority from GunnyBags_GodownToSocietyMapping where FromGodownDistrict='" + DistrictGodown + "' and FromGodown !='" + godown + "' and CropYear ='" + CropYear + "'";
                        string qrey = "select * from GunnyBags_GodownToSocietyMapping where FromGodownDistrict='" + DistrictGodown + "' and FromGodown !='" + godown + "' and CropYear ='" + CropYear + "'";
                        ...
                        if (ds != null)
                        {
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                if (ds != null)
                                {
                                    if (ds.Tables[0].Rows.Count > 0)
                                    {
                                        ddlPriority.SelectedValue = (Convert.ToInt32(ds.Tables[0].Rows[0]["MaxPriority"]) + 1).ToString();
                                    }
                                }
                            ...
                            {
                                ds.Clear();
                                //   qrey = "select Priority from GunnyBags_GodownToSocietyMapping where FromGodownDistrict='" + DistrictGodown + "' and FromGodown='" + godown + "' and ToSocietyDistrict='" + DistrictSociety + "' and ToSociety='" + Society + "' and CropYear = '" + CropYear + "' ";
                                qrey = "select top(1) Priority from GunnyBags_GodownToSocietyMapping where FromGodownDistrict='" + DistrictGodown + "' and FromGodown='" + godown + "'  and CropYear = '" + CropYear + "' ";
                                da = new SqlDataAdapter(qrey, con);
                                ds = new DataSet();
                                da.Fill(ds);
                                if (ds != null)
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                qrey = "INSERT INTO [GunnyBags_GodownToSocietyMapping] ([MappingID],[FromGodownDistrict],[FromGodown],[ToSocietyDistrict],[ToSociety],[FromDate],[ToDate],[CropYear],[RabiKharif],[Priority],[Quantity],[CreatedDate],[UpdatedDate],[UserID],[IP]) values('" + gatepass + "','" + DistrictGodown + "','" + godown + "','" + DistrictSociety + "','" + Society + "','" + FromDate + "','" + ToDate + "','" + CropYear + "','" + rabiKharif + "','" + SetPriority + "','" + Quantity + "', '" + System.DateTime.Now + "','" + System.DateTime.Now + "','" + DistCode + "','" + ip + "') ";
