<%@ Page Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master" AutoEventWireup="true" CodeFile="ChangePassword_Issue.aspx.cs" Inherits="IssueCenter_ChangePassword_Issue" Title="Change Password Issue Center" %>
...
<table border="1" cellpadding="0" cellspacing="0" style="padding:1; BORDER-COLLAPSE: collapse; border-right: green 3px double; border-top: green 3px double; border-left: green 3px double; border-bottom: green 3px double; width: 302px;" id="">
        <tr>
                <td colspan="3" style="height: 24px; color: white; background-color: transparent; background-image: url(../Images/imgg2.jpg);" align="center">
                    <asp:Label ID="lblChangePassword" runat="server" Text="Change Password" Font-Size="13pt"></asp:Label></td>
            </tr>
        </table>
<table border="1" cellpadding="0" cellspacing="0" style="padding:1; BORDER-COLLAPSE: collapse;  border-right: green 3px double; border-top: green 3px double; border-left: green 3px double; border-bottom: green 3px double;"  width="300" >
    ...
    <tr>
        <td align="left">
            <asp:Label ID="lblOldPassword" runat="server" Text="Old Password" Font-Size="12px"></asp:Label></td>
        <td align="left">
    <asp:TextBox ID="txtoldpwd" runat="server" Width="123px" TextMode="Password"></asp:TextBox></td>
    </tr>
    <tr>
        <td align="left" >
            <asp:Label ID="lblNewPassword" runat="server" Text="New Password" Font-Size="12px"></asp:Label></td>
        <td align="left" >
...
<tr>
<td align="left">
    <asp:Label ID="lblConfirmPassword" runat="server" Text="Confirm Password" Font-Size="12px"></asp:Label></td>
<td align="left">
...
<td align="left">
    ...
    <tr>
        <td>
            &nbsp; &nbsp; &nbsp;&nbsp;
    <asp:Button ID="btnsave" runat="server" Text="Save" OnClick="btnsave_Click" Width="74px" ValidationGroup="1" /></td>
        <td align="left">
