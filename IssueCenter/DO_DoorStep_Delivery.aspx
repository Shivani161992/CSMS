<%@ Page Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master"  AutoEventWireup="true" CodeFile="DO_DoorStep_Delivery.aspx.cs" Inherits="delivery" Title="Delivery Order" %>
...
<script type="text/javascript">
	...
	<div style="text-align: right; height: 1090px;" >
    <asp:Panel ID="panelDO" runat ="server" Height="808px"  >
        ...
        <tr><td align="center" style="background-color: #cccccc; width: 713px;" valign="top">
            <asp:Label ID="lbldo" runat="server" Font-Bold="True" ForeColor="Black" Text="Door Step Delivery Order"
                Width="200px"></asp:Label></td></tr>
            <tr>
                ...
                Permit / Release Order Details
                    ...
                    <table border="1" cellpadding="0" cellspacing="0" style="width: 680px">
                        <tr>
                            ...
                            <table style="width: 763px; height: 244px;">
                                <tr>
                            ...
                            <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; background-color: #ffcc66; height: 1px;">
                                <asp:Label ID="lblpermitno1" runat="server" Font-Size="12px" Text="Allotment No." Width="75px"></asp:Label></td>
                             <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; background-color: #ffcc66; height: 1px;" colspan="5"> 
                                ...
                                <asp:Label ID="lblpermitno" runat="server" Font-Size="12px" Text="Allotment No." Width="80px"></asp:Label></td>
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; background-color: #ffcc66; width: 40px;">
                                <asp:TextBox ID="tx_permit_no" runat="server" Width="143px" MaxLength="15" OnTextChanged="tx_permit_no_TextChanged" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px">0</asp:TextBox></td>
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; background-color: #ffcc66; width: 109px;">
                                <asp:Label ID="lblpermitdate" runat="server" Font-Size="12px" Text="Allotment Date"></asp:Label></td>
	...
	new tcal ({
				...
				'controlname': 'ctl00_ContentPlaceHolder1_tx_permit_date'
                                ...
                                <asp:Label ID="lblallotmonth" runat="server" Font-Size="12px" Text="Allot. Month"
                                    ...
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; width: 40px;">
                                ...
                                <asp:ListItem Value="12">December</asp:ListItem>
                                    ...
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; width: 109px;">
                                        <asp:Label ID="lblallotyear" runat="server" Font-Size="12px" Text="Allot. Year" Width="101px"></asp:Label></td>
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; width: 250px;">
                                ...
                                <asp:Label ID="lblScheme" runat="server" Font-Size="12px" Text="Scheme"></asp:Label></td>
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; width: 250px;" align="left">
                                &nbsp;
                                ...
                                <asp:Label ID="lblbalcomdty" runat="server" Font-Size="12px" Text="Balance Stock of Commodity" Visible="False"></asp:Label></td>
                                    <td colspan="2" style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid">
                                <asp:TextBox ID="txtcomdty_bal" runat="server" BackColor="MenuBar" Font-Bold="False"
                                    ForeColor="Black" ReadOnly="True" Width="93px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Visible="False"></asp:TextBox>Qtls.</td>
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid" colspan="2">
                                <asp:Label ID="lblratetype" runat="server" Font-Size="12px" Text="Rate Type" Width="53px"></asp:Label><asp:DropDownList ID="ddl_rate_type" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddl_rate_type_SelectedIndexChanged">
                                ...
                                <asp:Label ID="lbl_alloc" runat="server" Text="Allocation for the Month"></asp:Label>&nbsp;</td>
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; background-color: #ffffcc; width: 109px;">
                                    ...
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; background-color: #ffffcc; width: 250px;">
                                ...
                                <asp:TextBox ID="tx_already_iqty" runat="server" BackColor="MenuBar" MaxLength="8"
                                    ...
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; background-color: #ffffcc; width: 42px;">
                                ...
                                <asp:Label ID="lbl_curbal" runat="server" Text="Current Balance Eligibility" Width="168px" Height="20px" Visible="False"></asp:Label>&nbsp;</td>
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; width: 109px; background-color: #ffffcc; height: 1px;">
                                <asp:TextBox ID="tx_balQty" runat="server" BackColor="MenuBar" MaxLength="8" ReadOnly="True"
                                    Width="58px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Visible="False"></asp:TextBox><asp:Label ID="lbl_qtcur" runat="server" Text="Qtls." Visible="False"></asp:Label></td>
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; width: 250px; background-color: #ffffcc; height: 1px;">
                                <asp:Label ID="lbl_stock" runat="server" Text="Balance Stock of Commodity/Scheme" Width="238px" Height="13px" Visible="False"></asp:Label></td>
                                ...
                                <asp:TextBox ID="tx_bal_ic" runat="server" BackColor="MenuBar" MaxLength="8" ReadOnly="True"
                                    Width="90px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Visible="False"></asp:TextBox></td>
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; width: 42px; background-color: #ffffcc; height: 1px;">
                                        <asp:Label ID="lbl_qtstk" runat="server" Text="Qtls." Visible="False"></asp:Label></td>
                                </tr>
                            </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 10pt; position: static; background-color: #ffffcc; border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; height: 24px;" align="left">
				...
				'controlname': 'ctl00_ContentPlaceHolder1_tx_do_validity'
                        ...
                        <tr>
                            ...
                            <table style="width: 100%; height: 296px;">
                                ...
                                <tr>
                                    <td align="left" colspan="7" style="border-right: silver 1px solid; border-top: silver 1px solid;
                                        border-left: silver 1px solid; border-bottom: silver 1px solid; height: 1px">
                                <asp:Label ID="lbl_transporter" runat="server" Text="Transporter" Font-Size="Small" Width="40px"></asp:Label>
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                                        &nbsp;
                                       <%-- <asp:DropDownList ID="ddl_lead" runat="server" Font-Names="Arial Unicode MS" Font-Size="Small" Visible = "false">
                                </asp:DropDownList>--%>
                                
                                <asp:DropDownList ID="ddltransport" runat="server" >
                                </asp:DropDownList>
                                        <strong><span style="color: #ff0000">Transporter के नाम कृपया&nbsp; जिला कार्यालय से
                                            जुड़वाये</span></strong></td>
                                </tr>
                            <tr>
                                ...
                                <tr>
                                    <td align="left" colspan="7" style="border-right: silver 1px solid; border-top: silver 1px solid;
                                        border-left: silver 1px solid; border-bottom: silver 1px solid; height: 1px">
                                        <asp:Label ID="Label6" runat="server" ForeColor="Black" Text="Link Cooperative Society"
                                            Width="142px"></asp:Label>
                                        <asp:DropDownList ID="ddlCooperative" runat="server" Font-Names="Arial Unicode MS" Font-Size="Small" Width="251px">
                                        </asp:DropDownList>
                                        Search FPS(last 3 digit)
                                        <asp:TextBox ID="txt_fps" runat="server" AutoPostBack="True" OnTextChanged="txt_fps_TextChanged"></asp:TextBox>
                                        </td>
                                </tr>
                                <tr>
                                    <td align="left" colspan="7" style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; height: 278px;">
                                                <table style="width: 624px; height: 256px;" border="1">
                                                    <tr>
                                                        <td colspan="2" valign="top" align="left" style="height: 200px">
                                                            ...
                                                            <asp:ListBox ID="ddl_fps_name" runat="server" Height="200px" Width="402px" OnSelectedIndexChanged="ddl_fps_name_SelectedIndexChanged" AutoPostBack="True"></asp:ListBox></td>
                                ...
                                <asp:Label ID="lblRateQuintal" runat="server" Font-Size="12px" Text="Rate/Quintal"></asp:Label></td>
                                                                        <td colspan="2" style="width: 138px; height: 1px">
                                <asp:TextBox ID="tx_rate_qt" runat="server"
                                    MaxLength="8" Width="90px" BackColor="Linen" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"></asp:TextBox>
                                                                            in Rs</td>
                                                                    </tr>
                                                                    <tr>
                                ...
                                <tr>
                                    <td align="left" colspan="7" style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; height: 69px;">
               
                <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" Width="100%" Visible="False" Height = "150px">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                            BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" Font-Bold="False"
                            Font-Size="Small" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="100%" Height = "150px" >
                    ...
                    <table style="width: 100%; height: 160px;" border="1" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="left" style="font-size: 10pt; position: static; background-color: #cfdcc8; height: 10px;">
                                <asp:Label ID="lbltotamt" runat="server" Font-Size="12px" Text="Total Amount Payable" Width="120px"></asp:Label></td>
                            <td align="left" style="font-size: 10pt; position: static; background-color: #cfdcc8; width: 158px; height: 10px;">
                            ...
                            <td align="left" colspan="2" style="background-color: #cfdcc8; height: 10px;">
                                </td>
                            <td align="left" style="background-color: #cfdcc8; width: 126px; height: 10px;">
                                </td>
                            <td align="left" style="background-color: #cfdcc8; height: 10px;">
                            </td>
                        </tr>
                        <tr>
                            <td align="left" style="background-color: #cfdcc8; height: 20px;">
                                Payment Option</td>
                            <td align="left" colspan="3" style="background-color: #cfdcc8; height: 20px;">
                                <asp:RadioButton ID="rdbtncash" runat="server" Font-Bold="True" Text="CASH" GroupName="1" OnCheckedChanged="rdbtncash_CheckedChanged" AutoPostBack="True" /></td>
                            <td align="left" style="width: 126px; background-color: #cfdcc8; height: 20px;">
                                <asp:RadioButton ID="rdbtncredit" runat="server" Font-Bold="True" Text="CREDIT" GroupName="1" Checked="True" OnCheckedChanged="rdbtncredit_CheckedChanged" AutoPostBack="True" /></td>
                            <td align="left" style="background-color: #cfdcc8; height: 20px;">
                            </td>
                        </tr>
                        <tr>
                            <td align="left" style="background-color: #cfdcc8" colspan="5">
                                <asp:Panel ID="pnlbankdetails" runat="server" Width="100%" Visible="False" >
                                <table width = "100%">
                                
                                <tr>
                                
                                <td >
                                <asp:Label id="lblPaymentMode" runat="server" Text="Payment Mode" Width="92px" Font-Size="12px"></asp:Label>
                                
                                </td>
                                <td>
                                
                                <asp:DropDownList id="ddl_pmode" runat="server" Width="224px" OnSelectedIndexChanged="ddl_pmode_SelectedIndexChanged" AutoPostBack="True">
                                ...
                                <td>
                                <asp:Label id="lblddchekno" runat="server" Text="DD/Chq.No. " Width="111px" Font-Size="12px"></asp:Label>
                                ...
                                <asp:TextBox id="tx_dd_no" runat="server" Width="120px" MaxLength="50"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="lblddchekdate" runat="server" Font-Size="12px" Text="Payment Date"
	...
	new tcal ({
				...
				'controlname': 'ctl00_ContentPlaceHolder1_tx_dd_date'
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="tx_dd_amount" runat="server" MaxLength="12" Width="125px"></asp:TextBox><asp:Label
                                                ID="Label2" runat="server" ForeColor="Black" Text="Rs."></asp:Label>
        ...
        <asp:HyperLink id="hlinkpdo" runat="server" NavigateUrl="#" Visible="False" Font-Size="10pt">Issue Delivery Order</asp:HyperLink></td>
                        ...
                        <tr>
                            <td align="left" style="font-size: 10pt; position: static; background-color: #cfdcdc; height: 9px;">
                        ...
                        ErrorMessage="Please enter quantity" Height="0px" ValidationGroup="2" Width="0px">*</asp:RequiredFieldValidator></td>
                            <td align="right" colspan="3" style="font-size: 10pt; position: static; background-color: #cfdcdc; height: 9px;">
                    <asp:ValidationSummary ID="ValidationSummary2" runat="server" Font-Size="Small" ShowMessageBox="True"
                        ShowSummary="False" ValidationGroup="2" Width="232px" Height="1px" />
                            </td>
                            <td align="left" colspan="2" style="font-size: 10pt; position: static; background-color: #cfdcdc; height: 9px;">
