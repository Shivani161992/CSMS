<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master" AutoEventWireup="true" CodeFile="DelProcRcpt_Pdy2016.aspx.cs" Inherits="IssueCenter_DelProcRcpt_Pdy2016" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table align="center" style="border-style: solid; border-width: 1px; text-align: left; font-size: medium; width: 850px" border="1" cellspacing="0" cellpadding="3">
        <tr>
            <td colspan="6" style="text-align: center; font-size: large; text-decoration: underline; color: #CC6600">*<strong>Delete Receipt (Procurement 2016)</strong>*
                <input id="hdfChallan" type="hidden" runat="server" />
            </td>
        </tr>
        ...
        <tr>
            <td align="center" colspan="6"
                ...
                <span style="color: #000099; font-size: small">
                    <span style="font-family: Verdana; text-align: left"><strong>सम्बंधित एंट्री को डिलीट करने की पूर्ण जवाबदारी प्रबंधक एवं उपयोगकर्ता की रहेगी, कृपया जांच कर ही डिलीट करें|</strong></span>
                </span>
                <asp:Image
        ...
        <tr>
            <td>Commodity</td>
            <td>
                <asp:DropDownList ID="ddlcommodtiy" runat="server" Width="141px"  Height="24px" >
                </asp:DropDownList>
        ...
        <tr>
            <td>Issue ID</td>
            <td colspan="3">
                <asp:DropDownList ID="ddlIssueID" runat="server" Width="547px" AutoPostBack="true" Height="24px" OnSelectedIndexChanged="ddlIssueID_SelectedIndexChanged">
                </asp:DropDownList>
