<%@ Page Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master" AutoEventWireup="true" CodeFile="DepositerForm_ProcCSM2018.aspx.cs" Inherits="IssueCenter_DepositerForm_ProcCSM2018" Title="" %>
    ...
    <table align="center" style="border-style: solid; border-width: 1px; text-align: left; font-size: medium; width: 850px" border="1" cellspacing="0" cellpadding="3">
        ...
        <tr>
            ...
            <td>
                ...
                <img src="../PaddyMilling/calendar/cal.gif" align='absmiddle' onmouseover="fnInitCalendar(this, 'ctl00_ContentPlaceHolder1_DaintyDate3' , 'expiry=true,elapse=-480,restrict=true,close=true')" />
        ...
        <tr>
            <td visible = "false">Godown Name</td>
            <td colspan="3">
        ...
        <tr>
            <td colspan="6" style="text-align: center; font-size: large;">
                ...
                <asp:Button ID="btnPrint" runat="server" BackColor="Silver" 
                    ...
                    CausesValidation="False" OnClick="btnPrint_Click1" Visible="False" />
