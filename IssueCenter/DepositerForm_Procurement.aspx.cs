...
public partial class IssueCenter_DepositerForm_Procurement : System.Web.UI.Page
{
   ...
   // public SqlConnection con_Maze = new SqlConnection(ConfigurationManager.ConnectionStrings["Appconstr_MPMS2015_16"].ToString());
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["dist_id"] != null)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    string getcom = "SELECT Commodity_Name ,Commodity_Id FROM tbl_MetaData_STORAGE_COMMODITY where  Commodity_Id in ('22') order by Commodity_Name desc";
                ...
                HyperLink1.Attributes.Add("onclick", "window.open('Print_WHRRequest.aspx',null,'left=50, top=10, height=570, width= 690, status=no, resizable= no, scrollbars= no, toolbar= no,location= no, menubar= no');");
    ...
    void GetGodown()
    {
        ...
        else
        {
            ...
            {
                string qry = "SELECT distinct Recd_Godown ,GodownName FROM SCSC_Procurement2016 where Acceptance_Date = '" + pdate + "' and AN_Status = 'Y' and Distt_ID = '" + distid + "' and IssueCenter_ID = '" + issueid + "' and Commodity_Id = '" + ddlcommodtiy.SelectedValue + "' and SCSC_Procurement2016.Receipt_Id in (select IssueID from Acceptance_Note_Detail2016 where WHR_Request is null and Distt_ID = '" + distid + "' and IssueCenter_ID = '" + issueid + "' and Acceptance_Date = '" + pdate + "' and CommodityId = '" + ddlcommodtiy.SelectedValue + "')and GodownName is not null";
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        if (ddlcommodtiy.SelectedValue == "22")
        {
            ...
            cmdacno.CommandText = "prc_getMaxdepositNo2016";
            ...
            foreach (GridViewRow gr in GridView2.Rows)
            {
                ...
                string updatecsms = "Update Acceptance_Note_Detail2016 set WHR_Request = '" + whr_ID + "' , Updates_Date =  getdate() where Distt_ID = '" + distid + "' and IssueCenter_ID = '" + issueid + "' and Purchase_Center = '" + socid + "' and TC_Number = '" + TCnum + "' and godown = '" + godown + "' and IssueID = '" + ReceiptId + "'";
