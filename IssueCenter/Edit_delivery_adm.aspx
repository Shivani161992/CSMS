<%@ Page Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master"  AutoEventWireup="true" CodeFile="Edit_delivery_adm.aspx.cs" Inherits="Edit_delivery_adm" Title="Delivery Order" %>
        ...
        <tr><td align="center" style="background-color: #cccccc;">
            ...
            <tr>
                ...
                <legend>
                 Permit / Release Order Details
                    ...
                    <table style="width: 744px; background-color: lightblue;" border="1" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="7" style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc;" align="left">
                                <asp:Label ID="Label1" runat="server" ForeColor="Blue" Font-Size="Medium" Font-Italic="True"></asp:Label></td>
                        </tr>
                        <tr>
                            <td style="width: 144px; font-size: 10pt; position: static; background-color: #cfdcdc;" align="left">
                                DO No.</td>
                            <td style="width: 144px; font-size: 10pt; position: static; background-color: #cfdcdc;" align="left">
                            ...
                            <td style="width: 144px; font-size: 10pt; position: static; background-color: #cfdcdc;" align="left">
                                 ...
                                 <asp:TextBox ID="tx_do_date" runat="server"></asp:TextBox>
                      <script type  ="text/javascript">
                                                	new tcal ({
				'formname': '0',
				'controlname': 'ctl00_ContentPlaceHolder1_tx_do_date'
                            ...
                            <td style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc;" align="left">
                                DO Validity</td>
                            <td style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc;" align="left" colspan="2">
                            
                              <asp:TextBox ID="tx_do_validity" runat="server"></asp:TextBox>
                      <script type  ="text/javascript">
                                                	new tcal ({
				'formname': '0',
				'controlname': 'ctl00_ContentPlaceHolder1_tx_do_validity'
                        ...
                        <tr>
                            ...
                            <td align="left" style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc;">
                                Permit Date</td>
                            <td align="left" colspan="2" style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc;">
				...
				'controlname': 'ctl00_ContentPlaceHolder1_tx_permit_date'
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="2" style="font-size: 10pt; position: static; width: 144px; background-color: #cfdcdc;">
                                Balance Stock of Commodity</td>
                            <td align="left" style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc;">
                                <asp:TextBox ID="txtcomdty_bal" runat="server" BackColor="Linen" Font-Bold="False"
                                    ForeColor="Black" Width="91px"></asp:TextBox>Qtls.</td>
                            <td align="left" style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc;">
                                Rate Type</td>
                            <td align="left" style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc;">
                        ...
                        <tr>
                            <td align="left" colspan="3" style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc;">
                        ...
                        <tr>
                            <td colspan="3" style="font-size: 10pt; position: static; background-color: #cfdcc8;" align="left">
                                Rate/Qtls.
                                <asp:TextBox ID="tx_rate_qt" runat="server" BackColor="Linen" MaxLength="8"
                            ...
                            <td style="font-size: 10pt; position: static; background-color: #cfdcc8;" colspan="4" align="left">
                                ...
                                &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; Amount
                                <asp:TextBox ID="tx_tot_amt" runat="server" BackColor="Linen" MaxLength="8"
            ...
            <td style="vertical-align: top; text-align: left;">
                ...
                Payment Details
                    ...
                    <table style="width: 746px; background-color: lightsteelblue;" border="1" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc;">
                                Payment Mode</td>
                            <td style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc;" align="left">
                            ...
                            <td style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc;" colspan="2" align="left">
                                DD/Chq. No.
				...
				'controlname': 'ctl00_ContentPlaceHolder1_tx_dd_date'
                        ...
                        <tr>
                            <td style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc;" align="left">
                                Bank Name</td>
                            <td style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc;" align="left" colspan="3">
                                <strong>
                                    <asp:DropDownList ID="ddl_bank" runat="server">
                                    </asp:DropDownList></strong></td>
                            <td style="width: 144px; font-size: 10pt; position: static; background-color: #cfdcdc;" align="left">Amount</td>
                            <td style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc;" align="left">
                        ...
                        <tr>
                            <td style="width: 144px; font-size: 10pt; position: static; background-color: #cfdcdc;">
                                &nbsp;</td>
                            <td style="width: 144px; font-size: 10pt; position: static; background-color: #cfdcdc;">
                                <asp:Button ID="save" runat="server" Text="Save DO Details" Font-Bold="True" Font-Size="Small" OnClick="save_Click" ValidationGroup="1" /></td>
                            <td style="width: 144px; font-size: 10pt; position: static; background-color: #cfdcdc;">
                                &nbsp;</td>
                            <td style="width: 144px; font-size: 10pt; position: static; background-color: #cfdcdc;">
                                &nbsp;<asp:Button ID="Add_fps" runat="server" Font-Bold="True" OnClick="Add_fps_Click"
                                    Text="Save FPS Details" /></td>
                            <td style="width: 144px; font-size: 10pt; position: static; background-color: #cfdcdc;">
                            <asp:Button ID="delete_do" runat="server" Text="Delete DO" Font-Bold="True" Font-Size="Small" OnClick="delete_do_Click"/></td>
                            <td style="font-size: 10pt; width: 144px; position: static; background-color: #cfdcdc">
