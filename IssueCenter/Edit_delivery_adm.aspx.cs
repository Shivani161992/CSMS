...
using Data;
using DataAccess;
public partial class Edit_delivery_adm : System.Web.UI.Page
{
    Districts DObj = null;
    ...
    protected void get_do_no()
    {
       ...
       // tx_issueto.Text = "";
        ...
        cmd.CommandText = "select delivery_order_no from dbo.delivery_order_mpscsc where district_code='" + dist + "' and issueCentre_code='" + sid + "'  order by  created_date desc";
        cmd.Connection = con;
        con.Open();
        dr = cmd.ExecuteReader();
        while (dr.Read())
    ...
    protected void ddl_do_no_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddl_do_no.SelectedItem.Text == "Select")
        {
            ...
            Session["dono"] = null;
            Response.Redirect("~/IssueCenter/Edit_delivery_adm.aspx");
        }
        else
        {
            tx_permit_no.Text = "";
    ...
    protected void get_do_data()
    {
        ...
        dr.Close();
        string isuueqty = "";
        cmd.CommandText = "SELECT * FROM dbo.issue_against_do where delivery_order_no='" + do_no + "' and district_code='" + dist + "' and issueCentre_code='" + sid + "' and  allotment_month=" + ddl_allot_month.SelectedItem.Value + " and allotment_year=" + ddd_allot_year.SelectedItem.Text + "";
        cmd.Connection = con;
        dr = cmd.ExecuteReader();
        while (dr.Read())
        {
        ...
        tx_do_date.Text = (Convert.ToDateTime(do_date)).ToString ();
        tx_permit_date.Text =(Convert.ToDateTime(permit_date)).ToString ();
        tx_do_validity.Text =(Convert.ToDateTime(dovalidity)).ToString ();
        tx_dd_date.Text =(Convert.ToDateTime(dd_date)).ToString ();
  ...
  protected  decimal CheckNull(string Val)
    ...
    protected void delEdit_fps()
    {
        ...
        {           
            ...
            con.Open();
            cmd.ExecuteNonQuery();
            str1 = "delete from dbo.Issued_do_fps where delivery_order_no='" + do_no + "' and district_code='" + distid + "' and issueCentre_code='" + sid + "' and  allotment_month=" + ddl_allot_month.SelectedItem.Value + " and allotment_year=" + ddd_allot_year.SelectedItem.Text + " and fps_code='" + fpscode + "' and commodity='" + commcode + "' and scheme_id='" + schemecode + "'";
            cmd.CommandText = str1;
            cmd.Connection = con;          
            cmd.ExecuteNonQuery();
    ...
    {        
        ...
        {   
           ...
           if (temp == "YYY")
           {
               ...
               cmd.Connection = con;
               cmd.ExecuteNonQuery();
               str1 = "delete from dbo.Issued_do_fps where delivery_order_no='" + ddl_do_no.SelectedItem.Text + "' and district_code='" + distid + "' and issueCentre_code='" + sid + "' and  allotment_month=" + ddl_allot_month.SelectedItem.Value + " and allotment_year=" + ddd_allot_year.SelectedItem.Text + "";
               cmd.CommandText = str1;
               cmd.Connection = con;
               cmd.ExecuteNonQuery();
           }
    ...
    protected void Add_fps_Click(object sender, EventArgs e)
    {
        if (ddl_do_no.SelectedItem.Text == "Select")
        {
            Page.RegisterClientScriptBlock("asdsad", "<script language=javascript > alert('Please Select DO Number ...');</script>");
        }
        else
        {
            Label1.Text = "";
                    ...
                    if (count > 0)
                    {
                        if (issutype == "LF" || issutype == "F")
                        {
                            ...
                            while (i < count)
                            {
                                ...
                                if (temp1 == "YYY")
                                {
                                    str1 = "INSERT INTO dbo.do_fps(trans_id,delivery_order_no,district_code,issueCentre_code,allotment_month,allotment_year,block_code,fps_code,commodity,scheme_id,allot_qty,quantity,rate_per_qtls,status,ip_add)VALUES('" + transid + "','" + do_no + "','" + distid + "','" + sid + "'," + ddl_allot_month.SelectedItem.Value + "," + ddd_allot_year.SelectedItem.Text + ",'" + dt.Rows[i][0] + "','" + dt.Rows[i][1] + "','" + dt.Rows[i][3] + "','" + dt.Rows[i][5] + "','" + dt.Rows[i][10] + "'," + dt.Rows[i][8] + "," + dt.Rows[i][7] + ",'N','135.256.35.245')";
                                    cmd.CommandText = str1;
                                    cmd.Connection = con;
                                    cmd.ExecuteNonQuery();
                                    ...
                                    {
                                        strr = "INSERT INTO pds.fps_allot_mpsc( district_code,block_code, depot_code , fps_code, month, Year," + commodity + ",initial_creation) values ('" + distid + "','" + dt.Rows[i][0] + "','" + sid + "','" + dt.Rows[i][1] + "'," + ddl_allot_month.SelectedItem.Value + "," + ddd_allot_year.SelectedItem.Text + ",'" + dt.Rows[i][10] + "',getdate())";
                                    }
                                    cmd.CommandText = strr;
                                    cmd.Connection = con;
                                    cmd.ExecuteNonQuery();
                                ...
                                int trnscnt1 = 0;
                                string docount1 = "";
                                string strqr1 = "select max(convert(int,right(trans_id,len(trans_id)-len(allotment_year)-len(district_code)-len(delivery_order_no)-3))) as rwcount  from dbo.Issued_do_fps where delivery_order_no='" + do_no + "' and district_code='" + dist + "'";
                                ...
                                trnscnt1 = trnscnt1 + 1;
                                transid1 = ddd_allot_year.SelectedItem.Text + "-" +  dist.ToString() + "-" + do_no.ToString() + "-" + (trnscnt1).ToString();
                                str1 = "select * from dbo.Issued_do_fps where delivery_order_no='" + do_no + "' and district_code='" + distid + "' and issueCentre_code='" + sid + "' and  allotment_month=" + ddl_allot_month.SelectedItem.Value + " and allotment_year=" + ddd_allot_year.SelectedItem.Text + "  and fps_code='" + fpscode + "' and commodity='" + commcode + "' and scheme_id='" + schemecode + "'";
                                cmd.CommandText = str1;
                                cmd.Connection = con;
                                dr = cmd.ExecuteReader();
                                while (dr.Read())
                                ...
                                if (temp11 == "YYY")
                                {
                                    str1 = "INSERT INTO dbo.Issued_do_fps(trans_id,delivery_order_no,district_code,issueCentre_code,allotment_month,allotment_year,fps_code,commodity,scheme_id,issue_qty,lift_qty,trans_date,ip_add)VALUES('" + transid + "','" + do_no + "','" + distid + "','" + sid + "'," + ddl_allot_month.SelectedItem.Value + "," + ddd_allot_year.SelectedItem.Text + ",'" + dt.Rows[i][1] + "','" + dt.Rows[i][3] + "','" + dt.Rows[i][5] + "','" + dt.Rows[i][8] + "'," + dt.Rows[i][8] + ",getdate(),'135.256.35.245')";
                                    cmd.CommandText = str1;
                                    cmd.Connection = con;
                                    cmd.ExecuteNonQuery();
                                }
    ...
    protected void delete_do_Click(object sender, EventArgs e)
    {
        if (ddl_do_no.SelectedItem.Text == "Select")
        {
            Page.RegisterClientScriptBlock("asdsad", "<script language=javascript > alert('Please Select DO Number ...');</script>");           
        ...
        else
        {
            ...
            {
                con.Open();
                string str1 = "update dbo.Dccb_Permit set status='N' where district_code='" + distid + "' and issueCentre_code='" + sid + "' and Permit_order_no='" + tx_permit_no.Text + "'";
                cmd.CommandText = str1;
                cmd.Connection = con;           
                cmd.ExecuteNonQuery();
                str1 = "delete from dbo.delivery_order_mpscsc where delivery_order_no='" + ddl_do_no.SelectedItem.Text  + "' and district_code='" + distid + "' and issueCentre_code='" + sid + "' and allotment_month=" + ddl_allot_month.SelectedItem.Value + " and allotment_year=" + ddd_allot_year.SelectedItem.Text + "";
                cmd.CommandText = str1;
                cmd.Connection = con;
                cmd.ExecuteNonQuery();
                str1 = "delete from dbo.issue_against_do where delivery_order_no='" + ddl_do_no.SelectedItem.Text + "' and district_code='" + distid + "' and issueCentre_code='" + sid + "' and allotment_month=" + ddl_allot_month.SelectedItem.Value + " and allotment_year=" + ddd_allot_year.SelectedItem.Text + "";
                cmd.CommandText = str1;
                cmd.Connection = con;
                cmd.ExecuteNonQuery();
                Page.RegisterClientScriptBlock("asdsad", "<script language=javascript > alert('Data Updated Successfully ...');</script>");
