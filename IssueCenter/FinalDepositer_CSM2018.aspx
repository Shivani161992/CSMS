<%@ Page Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master" AutoEventWireup="true" CodeFile="FinalDepositer_CSM2018.aspx.cs" Inherits="IssueCenter_FinalDepositer_CSM2018" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        function validate() {
            if (Page_ClientValidate())
                return confirm('आपके व्‍दारा चुने गये समस्‍त Provisional Depositer पत्रक का अंतिम डिपाजिट फार्म बनाया जा रहा है,अंतिम डिपाजिट पत्रक बनानें के बाद डिलीट अथवा सुधार की कोई व्‍यवस्‍था नहीं है| क्या आपने जानकारी जांच ली हैं? यदि हाँ, तो OK पर क्लिक करे अन्यथा Cancel पर क्लिक करे|'); 
                        }
    </script>
    ...
    <table align="center" 
        ...
        <tr>
            <td colspan="6" style="text-align: center; font-size: large; text-decoration: underline; color: #CC6600">
                <strong>&nbsp;Final Depositer Form (Chana 
        ...
        <tr>
            ...
            <td>Select Provisional Depositer</td>
            <td>
                <asp:DropDownList ID="ddl_ProDepositer" runat="server" Width="270px" 
                    AutoPostBack="true" Style="height: 22px" Visible = "true" 
                    onselectedindexchanged="ddl_ProDepositer_SelectedIndexChanged">
        ...
        <tr>
            <td colspan="6" font-size: large; class="style1">
                फाइनल डिपोजिट आर्डर का प्रिंट करने के पश्चात ही ये डाटा वेयरहाउस सॉफ्टवेयर पर 
                W.H.R. के लिए ट्रान्सफर होगा |</td>
        </tr>
