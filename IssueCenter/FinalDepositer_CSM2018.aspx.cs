...
public partial class IssueCenter_FinalDepositer_CSM2018 : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd, cmd1;
            ...
            if (Session["update"].ToString() == ViewState["update"].ToString())
            {
                using (con = new SqlConnection(Con_CSMS))
                {
                    try
                    {
                        ...
                        cmdacno.CommandText = "getMAxDepositer_FinalCSM18";
