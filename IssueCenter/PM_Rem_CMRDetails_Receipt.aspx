<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master" AutoEventWireup="true" CodeFile="PM_Rem_CMRDetails_Receipt.aspx.cs" Inherits="IssueCenter_PM_Rem_CMRDetails_Receipt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <script type="text/javascript">
    ...
    <script type="text/javascript" lang="" src="../PaddyMilling/calendar/calendarLot.js"></script>
     ...
     <table id="Table1" runat="server" style="width: 1000px; background-color: #FFFACD;" border="1">
            <tr>
           ...
           <tr>
                ...
                <td style="width: 300px; color: #556B2F; text-align: left; background-color: #FFFAF0; font-size: medium;">
                    <asp:DropDownList ID="ddlAgreeDist" runat="server" Width="300px" CssClass="tddl"  AutoPostBack="True" OnSelectedIndexChanged="ddlAgreeDist_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            ...
            <tr>
                ...
                <td colspan="3" style="width: 300px; color: #556B2F; text-align: left; background-color: #FFFAF0; font-size: medium;">
                    <asp:DropDownList ID="ddlMillName" runat="server" Width="600px" CssClass="tddl" AutoPostBack="True" OnSelectedIndexChanged="ddlMillName_SelectedIndexChanged">
                    </asp:DropDownList>
                    <asp:Label ID="lblMillingType" runat="server" Text="Label" Visible="false"></asp:Label>
                </td>
            ...
            <tr>
                ...
                <td style="width: 300px; color: #556B2F; text-align: left; background-color: #FFFAF0; font-size: medium;">
                    <asp:DropDownList ID="ddlAgreeNo" runat="server" Width="300px" CssClass="tddl"  AutoPostBack="True" OnSelectedIndexChanged="ddlAgreeNo_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
                ...
                <td style="width: 300px; color: #556B2F; text-align: left; background-color: #FFFAF0; font-size: medium;">
                    <asp:DropDownList ID="ddlCMRDO" runat="server" Width="300px" CssClass="tddl"  AutoPostBack="True" OnSelectedIndexChanged="ddlCMRDO_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td  style="width: 200px; color: #556B2F; text-align: left; background-color: #FFFACD; font-size: large;">
                    <asp:TextBox ID="txtLotNumber" CssClass="tcolumn" Width="250px" Enabled="false" runat="server"></asp:TextBox>
                ...
                <td colspan="4" style="width: 1000px; height: 15px; text-align: center; background-color: #FFFAFA">
                    <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False" ShowFooter="True" CellPadding="4" EnableModelValidation="True" ForeColor="#333333" GridLines="None"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="todisttext" HeaderText="Agreement Number" />
                            <asp:BoundField DataField="fromdistval" HeaderText="CMR DO Number" />
           ...
           <tr>
                ...
                <td style="width: 300px; color: #556B2F; text-align: left; background-color: #FFFAF0; font-size: medium;">
                    <asp:TextBox ID="txtCmrQuanitity" CssClass="tcolumn" Width="300px" Height="18px" AutoPostBack="true" OnTextChanged="txtCmrQuanitity_TextChanged" Enabled="true" runat="server"></asp:TextBox>
                </td>
                <td style="width: 200px; color: #556B2F; text-align: left; background-color: #FFFACD; font-size: large;">
                    <strong>Recd. No. of Bags</strong>
                </td>
                <td style="width: 300px; color: #556B2F; text-align: left; background-color: #FFFAF0; font-size: medium;">
                    <asp:TextBox ID="txtNoOfBags" CssClass="tcolumn" Width="300px" Height="18px" Enabled="true" AutoPostBack="true" OnTextChanged="txtNoOfBags_TextChanged" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td style="width: 200px; color: #556B2F; text-align: left; background-color: #FFFACD; font-size: large;">
                        <asp:TextBox ID="txtTruckNoOne" runat="server" AutoComplete="off" Class="TruckNumber" MaxLength="14" onfocus="this.select();" onmouseup="return false;" Width="137px"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="width: 200px; color: #556B2F; text-align: left; background-color: #FFFACD; font-size: large;">
                         <asp:TextBox ID="txtDate" CssClass="tcolumn" Width="200px" Enabled="true" runat="server"></asp:TextBox>
                    ...
                    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDate" ErrorMessage="RequiredFieldValidator" Font-Bold="False" SetFocusOnError="True">**</asp:RequiredFieldValidator>--%>
            ...
            <tr>
                <td colspan="4" style="text-align: center; font-size: large; text-decoration: underline; color: #F0E68C; border-style: none; background-color: #800000;"><b style="color: #FFFF66"> CMR Receving Destination</b></td>
            </tr>

          <tr>
                <td style="width: 200px; color: #556B2F; text-align: left; background-color: #FFFACD; font-size: large;">
                    <strong>CMR Receiving District</strong>
                </td>
                <td style="width: 300px; color: #556B2F; text-align: left; background-color: #FFFAF0; font-size: medium;">
                    <asp:TextBox ID="txtRecDist" CssClass="tcolumn" Width="300px" Enabled="false" runat="server"></asp:TextBox>
                </td>
                <td style="width: 200px; color: #556B2F; text-align: left; background-color: #FFFAF0; font-size: large;">
                    <strong>Issue Center</strong>
                </td>
                <td style="width: 300px; color: #556B2F; text-align: left; background-color: #FFFAF0; font-size: medium;">
                    <asp:TextBox ID="txtIssueCenter" CssClass="tcolumn" Width="300px" Enabled="false" runat="server"></asp:TextBox>
                </td>
            </tr>
         <tr>
                <td style="width: 200px; color: #556B2F; text-align: left; background-color: #FFFACD; font-size: large;">
                ...
                <td style="width: 300px; color: #556B2F; text-align: left; background-color: #FFFAF0; font-size: medium;">
                    <asp:DropDownList ID="ddlBranch" runat="server" Width="300px" CssClass="tddl"  AutoPostBack="True" OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
                <td style="width: 200px; color: #556B2F; text-align: left; background-color: #FFFAF0; font-size: large;">
                ...
                <td style="width: 300px; color: #556B2F; text-align: left; background-color: #FFFAF0; font-size: medium;">
                   <asp:DropDownList ID="ddlGodam" runat="server" Width="300px" CssClass="tddl"  AutoPostBack="True" OnSelectedIndexChanged="ddlGodam_SelectedIndexChanged" >
                    </asp:DropDownList>
                </td>
            </tr>
         </table>
