<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print_DO_PDSMO.aspx.cs" Inherits="IssueCenter_Print_DO_PDSMO" %>
    ...
    <form id="form1" runat="server">
        <div class="A4">
            ...
            <table align="center" class="auto-style1">
                ...
                <tr>
                    <td style="text-align: center" class="auto-style3"><strong>&lt;&lt; डिलेवरी चालान &gt;&gt;
                    </strong></td>
            ...
            <table align="center" class="auto-style1">
                <tr>
                    <td style="text-align: left">डिलेवरी चालान क्रमांक : ....<asp:Label ID="lblDONo" runat="server" Text=""></asp:Label>....</td>
                ...
                <tr>
                    <td style="text-align: justify" colspan="2">&nbsp;&nbsp;१. मुख्यालय का MOVEMENT ORDER क्रमांक ....<asp:Label ID="lblMovmtNo" runat="server" Text=""></asp:Label>.... दिनांक ....<asp:Label ID="lblMODate" runat="server"></asp:Label>....</td>
                </tr>

                <tr>
                    <td style="text-align: justify" colspan="2">&nbsp;&nbsp;२. परिवहन आदेश क्रमांक ....<asp:Label ID="lblTOno" runat="server" Text=""></asp:Label>....<asp:Label ID="lblTransporterName" runat="server" Text=""></asp:Label>.... दिनांक ....<asp:Label ID="lblTOEndDate" runat="server" Text=""></asp:Label>....</td>
                </tr>
                ...
                <tr>
                    <td style="text-align: justify" colspan="2">&nbsp; संदर्भित आदेश&nbsp;के अनुक्रम में निम्नानुसार स्कंध, ब्रांच ....<asp:Label ID="lblBranch" runat="server" Text=""></asp:Label>.... गोदाम ....<asp:Label ID="lblGodown" runat="server" Text=""></asp:Label>.... से जारी किया जा रहा है |</td>
                </tr>
            ...
            <table align="center" class="auto-style1">
                ...
                <tr>
                    <td runat="server" id="RowRoad" style="text-align: justify" colspan="2">&nbsp; उक्त स्कंध जिला कार्यालय ....<asp:Label ID="lblToDistName" runat="server" Text=""></asp:Label>.... के प्रदाय केंद्र ....<asp:Label ID="lblToIC" runat="server" Text=""></asp:Label>.... ब्रांच ....<asp:Label ID="lblToBranch" runat="server" Text=""></asp:Label>.... गोदाम ....<asp:Label ID="lblToGodown" runat="server" Text=""></asp:Label>.... पर जमा किया जाना है |</td>
