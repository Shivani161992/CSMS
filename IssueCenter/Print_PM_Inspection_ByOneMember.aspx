<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print_PM_Inspection_ByOneMember.aspx.cs" Inherits="IssueCenter_Print_PM_Inspection_ByOneMember" %>

<%@ PreviousPageType VirtualPath="~/IssueCenter/PM_Inspection_ByOneMember.aspx" %>
...
<head id="Head1" runat="server">
    ...
    <form id="form1" runat="server">
        ...
        <div class="A4">
            ...
            <table align="center" class="auto-style1" runat="server" style="width:925px">
                <tr>
                    <td colspan="2">
                        Acceptance/Rejection&nbsp;No.
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        Sub:-&nbsp; Inspection Of your District Godown Comodity:-....<asp:Label ID="lblcommo" runat="server" Font-Bold="True"></asp:Label>....</td>
                    <td>
                ...
                <tr>
                 ...
                 <tr>
                    <td colspan="4">
                       आपके जिले के गोदामो में संगृहीत स्कंध की गुणवक्ता की जांच निम्म विवरण अनुसार की गईएंव जांच में निम्म घटक पाये गये जिसके आधार पर स्टैक की मात्रा को रिजेक्ट किया जाता है अथवा सविप्र में वितरण योग्य पाया गया|
                    </td>
                ...
                <tr>
                    <td>
                        ...
                        Miller&#39;s Name:-....</td>
                    <td>
                        ....<asp:Label ID="lblmillname" runat="server" Font-Bold="True"></asp:Label>....
                    </td>
                    <td>
Miller&#39;s District:-....
                    </td>
                    <td>
                        ...
                        ....<asp:Label ID="lblmilldistrict" runat="server" Font-Bold="True"></asp:Label>....</td>
                </tr>
                    ...
                    <td colspan="4">
                       <table style="width:900px;">
                           <tr  >
                               ...
                               <td>
                                    ....<asp:Label ID="lblmillone" runat="server" Font-Bold="True"></asp:Label>....
                               </td>
                               <td>
Miller&#39;s District:-....
                               </td>
                               <td>
 ....<asp:Label ID="lbldistone" runat="server" Font-Bold="True"></asp:Label>....
                               </td>
                           </tr>
                           <tr>
                               <td>
                               ...
                               <td>
                                ...
                                ....<asp:Label ID="lblmilltwo" runat="server" Font-Bold="True"></asp:Label>....</td>
                               <td>
Miller&#39;s District:-....
                               </td>
                               <td>
                                    ....<asp:Label ID="lbldisttwo" runat="server" Font-Bold="True"></asp:Label>....
                               </td>
                           </tr>
                           <tr>
                               <td>
                               ...
                               <td>
                                    ....<asp:Label ID="lblmillthree" runat="server" Font-Bold="True"></asp:Label>....
                               </td>
                               <td>
Miller&#39;s District:-....
                               </td>
                               <td>
 ....<asp:Label ID="lbldistthree" runat="server" Font-Bold="True"></asp:Label>....
                               </td>
                           </tr>
                           <tr>
                               <td>
                               ...
                               <td>
                                ...
                                ....<asp:Label ID="lblmillfour" runat="server" Font-Bold="True"></asp:Label>....</td>
                               <td>
Miller&#39;s District:-....
                               </td>
                               <td>
 ....<asp:Label ID="lbldistfour" runat="server" Font-Bold="True"></asp:Label>....
                               </td>
                           </tr>
                       </table>
                    </td>
            ...
            <tr>
                ...
                <td style="height: 51px"><asp:Label ID="Label10" runat="server"></asp:Label>
                    </td>
            </tr>
            ...
            <table align="center" class="auto-style1" style="width:925px" runat="server">
                ...
                <tr>
                    ...
                    <td>
                        ....<asp:Label ID="lblinspdate" runat="server" Font-Bold="True"></asp:Label>....
                    </td>
                     <td>
                         बोरों की संख्या
                    </td>
                ...
                <tr>
                    <td >
                     ...
                     <td>
                         ....<asp:Label ID="lbldistinspone" runat="server" Font-Bold="True"></asp:Label>....
                    </td>
                     <td>
                           प्रदाय केंद्र का नाम
                    </td>
                     <td>
....<asp:Label ID="lblIC" runat="server" Font-Bold="True"></asp:Label>....
                 ...
                 <tr>
                    <td >
                      ...
                      <td>
                          ....<asp:Label ID="lblgodown" runat="server" Font-Bold="True"></asp:Label>....
                    </td>
                      <td>
  स्टैक क्रिमंक
                    </td>
                      <td>
....<asp:Label ID="lblstack" runat="server" Font-Bold="True"></asp:Label>....
                    </td>
                </tr>
                 <tr>
                    <td >
                  गोदाम इंस्पेक्टर का नाम
                    </td>
                      <td>
                          ....<asp:Label ID="lblinspname" runat="server" Font-Bold="True"></asp:Label>....
                    </td>
                      <td>
 गोदाम इंस्पेक्टर का पद
                    </td>
                      <td>
                          ....<asp:Label ID="lblinspdesg" runat="server" Font-Bold="True"></asp:Label>....
                    </td>
