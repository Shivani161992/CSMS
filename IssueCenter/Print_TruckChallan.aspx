...
<body>
    ...
    <td colspan ="2"> 
        <asp:Label ID="titlempscsc" runat="server" Text=" म. प्र. स्टेट सिविल सप्लाईज कर्पोरेशन लि." ForeColor ="Maroon" Font-Size ="20px"></asp:Label>
                ...
                <td style="height: 29px"> 
                    --जिला--;<asp:Label ID="lbldepott" runat="server" Text="Depot:">
    ...
    <tr> 
    <td align ="left" style="font-size: 10pt; width: 222px;">
       बुक नम्बर 
    </td>
    ...
    <td style="font-size: 10pt"> </td>
     ...
     <tr> 
    <td align ="left" style="font-size: 10pt; width: 222px;">
        संग्रहण केन्द्र का नाम
    </td>
    <td align ="left" style="width: 163px"> 
       :<asp:Label ID="lblpname" runat="server"></asp:Label></td>
    <td align ="left"> </td>
    <td align ="left">
        &nbsp;</td>
    </tr>
    ...
    <tr> 
    <td align ="left" style="font-size: 10pt; width: 222px;"> स्कन्ध भेजने की तारीख 
    </td>
    ...
    <tr style="font-size: 12pt"> 
    <td align ="left" style="font-size: 10pt; width: 222px;"> स्कन्ध का नाम</td>
    ...
    <tr> 
    <td style="width: 222px; font-size: 12px;">
        हस्ताक्षर
    </td>
    <td style="width: 163px"> </td>
    <td> </td>
    ...
    <tr> 
    <td style="width: 222px; font-size: 12px;"> ट्रक ड्राइवर / परिवाहन ठेकेदार </td>
    <td style="width: 163px"> </td>
