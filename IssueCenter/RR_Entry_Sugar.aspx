<%@ Page Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master" AutoEventWireup="true" CodeFile="RR_Entry_Sugar.aspx.cs" Inherits="IssueCenter_RR_Entry_Sugar" Title="R.R. Entry" %>
...
if (count > 5)  
{
 ...
 <table border="1" cellpadding="0" cellspacing="0" style="padding:1; BORDER-COLLAPSE: collapse;  border-right: navy 3px double; border-top: navy 3px double; border-left: navy 3px double; border-bottom: navy 3px double; width: 602px;" >
     <tr>
     ...
     <tr>
         <td align="left" class="tdmarginro" style="font-size: 10pt; position: static; background-color: #cfdcdc">
         </td>
         <td align="center" colspan="2" style="color: white; background-color: lightslategray">
             From Sugar Factory</td>
         <td align="left" class="tdmarginro" style="font-size: 10pt; position: static; background-color: #cfdcdc">
         </td>
     </tr>
     <tr>
     ...
     <tr>
         <td align="left" style="font-size: 10pt; position: static; height: 33px; background-color: #cfdcdc">
         ...
         <td align="left" style="font-size: 10pt; position: static; height: 33px; background-color: #cfdcdc">
             <asp:TextBox ID="txtrackno" runat="server" OnTextChanged="txtrackno_TextChanged" Width="147px"></asp:TextBox></td>
     </tr>
     <tr>
         <td  style="font-size: 10pt; position: static; height: 33px; background-color: #cfdcdc;" align="left">
             <asp:Label ID="lblChallanNumber" runat="server" Text="Select Challan No."></asp:Label></td>
         <td  style="font-size: 10pt; position: static; height: 33px; background-color: #cfdcdc;" align="left">
             <asp:DropDownList ID="ddlchallan" runat="server"  Width ="153px" AutoPostBack="True" OnSelectedIndexChanged="ddlchallan_SelectedIndexChanged">
             </asp:DropDownList></td>
         <td  style="font-size: 10pt; position: static; height: 33px; background-color: #cfdcdc" align="left">
           <asp:Label ID="lblChallanNumber1" runat="server" Text="TruckChallan No." Width="98px"></asp:Label></td>
         <td  style="font-size: 10pt; position: static; height: 33px; background-color: #cfdcdc" align="left">
             <asp:TextBox ID="txtchallan" runat="server" Width="147px" ValidationGroup="1"></asp:TextBox>
     ...
     <tr>
       ...
       <asp:Label ID="lblrailhead" runat="server" Text="Sending Rail Head" Width="101px"></asp:Label></td>
         <td style="font-size: 10pt; position: static; background-color: #cfdcdc;" align="left">
             <asp:DropDownList ID="ddlsenrailhead" runat="server"  Width ="153px" AutoPostBack="True" OnSelectedIndexChanged="ddlsenrailhead_SelectedIndexChanged">
         ...
         <asp:TextBox ID="DaintyDate3" runat="server" Width="115px"></asp:TextBox>
                      <script type  ="text/javascript">
                                                	new tcal ({
				'formname': '0',
             ...
             <asp:TextBox ID="txtchalldt" runat="server" Width="113px" Visible="False"></asp:TextBox>
         </td>
     </tr>
     <tr>
         <td  style="font-size: 10pt; position: static; background-color: #cfdcdc" align="left">
         ...
         <td  style="font-size: 10pt; position: static; background-color: #cfdcdc" align="left">
             <asp:TextBox ID="txttruckno" runat="server" Width="147px" OnTextChanged="txttruckno_TextChanged"></asp:TextBox>
     ...
     <tr>
         ...
         <td  style="font-size: 10pt; position: static; background-color: #cfdcdc;" align="left">
             <asp:TextBox ID="txtdisbag" runat="server" Width="147px"></asp:TextBox></td>
         <td  style="font-size: 10pt; position: static; background-color: #cfdcdc" align="left">
         ...
         <td class="tdmarginro" style="font-size: 10pt; position: static; background-color: #cfdcdc" align="left">
             <asp:TextBox ID="txtdisqty" runat="server" Width="147px"></asp:TextBox>Qtls.</td>
     </tr>
     <tr>
         <td  style="font-size: 10pt; position: static; background-color: #cfdcdc;" align="left">
     ...
     <tr>
         ...
         <td  style="font-size: 10pt; position: static; background-color: #cfdcdc" align="left">
             <asp:Label ID="lblsch" runat="server" Visible="False" Width="2px">0</asp:Label></td>
         <td class="tdmarginro" style="font-size: 10pt; position: static; background-color: #cfdcdc" align="left">
         </td>
     </tr>
     <tr>
         ...
         <td  style="font-size: 10pt; position: static; background-color: #cfdcdc;" align="left">
             <asp:TextBox ID="txtrecdbaf" runat="server" Width="147px"></asp:TextBox></td>
         <td  style="font-size: 10pt; position: static; background-color: #cfdcdc;" align="left">
             <asp:Label ID="lblTotalQuantityReceived" runat="server" Text="Received Qty."></asp:Label></td>
         <td  style="font-size: 10pt; position: static; background-color: #cfdcdc;" align="left">
             <asp:TextBox ID="txtrecdqty" runat="server" Width="147px"></asp:TextBox>Qtls.</td>
     </tr>
     <tr>
         <td  style="font-size: 10pt; position: static; background-color: #cfdcdc;" align="left">
         ...
         <td  style="font-size: 10pt; position: static; background-color: #cfdcdc;" align="left">
             <asp:TextBox ID="txtmaxcap" runat="server" Font-Bold="True" Font-Italic="False" ForeColor="#0000C0"
                 ReadOnly="True" Width="147px"></asp:TextBox></td>
     </tr>
     <tr>
         <td  style="font-size: 10pt; position: static; background-color: #cfdcdc;" align="left">
         ...
         <td  style="font-size: 10pt; position: static; background-color: #cfdcdc;" align="left">
             <asp:TextBox ID="txtcurntcap" runat="server" Font-Bold="True" Font-Italic="False"
                 ForeColor="#0000C0" ReadOnly="True" Width="147px"></asp:TextBox></td>
         <td  style="font-size: 10pt; position: static; background-color: #cfdcdc;" align="left">
