<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master" AutoEventWireup="true" CodeFile="RePrintAcpt_Kharif2016.aspx.cs" Inherits="IssueCenter_RePrintAcpt_Kharif2016" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table align="center" style="width: 600px; border-style: solid; border-width: 1px; text-align: left" border="1" cellspacing="0" cellpadding="6">
        <tr>
            <td colspan="4" style="text-align: center"><span style="font-size: large; text-decoration: underline; color: #CC6600; font-weight: bold">Reprint Acceptance Note (Kharif-2016)</span></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="auto-style1" colspan="3">
                <asp:DropDownList ID="ddlGodown" runat="server" Width="261" OnSelectedIndexChanged="ddlGodown_SelectedIndexChanged" AutoPostBack="true">
                </asp:DropDownList>
            </td>
        ...
        <tr>
            ...
            <td class="auto-style1">
                <strong>Acceptance No.</strong></td>

            <td colspan="3">
                <asp:DropDownList ID="ddlReceiptID" runat="server" Width="261px">
                </asp:DropDownList>
