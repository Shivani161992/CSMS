<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master" AutoEventWireup="true" CodeFile="RePrintReceiptEntry_MO.aspx.cs" Inherits="IssueCenter_RePrint_DO_PDSMO" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table align="center" style="width: 600px; border-style: solid; border-width: 1px; text-align: left" border="1" cellspacing="0" cellpadding="6">
        <tr>
            <td colspan="3" style="text-align:center"><span style=" font-size: large; text-decoration: underline; color: #CC6600; font-weight: bold">Reprint Receipt Entry</span></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" style="text-align: center" >
                <strong>Receipt Number</strong>
                   <asp:DropDownList ID="ddlTONumber" runat="server" Width="150px" Style="margin-left: 10px" AutoPostBack="True">
                </asp:DropDownList>
            </td>
            <td class="auto-style3">
