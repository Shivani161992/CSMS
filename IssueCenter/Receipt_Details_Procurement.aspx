<%@ Page Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master" AutoEventWireup="true" CodeFile="Receipt_Details_Procurement.aspx.cs" Inherits="IssueCenter_Receipt_Details_Procurement" Title="Deposit at Issue Centre from Procurement" %>
    ...
    <div id="hedl">
            <span>
                <p align="center" class="MsoNormal" style="margin: 0in 0in 0pt; text-align: center">
                    <span>Deposit at Issue Centre from Procurement</span><b style="mso-bidi-font-weight: normal"><span
                ...
                style="font-size: 14pt; color: red; font-family: Verdana; mso-ansi-language: EN-US"><?xml
                    namespace="" ns="urn:schemas-microsoft-com:office:office" prefix="o" ?><o:p></o:p></span></b></div>
    <div id="ronewmargin">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Acceptance_No" HeaderText="Acceptance No." SortExpression="Acceptance_No" >
                 ...
                 <asp:TemplateField HeaderText="AN Date">
                ...
                <asp:BoundField DataField="Status_Deposit" HeaderText="Status of Deposit" SortExpression="Status_Deposit" >
                    <HeaderStyle CssClass="gridlarohead" />
                </asp:BoundField>
            </Columns>
                    ...
                    <tr>
                                        ...
                                        <td class="tdmarginro" style="width: 119px; background-color: #e3dba4;">
                                            Acceptance Note</td>
                                        <td style="width: 119px; background-color: #e3dba4;">
                                            &nbsp;<asp:TextBox ID="txtacno" runat="server" Width="144px"></asp:TextBox></td>
                                        <td class="tdmarginro" style="width: 119px; background-color: #e3dba4;">
                                            Source Society</td>
                                        <td style="background-color: #e3dba4; width: 119px;">
                                            <asp:TextBox ID="txtsociety" runat="server" Width="110px" ></asp:TextBox>
                                        </td>
                                        <td class="tdmarginro" style="width: 119px; background-color: #e3dba4;">
                                            </td>
                                    </tr>
                    <tr>
                        ...
                        <td class="tdmarginro" style="width: 119px; background-color: #e3dba4">
                            Truck Number</td>
                        <td style="width: 119px; background-color: #e3dba4">
                            &nbsp;<asp:TextBox ID="txttruckno" runat="server" Width="110px"></asp:TextBox></td>
                        <td class="tdmarginro" style="width: 119px; background-color: #e3dba4">
                        </td>
                    </tr>
                                    <tr>
                                        ...
                                        <td style="width: 119px; background-color: #e3dba4; height: 43px;">
                                            &nbsp;<asp:DropDownList ID="ddlcomdty" runat="server" Width="155px" OnSelectedIndexChanged="ddlcomdty_SelectedIndexChanged">
                                            </asp:DropDownList></td>
                                        <td class="tdmarginddl" style="width: 119px; background-color: #e3dba4; height: 43px;">
                                            Category</td>
                                        <td style="background-color: #e3dba4; width: 119px; height: 43px;">
                                            &nbsp;<asp:DropDownList ID="ddlcategory" runat="server" Width="111px" OnSelectedIndexChanged="ddlcategory_SelectedIndexChanged">
                                            </asp:DropDownList></td> 
                    ...
                    <tr>
                        <td class="tdmarginddl" style="width: 119px; background-color: #e3dba4">
                            Quantity Deposit</td>
                        <td style="width: 119px; background-color: #e3dba4">
                            &nbsp;<asp:TextBox ID="txtqty" runat="server" Width="105px" MaxLength="13"></asp:TextBox></td>
                        <td class="tdmarginddl" style="width: 119px; background-color: #e3dba4">
                            Date of Deposit</td>
                        <td class="tdmarginddl" style="width: 119px; background-color: #e3dba4">
				...
				'controlname': 'ctl00_ContentPlaceHolder1_DaintyDate2'
                    ...
                    <tr>
                        <td class="tdmarginddl" style="width: 119px; background-color: #e3dba4">
                            Mode of Weigment</td>
                        <td style="width: 119px; background-color: #e3dba4">
                            <asp:DropDownList ID="txtwmode" runat="server" Width="135px" OnSelectedIndexChanged="txtwmode_SelectedIndexChanged">
        ...
        <table cellpadding ="0" cellspacing ="0" border ="0" class="laromargin" style="border-right: 1px solid; border-top: 1px solid; border-left: 1px solid; border-bottom: 1px solid; background-color: #dad08e">
            ...
            <tr>
                ...
                <td colspan="6">
                    ...
                    <asp:Button ID="btnClose" runat="server" Text="Close" Width="83px" OnClick="btnSave_Click" /></td>
                <td>
                </td>
                <td>
                </td>
