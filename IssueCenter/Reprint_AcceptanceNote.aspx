<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master" AutoEventWireup="true" CodeFile="Reprint_AcceptanceNote.aspx.cs" Inherits="IssueCenter_Reprint_AcceptanceNote" %>
...
<td style="width: 297px; text-align: right; font-family: Georgia; font-size: small; background-color: #FF6600; color: #FFFFCC;">
    Acceptance Note Number:</td>

<td>
                                <asp:DropDownList ID="ddl_Acceptanceno" runat="server" AutoPostBack="True" 
                                    
        OnSelectedIndexChanged="ddl_Acceptanceno_SelectedIndexChanged" Width="233px">
                                </asp:DropDownList>
                            </td>
</tr>
