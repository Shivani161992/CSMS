<%@ Page Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master" AutoEventWireup="true" CodeFile="UparjanReceipt_Year.aspx.cs" Inherits="IssueCenter_UparjanReceipt_Year" Title="ReceiptType" %>
    ...
    <table style="background-color: #cfdcdc; border-right: navy 1px double; border-top: navy 1px double; font-size: 10pt; border-left: navy 1px double; border-bottom: navy 1px double; position: static;" border="1" cellpadding="0" cellspacing="0">
        <tr>
            <td colspan="2" style="color: #0066ff; font-style: italic; height: 36px; background-color: lightslategray;">
                <asp:Label ID="lbldotype" runat="server" Text="Please select Receipt Crop Year" Font-Size="14px" Font-Bold="True" Font-Italic="True" ForeColor="White"></asp:Label></td>
        </tr>
        <tr>
            <td style="width: 140px; height: 53px;" align="right">
                <asp:Label ID="lbldoselect" runat="server" Text="Receipt Crop Year" 
