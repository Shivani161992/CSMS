...
public partial class IssueCenter_UparjanReceipt_Year : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void btnok_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("~/IssueCenter/Scsc_Procurement2015.aspx");
        }
        ...
        {
            Response.Redirect("~/IssueCenter/CSC_Procurement_Kharif2016.aspx");
        }
