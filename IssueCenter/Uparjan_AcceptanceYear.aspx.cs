...
public partial class IssueCenter_Uparjan_AcceptanceYear : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    private void GetOPCommodity()
    {
        using (con = new SqlConnection(Con_CSMS))
        {
            try
            {
                ...
                select = "Select Commodity_Name,Commodity_Id From tbl_MetaData_STORAGE_COMMODITY Where Commodity_Id IN('28') Order By Commodity_Name Desc";
