<%@ Page Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master"  AutoEventWireup="true" CodeFile="delivery.aspx.cs" Inherits="delivery" Title="Delivery Order" %>
...
<script type="text/javascript">
    ...
    <asp:Panel ID="panelDO" runat ="server" Height="808px"  >
        ...
        <tr><td align="center" style="background-color: #cccccc; width: 713px;" valign="top">
            ...
            <tr>
                <td style="width: 713px; height: 610px" valign="top">
                    ...
                    <table border="1" cellpadding="0" cellspacing="0" style="width: 680px">
                        <tr>
                            ...
                            <table style="width: 688px">
                                <tr>
                                    <td colspan="6" style="border-right: silver 1px solid; border-top: silver 1px solid;
                                        ...
                                        <asp:Label ID="lblDist" runat="server" Font-Size="14pt" ForeColor="#C00000" Width="168px"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td colspan="6" style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid">
                            ...
                            <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; background-color: #ffcc66;">
                             ...
                             <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; background-color: #ffcc66;" colspan="5"> 
	...
	new tcal ({
				...
				'controlname': 'ctl00_ContentPlaceHolder1_tx_permit_date'
                                ...
                                <asp:Label ID="lbltoissue" runat="server" Font-Size="12px" Text="Issue To"></asp:Label></td>
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; background-color: #ffcc66;">
                                        <asp:DropDownList ID="ddl_issueto" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddl_issueto_SelectedIndexChanged" Width="184px">
                                    ...
                                    <td colspan="4" style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; background-color: #ffcc66;">
                                        &nbsp;
                                <asp:Label ID="lbl_lead" runat="server" Text="Name" Font-Size="Small" Width="40px" Visible="False"></asp:Label>
                                ...
                                <tr>
                                    <td colspan="2" style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; width: 66px; background-color: #ffffcc;">
                                <asp:Label ID="lbl_curbal" runat="server" Text="Current Balance Eligibility" Width="177px" Visible="False"></asp:Label></td>
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; width: 66px; background-color: #ffffcc;">
                                <asp:TextBox ID="tx_balQty" runat="server" BackColor="MenuBar" MaxLength="8" ReadOnly="True"
                                    Width="58px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"></asp:TextBox><asp:Label ID="lbl_qtcur" runat="server" Text="Qtls." Visible="False"></asp:Label></td>
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; width: 66px; background-color: #ffffcc;">
                                <asp:Label ID="lbl_stock" runat="server" Text="Balance Stock of Commodity/Scheme" Width="176px" Visible = "false"></asp:Label></td>
                                    <td style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; width: 66px; background-color: #ffffcc;">
				...
				'controlname': 'ctl00_ContentPlaceHolder1_tx_do_validity'
                        ...
                        <tr>
                            ...
                            <tr>
                               ...
                               <td align="left" 
                                    style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid">
                                    Search FPS(last 3 digit)</td>
                                <td align="left" 
                                    style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid">
                                    <asp:TextBox ID="txt_fps" runat="server" AutoPostBack="True" 
                                        ontextchanged="txt_fps_TextChanged"></asp:TextBox>
                                </td>
                            </tr>
                                <tr>
                                    <td align="left" colspan="3" 
                                        style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid">
                                                <table style="width: 624px; height: 256px;" border="1">
                                                    <tr>
                                                        <td colspan="2" valign="top" align="left" style="height: 226px">
                                                            <asp:Label ID="lbl_fps" runat="server" ForeColor="Black" Text="FPS"></asp:Label>
                                                            <asp:Label ID="Label4" runat="server" Text="Name"></asp:Label>
                                                            <asp:ListBox
                                                                ID="ddl_fps_name" runat="server" Height="256px" Width="380px" 
                                                                OnSelectedIndexChanged="ddl_fps_name_SelectedIndexChanged" AutoPostBack="True" 
                                                                Font-Size="Smaller"></asp:ListBox></td>
                                                        <td colspan="4" valign="top" style="width: 344px; height: 226px;">
                                ...
                                <asp:TextBox ID="tx_already_iqty2" runat="server" BackColor="MenuBar" MaxLength="8" Width="90px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" ReadOnly="True"></asp:TextBox></td>
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 172px; height: 28px;" contenteditable="">
                                ...
                                <asp:Label ID="lblQuantity" runat="server" Font-Size="12px" ForeColor="Black" Text="Quantity"></asp:Label></td>
                                                                        <td colspan="2" style="height: 22px; width: 128px;">
                        ...
                        <tr>
                            <td align="left" style="font-size: 10pt;  position: static; background-color: #cfdcdc;" colspan="6">
                                &nbsp;<%--       <asp:RequiredFieldValidator
                                    ...
                                    Height="0px" ValidationGroup="1" Width="0px">*</asp:RequiredFieldValidator>--%><asp:Label ID="LbldisplayDo" runat="server" Font-Bold="True" ForeColor="#0000C0"
