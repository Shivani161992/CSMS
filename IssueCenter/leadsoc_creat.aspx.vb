...
Try
        If distname.Text <> "" Then
            ...
            cmds.Connection = con
            Dim dr1 As SqlDataReader
            cmds.CommandText = "select pds.block_master.Block_Uname,pds.block_master.block_code from pds.block_master  where pds.block_master.District_code='" & distcode & "' order by Block_Uname"
            con.Open()
            dr1 = cmds.ExecuteReader()
            While dr1.Read()
...
Try
  ...
  Label1.Text = ""
        ...
        If blockname.SelectedItem.Text <> "Select" Then
            ...
            cmds.Connection = con
            Dim dr1 As SqlDataReader
            cmds.CommandText = "select pds.fps_master.fps_code,pds.fps_master.fps_Uname from pds.fps_master  where pds.fps_master.district_code='" & distcode & "' and pds.fps_master.block_code='" & blockcode & "' order by pds.fps_master.fps_Uname"
            con.Open()
            dr1 = cmds.ExecuteReader()
            While dr1.Read()
                Dim lstitem As New ListItem
...
Try
  ...
  If leadname.Text = "" And leadname_h.Text = "" Then
        ...
        ElseIf blockname.SelectedItem.Text <> "Select" And fpslist.Items.Count > 0 Then
            ...
            S1 = S1 & " ('" & dcode & "','" & blockcode & "','" & lead_code & "',N'" & leadname.Text.Trim() & "',N'" & chkSha(leadname_h.Text.Trim()) & "',N'" & leadadd.Text.Trim() & "',N'" & leadtele.Text.Trim() & "',N'" & leadmob.Text.Trim() & "',getdate(),getdate())"
            cmd.CommandText = S1
            con.Open()
            cmd.ExecuteNonQuery()
            con.Close()
            ...
            While c >= 0
                ...
                S1 = "insert into dbo.Lead_soc_fps(LeadSoc_Code,District_code,block_code,fps_code,created_date,updated_date) values('" & lead_code & "','" & dcode & "','" & bcode & "','" & itm_code & "',getdate(),getdate())"
                cmd2.Connection = con
                cmd2.CommandText = S1
                con.Open()
...
Try
  ...
  Label1.Text = ""
        ...
        ElseIf lead.SelectedItem.Text <> "Select" Or fpslist.Items.Count > 0 Then
            ...
            cmd.Connection = con
            ' For FPS Updation
            Dim str1 As String = "update dbo.m_LeadSoc set LeadSoc_name=N'" & leadname.Text.Trim() & "',LeadSoc_nameU=N'" & chkSha(leadname_h.Text.Trim()) & "',LeadSoc_address=N'" & leadadd.Text.Trim() & "',LeadSoc_tel=N'" & leadtele.Text.Trim() & "',LeadSoc_mob=N'" & leadmob.Text.Trim() & "' where LeadSoc_Code='" & ldcode & "'"
            ...
            While c >= 0
                ...
                If temp = "" Then
                    ...
                    cmdc.Connection = con
                    str2 = "insert into dbo.Lead_soc_fps(LeadSoc_Code,District_code,block_code,fps_code,created_date,updated_date) values('" & ldcode & "','" & dcode & "','" & bcode & "','" & itm_code & "',getdate(),getdate())"
...
Try
   ...
   Label1.Text = ""
        ...
        Else
            ...
            Dim dr1 As SqlDataReader
            fpslist.Items.Clear()
            cmds.CommandText = "select pds.fps_master.fps_code,pds.fps_master.fps_Uname from dbo.Lead_soc_fps inner join pds.fps_master on Lead_soc_fps.fps_code=pds.fps_master.fps_code where Lead_soc_fps.LeadSoc_Code='" & ldcode & "' and Lead_soc_fps.District_code='" & distcode & "' and Lead_soc_fps.block_code='" & blockname.SelectedItem.Value & "'"
            con.Open()
            dr1 = cmds.ExecuteReader()
            While dr1.Read()
...
Response.Redirect("~/IssueCenter/leadsoc_creat.aspx")
