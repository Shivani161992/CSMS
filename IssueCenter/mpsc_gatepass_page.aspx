<%@ Page Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master" AutoEventWireup="true" CodeFile="mpsc_gatepass_page.aspx.cs" Inherits="mpsc_gatepass_page" Title="Receipt Acknowledgement Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <asp:TextBox ID="DaintyDate2" runat="server"></asp:TextBox>
    ...
    <asp:DropDownList ID="ddlsarrival" runat="server" Width="120px" OnSelectedIndexChanged="ddlsarrival_SelectedIndexChanged">
