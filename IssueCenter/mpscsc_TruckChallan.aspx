<%@ Page Language="C#" MasterPageFile="~/MasterPage/IssueMaster.master" AutoEventWireup="true" CodeFile="mpscsc_TruckChallan.aspx.cs" Inherits="mpscsc_TruckChallan" Title="Truck Challan (Transfer To Other Godown)" %>
...
<tr>
 ...
 <table border ="0" cellpadding ="0" cellspacing ="0">
     <tr>
         <td align="center"  colspan="4" style="border-right: lightblue 1px solid;
             border-top: lightblue 1px solid; border-left: lightblue 1px solid; border-bottom: lightblue 1px solid; background-color: #cccccc;">
    <asp:Label ID="lbltransfer" runat="server" Text="Detail Of Truck Challan (Transfer To Other Godown)" Width="360px" Font-Bold="True" Font-Size="12px"></asp:Label></td>
     </tr>
     <tr>
 ...
 <td align="left" style="font-size: 10pt; position: static; background-color: #cfdcdc; border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid;">
  ...
  <td align="left" style="font-size: 10pt; position: static; background-color: #cfdcdc; border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid;"> <asp:TextBox ID="txtroqty" runat="server"  Width ="130px" Visible="False"></asp:TextBox></td>
     ...
     <tr>
         ...
         <td align="left" style="font-size: 10pt; position: static; background-color: #cfdcdc; border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; height: 24px;">
             <asp:TextBox ID="txtbqty" runat="server" Visible="False" Width="145px"></asp:TextBox></td>
         <td class="tdmarginddl" style="font-size: 10pt; position: static; background-color: #cfdcdc; border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; height: 24px;">
             <asp:Label ID="Label21" runat="server" Text="Current Bags" Width="115px" Visible="False"></asp:Label></td>
         <td align="left" style="font-size: 10pt; position: static; background-color: #cfdcdc; border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; height: 24px;">
             <asp:TextBox ID="txtcurbags" runat="server" Visible="False" Width="146px"></asp:TextBox></td>
     </tr>
     <tr>
         <td class="tdmarginddl" style="font-size: 10pt; position: static; background-color: #cfdcdc; border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; height: 24px;" align="left">
 ...
 <td style="font-size: 10pt; position: static; background-color: #cfdcdc; border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; height: 24px;" align="left">
  ...
  <td align="left" style="font-size: 10pt; position: static; background-color: #cfdcdc; border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid; border-bottom: silver 1px solid; height: 24px;"> <asp:TextBox ID="txtquant" runat="server" Width="146px"></asp:TextBox>Qtls.<asp:RequiredFieldValidator
