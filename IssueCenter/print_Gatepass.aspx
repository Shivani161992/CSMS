<%@ Page Language="C#" AutoEventWireup="true" CodeFile="print_Gatepass.aspx.cs" Inherits="print_Gatepass" Title =" Print Receipt Gate Pass" %>
...
<body>
    ...
    <td align ="left" style="font-size: 12pt"> Transporter Name </td>
    <td align ="left" style="font-size: 12pt"> :<asp:Label ID="lbltransp" runat="server" Text=""> </asp:Label></td>
    ...
    <tr> 
    <td style="font-size: 12pt"> 7.</td>
    <td style="font-size: 12pt" align="left"> WCM No.</td>
    <td style="font-size: 12pt" align="left"> :<asp:Label ID="lblwcmno" runat="server" Text=""> </asp:Label></td>
    <td style="font-size: 12pt"> </td>
    <td style="font-size: 12pt"> (Qty. in Qtls.)</td>
    </tr>
    <tr> 
    <td style="font-size: 12pt"> 
        8.</td>
    <td align ="left" style="font-size: 12pt"> Category </td>
    <td align ="left" style="font-size: 12pt"> :<asp:Label ID="lblcatg" runat="server" Text=""> </asp:Label></td>
    <td align ="left" style="font-size: 12pt">Moisture % </td>
    <td align ="left" style="font-size: 12pt">
