...
#End Region
    ...
    Private Sub get_Data(ByVal From_Date As String, ByVal To_Date As String, ByVal Depot_ID As String, ByVal DistId As String)
        ...
        If (ddlcropyear.SelectedItem.Text = "2016-2017") Then
            ReportViewer1.ServerReport.ReportPath = folder & "AccepNote_drilldown2016"
            ...
            paramList.Add(New ReportParameter("IssueCenter_ID", Depot_ID, False))
        ...
        ElseIf (ddlcropyear.SelectedItem.Text = "2015-2016") Then
            ReportViewer1.ServerReport.ReportPath = folder & "AccepNote_drilldown"
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        If tx_from_date.Text = "" Then
            ...
            tx_from_date.Text = "01-03-2016"

        End If

        If tx_to_date.Text = "" Then

            tx_to_date.Text = "01-03-2016"
        ...
        get_Data(fdate, tdate, IC_code, dist_code)
