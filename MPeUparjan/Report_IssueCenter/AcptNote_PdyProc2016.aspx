<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AcptNote_PdyProc2016.aspx.cs" Inherits="Report_IssueCenter_AcptNote_PdyProc2016" %>
        ...
        <div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3; padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%; background-color: lavender;"
                ...
                <tr style="text-align: center">
                    <td colspan="8" class="auto-style1" style="color: #CC6600; background-color:#FFCCFF">Acceptence Note Details (Procurement 2016)</td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:Label ID="lblFrmDate" runat="server" Style="font-weight: 700; font-size: large;" Text="From Acceptance Date" ></asp:Label>
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:Label ID="lblToDate" runat="server" Style="font-weight: 700; font-size: large;" Text="To Acceptance Date"></asp:Label>
                    </td>
                    <td>
