...
public partial class Report_IssueCenter_CheckList : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (year == "2016")
        {
            ...
            {
                getData1(fdate, DistrictId, IssueId);
            }

            else
            {
                getData(fdate, DistrictId, IssueId);
            }
        }
    ...
    private void getData(string fdate, string DistrictId, string IssueId)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "CheckList";
    ...
    private void getData1(string fdate, string DistrictId, string IssueId)
    {
        while (this.ReportViewer1.ServerReport.IsDrillthroughReport)
        {
            this.ReportViewer1.PerformBack();
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "CheckList2016";
        ReportViewer1.ServerReport.ReportServerCredentials = new ReportServerNetworkCredentials();
        ReportParameterInfoCollection pInfo = default(ReportParameterInfoCollection);
        System.Collections.Generic.List<ReportParameter> paramList = new System.Collections.Generic.List<ReportParameter>();
