<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckList2Dates_Paddy2016.aspx.cs" Inherits="Report_IssueCenter_CheckList2Dates_Paddy2016" %>
        ...
        <div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3; padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%; background-color: lavender;"
                ...
                <tr style="text-align: center">
                    <td colspan="8" class="auto-style1" style="color: #CC6600; background-color:#FFCCFF">Check List Details Between Two Dates (Receiving From Procurement 2016)</td>
                </tr>
                <tr>
                    <td>
