...
public partial class Report_IssueCenter_CheckList2Dates_Paddy2016 : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    private void getData(string Comdty, string fdate, string DistrictId, string IssueId, string DistName, string ICName, string CmodtyName, string ToDate)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "CheckList2Dates_Paddy2016";
