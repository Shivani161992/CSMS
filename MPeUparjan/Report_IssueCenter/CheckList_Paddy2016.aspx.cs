...
public partial class CheckList_Paddy2016 : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        {
            getData(ddlComdty.SelectedValue.ToString(), fdate, DistrictId, IssueId, hdfDistName.Value, hdfICName.Value, ddlComdty.SelectedItem.ToString());
        }

    }

    private void getData(string Comdty, string fdate, string DistrictId, string IssueId, string DistName, string ICName, string CmodtyName)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "CheckList_Paddy2016";
