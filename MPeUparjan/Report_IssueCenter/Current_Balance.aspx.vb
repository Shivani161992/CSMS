...
Partial Class Report_IssueCenter_Current_Balance
...
#End Region
    ...
    Private Sub get_Data(ByVal DistID As String, ByVal DepotID As String)
        ...
        ReportViewer1.ServerReport.ReportPath = folder & "CurrentBalance_IC"
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        depot = Session("issue_id").ToString()
        get_Data(dist, depot)
    End Sub
