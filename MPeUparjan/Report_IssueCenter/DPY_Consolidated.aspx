<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DPY_Consolidated.aspx.cs" Inherits="Report_IssueCenter_DPY_Consolidated" %>
    ...
    <table cellpadding="0" cellspacing="0"   style="background-color:#ecf5d5; width:100%; border:double;border-color:#868f6f">
        <tr>
            <td colspan="8" style="font-weight: bold; font-size: 9pt; color: #595f4a; font-family: Verdana;
                ...
                <span style="font-size: 11pt">Door Step Delivery Consolidated Details</span></td>
        </tr>
