...
public partial class Report_IssueCenter_DPY_Consolidated : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        get_Data(IssueCenterID, month, year);
       
    }


    private void get_Data(string IssueID, string month, string year)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "DPY_IC_IssueDO";
