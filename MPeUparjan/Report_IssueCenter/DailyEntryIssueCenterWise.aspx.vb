...
Partial Class Report_IssueCenter_DailyEntryIssueCenterWise
...
#End Region
    ...
    Private Sub get_Data(ByVal From_Date As String, ByVal To_Date As String, ByVal Depot_ID As String)
        ...
        ReportViewer1.ServerReport.ReportPath = folder & "DailyEntryStatusOfIssueCenter"
        ReportViewer1.ServerReport.ReportServerCredentials = New MyReportServerCredentials
        Dim pInfo As ReportParameterInfoCollection
        Dim paramList As New Generic.List(Of ReportParameter)
        'Dim a1 As New ReportParameter
        paramList.Add(New ReportParameter("fdate", From_Date, False))
        paramList.Add(New ReportParameter("tdate", To_Date, False))
        paramList.Add(New ReportParameter("depotid", Depot_ID, False))
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If tx_from_date.Text <> "" And tx_to_date.Text <> "" Then

            Dim fdate As String
            Dim tdate As String
            fdate = getDate_MDY(tx_from_date.Text)
            tdate = getDate_MDY(tx_to_date.Text)
            get_Data(fdate, tdate, IC_code)
        Else
            Page.RegisterClientScriptBlock("mymsg2", "<script language=javascript> alert('Please Select the Date from Calandar......'); </script> ")
