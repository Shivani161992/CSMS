...
Partial Class Report_IssueCenter_Daily_Dispatched
...
#End Region
    ...
    Private Sub get_Data(ByVal From_Date As String, ByVal to_Date As String, ByVal Dist_ID As String, ByVal Depot_ID As String)
        ...
        If ddldisptype.SelectedItem.Text = "Dispatch by Road" Then
            ReportViewer1.ServerReport.ReportPath = folder & "Daily_Dispatch_Details"
        Else
            If ddldisptype.SelectedItem.Text = "Issue Against DO" Then
                ReportViewer1.ServerReport.ReportPath = folder & "Dispatch_DO_Details"
            Else
                ReportViewer1.ServerReport.ReportPath = folder & "IssueCenter_TotalofRackDispatch"
    ...
    Protected Sub LinkButton1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LinkButton1.Click
        ...
        If ReportViewer1.ServerReport.IsDrillthroughReport Then
