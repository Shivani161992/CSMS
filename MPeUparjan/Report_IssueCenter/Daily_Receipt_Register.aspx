<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Daily_Receipt_Register.aspx.vb" Inherits="Report_IssueCenter_Daily_Receipt_Register" Debug="true" %>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 1000px; background-color: #ece9d8;" id="">
            ...
            <tr>
                ...
                <td colspan="2" style="height: 25px">
                    <asp:DropDownList ID="ddlsource" runat="server" Width="254px">
                    </asp:DropDownList></td>
