<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteAcptRcpt_PdyProc2016.aspx.cs" Inherits="Report_IssueCenter_DeleteAcptRcpt_PdyProc2016" %>
        ...
        <div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3; padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%; background-color: lavender;"
                ...
                <tr style="text-align: center">
                    <td colspan="7" class="auto-style1" style="color: #CC6600; background-color: #FFCCFF">Deleted Acceptance and Receipt Report (Procurement 2016)</td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:Label ID="lblFrmDate" runat="server" Style="font-weight: 700; font-size: large;" Text="Select Delete Type"></asp:Label>
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlDeletedtype" runat="server" Width="173px">
                            <asp:ListItem Value="Select">--Select--</asp:ListItem>
                            <asp:ListItem Value="N">Receipt</asp:ListItem>
                            <asp:ListItem Value="Y">Acceptance</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td></td>
                    <td>
