<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DetailProc.aspx.cs" Inherits="Report_IssueCenter_DetailProc" %>
...
<body>
    ...
    <td class="style16" > 
        Select Crop Year</td>
    <td style="font-weight: bold;font-family: Verdana;text-align: left; " 
        ...
        <td style="font-weight: bold; font-size: 9pt; color: #595f4a; font-family: Verdana;
            text-align: left;" class="style12" colspan="2">
