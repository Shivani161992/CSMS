...
public partial class Report_IssueCenter_DetailProc : System.Web.UI.Page
{
    ...
    private void get_Data(string Crop_Year, string commodity, string issueid)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "IC_DetailProcurement";
        ...
        paramList.Add(new ReportParameter("DepotID", issueid, false));
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string issuecent = Session["issue_id"].ToString();

        get_Data(cropyear,commodity, issuecent);
    }
}
