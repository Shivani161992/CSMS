<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GdnWiseRcpt_PdyProc2016.aspx.cs" Inherits="Report_IssueCenter_GdnWiseRcpt_PdyProc2016" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <input id="hdfCMRGodown" type="hidden" runat="server" />
        <div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3; padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%; background-color: lavender;"
                ...
                <tr style="text-align: center">
                    <td colspan="8" class="auto-style1" style="color: #CC6600; background-color: #FFCCFF">Godown Wise Receipt Report (Procurement 2016)</td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:Label ID="lblFrmDate" runat="server" Style="font-weight: 700; font-size: large;" Text="Branch"></asp:Label>
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlBranch" runat="server" Width="137px" AutoPostBack="True" OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td>
                        <asp:Label ID="lblToDate" runat="server" Style="font-weight: 700; font-size: large;" Text="Godown"></asp:Label>
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlGodam" runat="server" Width="200px">
                        </asp:DropDownList>
                    </td>
