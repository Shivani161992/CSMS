<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IC_RoadDispatch_commwise.aspx.cs" Inherits="Report_IssueCenter_IC_RoadDispatch_commwise" %>
                    ...
                    <tr>
                        <td align="center" colspan="5" style="font-weight: bolder; font-size: 12pt; color:Black; background-color: lavender; text-align: center;">
                            <span style="font-weight: 700; font-size: 11pt; color: #00008b; font-style: normal;
                                font-family: Arial; text-decoration: none">Commodity Wise By Road Dispatch Report</span></td>
