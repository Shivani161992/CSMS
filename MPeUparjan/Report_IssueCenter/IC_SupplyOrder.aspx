<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IC_SupplyOrder.aspx.cs" Inherits="Report_IssueCenter_IC_SupplyOrder" %>
     ...
     <center>
                    ...
                    <tr>
                        <td align="center" colspan="5" style="font-weight: bolder; font-size: 12pt; color:Black; background-color: lavender; text-align: center;">
                            <span style="font-weight: 700; font-size: 11pt; color: #00008b; font-style: normal;
                                font-family: Arial; text-decoration: none">Total Receipt Details for Tender Purchase
                                by Road (Sugar Supply Order) Details Order
                                Wise</span></td>
               ...
               <script type="text/javascript">
                ...
                <asp:Panel ID="pnlreport" runat="server" Visible="true">
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="466px" ProcessingMode="Remote"
                        ...
                        ZoomMode="PageWidth" BackColor="CornflowerBlue" BorderColor="#E0E0E0"
                         LinkDisabledColor="Black" LinkActiveColor="Yellow" Style="margin-left: 0px; margin-right: 0px;"
                            ShowBackButton="true" EnableTheming="true" DocumentMapWidth="50%">
