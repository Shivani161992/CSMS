<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rcpt_PaddyProc2016.aspx.cs" Inherits="Report_IssueCenter_Rcpt_PaddyProc2016" %>
        ...
        <div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3; padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%; background-color: lavender;"
                ...
                <tr style="text-align: center">
                    <td colspan="8" class="auto-style1" style="color: #CC6600; background-color:#FFCCFF">Daily Receipt Register (Procurement 2016)</td>
                </tr>
                <tr>
                    <td>
