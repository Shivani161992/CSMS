...
public partial class Report_IssueCenter_RejTruck_PdyProc2016 : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        {
            getData(ddlComdty.SelectedValue.ToString(), DistrictId, IssueId, hdfDistName.Value, hdfICName.Value, ddlComdty.SelectedItem.ToString());
        }

    }

    private void getData(string Comdty, string DistrictId, string IssueId, string DistName, string ICName, string CmodtyName)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "RejTruck_PdyProc2016";
