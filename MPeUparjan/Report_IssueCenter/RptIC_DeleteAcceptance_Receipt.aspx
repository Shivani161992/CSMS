<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptIC_DeleteAcceptance_Receipt.aspx.cs" Inherits="Report_IssueCenter_RptIC_DeleteAcceptance_Receipt" %>
    ...
    <table cellpadding="0" cellspacing="0"   style="background-color:#ecf5d5; width:100%; border:double;border-color:#868f6f" id="TABLE1" onclick="return TABLE1_onclick()">
        <tr>
            <td colspan="8" style="font-weight: bold; font-size: 9pt; color: #595f4a; font-family: Verdana;
                ...
                <span style="font-size: 11pt">केन्द्र की निरस्त किये हुए प्राप्ति एवं स्वीकृति
                    पत्रक की जानकारी 2016</span></td>
        </tr>
        <tr>
            ...
            <td class="style3" colspan="5" style="font-weight: bold; font-family: Verdana; height: 23px;
                text-align: center">
                <span style="font-size: 11pt">Select Delete Type</span></td>
