<%@ Page Language="VB" AutoEventWireup="false" CodeFile="delivery_order_rpt.aspx.vb"
    Inherits="delivery_order_rpt" %>
        ...
        <center>
            <div style="width:800px;">
                <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3;
                    padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%;height:auto" >
                    ...
                    <tr>
                        <td align="center" colspan="5" >
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" ProcessingMode="Remote" 
                                Width="100%" Font-Names="Verdana" Font-Size="8pt" ShowCredentialPrompts="False" Height="650px">
