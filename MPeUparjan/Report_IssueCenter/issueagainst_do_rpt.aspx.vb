...
Partial Class issueagainst_do_rpt
...
#End Region
    ...
    Private Sub get_Data()
        ...
        Dim dono As String = ddl_do_no.SelectedValue.ToString()
        ' For Report
        ...
        ReportViewer1.ServerReport.ReportPath = folder & "issueagainst_do_mpscsc"

        ReportViewer1.ServerReport.ReportServerCredentials = New MyReportServerCredentials
        Dim pInfo As ReportParameterInfoCollection
        Dim paramList As New Generic.List(Of ReportParameter)
        'Dim a1 As New ReportParameter
        paramList.Add(New ReportParameter("dono", dono, False))
    ...
    Protected Sub get_DO_Number()
        ...
        cmd.CommandText = "select delivery_order_no from dbo.delivery_order_mpscsc where do_date >='" + From_Date + "' and do_date<='" + To_Date + "' and district_code='" + dist_code + "' and issueCentre_code='" & issue_code & "'"
       
        cmd.Connection = con
        con.Open()
        dr = cmd.ExecuteReader()
        If dr.HasRows Then
            ddl_do_no.DataSource = dr
            ddl_do_no.DataTextField = "delivery_order_no"
            ddl_do_no.DataValueField = "delivery_order_no"
            ddl_do_no.DataBind()
