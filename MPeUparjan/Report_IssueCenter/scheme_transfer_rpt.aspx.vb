...
Partial Class Report_IssueCenter_Scheme_Transfer_rpt
...
#End Region
    ...
    Private Sub get_Data(ByVal DistID As String, ByVal DepotID As String, ByVal Month As String, ByVal Year As String)
        ...
        ReportViewer1.ServerReport.ReportPath = folder & "Scheme_Transfer_rpt_IC"
        ...
        paramList.Add(New ReportParameter("DepotID", Depotid, False))
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        get_Data(dist_code, IC_code, month, year)
    End Sub
