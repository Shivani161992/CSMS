...
public partial class Millers_Login_Miller_Login : System.Web.UI.Page
{
    ...
    protected void bttsub_Click(object sender, EventArgs e)
    {
        ...
        if (txtuser.Text == "")
        {
            Page.RegisterClientScriptBlock("mymsg2", "<script language=javascript> alert('Enter Registration |'); </script> ");
        }
        ...
        else
        {
            ...
            string qry = "SELECT Aadhar_number, Mill_Name  FROM Miller_Registration_2017 where CropYear = '2017-2018' and Registration_ID = '" + txtuser.Text + "' ";
            ...
            {
                strpd = ds.Tables[0].Rows[0]["Aadhar_number"].ToString();
                ...
                else
                {
                    ...
                    if (password == hpwd.ToLower())
                    {
                        ...
                        Session["MillerName"] = MillerName;

                        Response.Redirect("~/Millers_Login/Miller_Home.aspx");
                    }
                }
