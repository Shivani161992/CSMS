<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Inspector_Login.aspx.cs" Inherits="PaddyMilling_Inspection__Rice_wheat_Inspector_Login" %>
...
<body>
    ...
    <form id="form1" runat="server" style="width: 100%;">
        <div style="margin-top: 25px; float: right; width: 100%">
            ...
            <table class="table">
                <tr>
                    <td colspan="4" class="column">Login
                    </td>
                </tr>
                ...
                <tr>
                 ...
                 <tr>
                    <td style="text-align: center; height: 50px; font-size: large;">
                        <asp:TextBox ID="txtPass" runat="server" placeholder="Password" class="tcolumn"></asp:TextBox>
                    </td>
                </tr>
    <tr>
                    <td style="text-align: center; height: 60px; font-size: large;">

                        <asp:Button ID="bttlogin" runat="server" Text="Login" CssClass="bttn w3-grey" OnClick="bttlogin_Click" /></td>
                </tr>
                <tr>
