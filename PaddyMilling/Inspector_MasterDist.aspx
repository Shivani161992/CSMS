<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/DistLoginOperations_Master.master" AutoEventWireup="true" CodeFile="Inspector_MasterDist.aspx.cs" Inherits="PaddyMilling_Inspector_MasterDist" %>
        ...
        <table style="width: 1000px; font-size: 12px;">
            <tr>
                ...
                <td style="text-align: right; width: 500px">
                    <a href="Inspector_MasterDist.aspx" class="sign">&#8635 New
                    </a>
                </td>
            </tr>
        </table>
        <table class="InspecTable">
            <tr>
                <td colspan="2" style="text-align: center;">
                    <center>
                        <h2 style="color: #e74c3c; font-size: 30px; font-family: sans-serif; letter-spacing: 4px;">Inspector Master</h2>
                    </center>
            ...
            <tr>
                <td class="InspColumn" style="padding-left: 20px;">District
                    ...
                    <asp:TextBox ID="txtDistrict" CssClass="insfixtext" runat="server" ReadOnly="true"></asp:TextBox>
                </td>
                <td class="InspColumn" style="padding-left: 20px;">Issue Center
                    <br />
                    <asp:DropDownList ID="ddlIC" runat="server" CssClass="inspddl">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="InspColumn" style="padding-left: 20px;">Mobile Number Two
                    <br />

                    <asp:TextBox ID="txtMobtwo" CssClass="insptxt" runat="server" MaxLength="10" onkeypress="return allowOnlyNumber(event);"></asp:TextBox>
