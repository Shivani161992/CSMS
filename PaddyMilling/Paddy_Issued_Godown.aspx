<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SCSC_master.master" AutoEventWireup="true" CodeFile="Paddy_Issued_Godown.aspx.cs" Inherits="PaddyMilling_Paddy_Issued_Godown" %>
    ...
    <table align="center" style="width: 850px; border-style: solid; border-width: 1px; text-align: left; font-size: small" border="1" cellspacing="0" cellpadding="2">
        <tr>
            <td colspan="6" style="text-align: center; font-size: large; color: #CC6600"><span style="vertical-align: top; font-weight: bold; text-decoration: underline">Paddy Issued To Miller From Godown</span><span style="vertical-align: top; font-weight: bold; color: blue"> (Mapping)</span>
                ...
                <input id="hdfGodown" type="hidden" runat="server" />
                 <input id="hdfAllGridGodown" type="hidden" runat="server" />
                <input id="hdfODDist" type="hidden" runat="server" />
            </td>
                ...
                <div style="height: 150px; overflow: auto;" align="center">
                    <asp:GridView ID="GridView2" Width="100%" runat="server" HeaderStyle-CssClass="FixedHeader" AutoGenerateColumns="False" ShowFooter="false" CellPadding="4" EnableModelValidation="True" ForeColor="#333333" GridLines="None"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField ReadOnly="true" HeaderText="S.No" HeaderStyle-Width="40px" ItemStyle-Width="40px" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Bottom" FooterStyle-HorizontalAlign="Right"></asp:BoundField>

                            <asp:BoundField DataField="ICName" HeaderText="Issue Centre" HeaderStyle-Width="108px" ItemStyle-Width="108px" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Bottom" FooterStyle-HorizontalAlign="Right"></asp:BoundField>

                            <asp:BoundField DataField="Godown_id" HeaderText="Godown" HeaderStyle-Width="260px" ItemStyle-Width="260px" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Bottom" FooterStyle-HorizontalAlign="Right"></asp:BoundField>

                            <asp:BoundField DataField="distance" HeaderText="Distance (Km)" HeaderStyle-Width="70px" ItemStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Bottom" FooterStyle-HorizontalAlign="Right"></asp:BoundField>

                            <asp:BoundField HeaderText="Original Paddy Available (Qtls)" HeaderStyle-Width="100px" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Bottom" FooterStyle-HorizontalAlign="Right"></asp:BoundField>

                            <asp:BoundField HeaderText="Paddy Already Mapped (Qtls)" HeaderStyle-Width="90px" ItemStyle-Width="90px" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Bottom" FooterStyle-HorizontalAlign="Right"></asp:BoundField>

                            <asp:BoundField HeaderText="Rem. Paddy Available (Qtls)" HeaderStyle-Width="90px" ItemStyle-Width="90px" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Bottom" FooterStyle-HorizontalAlign="Right"></asp:BoundField>

                            <asp:BoundField DataField="IssueCenter" HeaderText="ICId" HeaderStyle-Width="90px" ItemStyle-Width="90px" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Bottom" FooterStyle-HorizontalAlign="Right" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" FooterStyle-CssClass="hiddencol"></asp:BoundField>
                            ...
                            <asp:BoundField DataField="DistrictId" HeaderText="DistID" HeaderStyle-Width="90px" ItemStyle-Width="90px" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Bottom" FooterStyle-HorizontalAlign="Right" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" FooterStyle-CssClass="hiddencol"></asp:BoundField>
        ...
        <tr>
            ...
            <td style="text-align: left; background-color: #CCFF99; font-size: medium">
                <asp:TextBox ID="txtQty" runat="server" Width="83px" Style="text-align: right" MaxLength="10" AutoComplete="off"
