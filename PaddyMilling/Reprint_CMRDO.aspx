<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SCSC_master.master" AutoEventWireup="true" CodeFile="Reprint_CMRDO.aspx.cs" Inherits="PaddyMilling_Reprint_CMRDO" %>
         ...
         <table style="width: 1100px; font-size: 12px;">
            <tr>
                ...
                <td style="text-align: center; width: 700px">
                    <h2 style="color:#e67e22; font-size: 20px; font-family: 'Bellefair'; letter-spacing: 4px; text-decoration-style: wavy; text-align:center"> Reprint CMR Deposit Order</h2>
                     <input id="hdfCropYear" type="hidden" runat="server" />
                </td>

                <td style="text-align: right; width: 200px">
                    <a href="Reprint_CMRDO.aspx" class="sign">&#8635 New
                    </a>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="InspColumn" style="padding-left: 20px;">Agreement Number <br />
                     <asp:DropDownList ID="ddlAgrmtNo" runat="server" CssClass="inspddl"  AutoPostBack="True" OnSelectedIndexChanged="ddlAgrmtNo_SelectedIndexChanged"  >
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlAgrmtNo" ErrorMessage="RequiredFieldValidator" SetFocusOnError="True">*</asp:RequiredFieldValidator>

                                  
                </td>
                <td class="InspColumn" style="padding-left: 20px;">
                   CMR Deposit Order Number
                    <br/>
                     <asp:DropDownList ID="ddlMvmtNumber" runat="server" CssClass="inspddl" Style="margin-left: 10px" >
                </asp:DropDownList>
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlMvmtNumber" ErrorMessage="RequiredFieldValidator" SetFocusOnError="True">*</asp:RequiredFieldValidator>
