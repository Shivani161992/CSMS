...
function _fnGetTitleRow(iIndex) {
    ...
    oRowLayout.push("<td align='right' valign='middle' class='titleRow_'>");
    oRowLayout.push("<a href=\"javascript:_fnCloseCalendar('" + iIndex + "')\" title='' class='linksButton_'>X</a></td>");
    oRowLayout.push("</tr>");
...
function _fnGetYearRow(iIndex) {
    ...
    oRowLayout.push(" title='' class='linksCalendar_'>&lt;</a></td>");
    ...
    oRowLayout.push("<a href=\"javascript:_fnShowYears('" + iIndex + "')\" title='' class='linksCalendar_' style='font-size:10px'>v</a></td>");
    oRowLayout.push("<td align='center' valign='middle' width='15'>");
...
function _fnGetMonthRow(iIndex) {
    ...
    oRowLayout.push(" title='' class='linksCalendar_'>&lt;</a>");
    ...
    oRowLayout.push("<a href=\"javascript:_fnShowAllMonths('" + iIndex + "')\" title='' class='linksCalendar_' style='font-size:10px'>v</a></td>");
    oRowLayout.push("<td align='center' valign='middle' width='15'>");
