<%@ Page Language="C#" MasterPageFile="~/MasterPage/Regional_Office.master" AutoEventWireup="true" CodeFile="ChangePassword_Region.aspx.cs" Inherits="Regional_Office_ChangePassword_Region" Title="Change Password Regional Office" %>
...
<td align="left">
    ...
    <asp:Button ID="btnadd" runat="server" Text="Save" OnClick="btnadd_Click" Width="74px" ValidationGroup="1" /></td>
        <td align="left">
            <asp:Button ID="btnclose" runat="server" Text="Close" Width="123px" OnClick="btnclose_Click" /></td>
    </tr>
    <tr>
        <td colspan="2">
