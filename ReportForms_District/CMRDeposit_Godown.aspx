<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CMRDeposit_Godown.aspx.cs" Inherits="ReportForms_District_CMRDeposit_Godown" %>
        ...
        <div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3; padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%; background-color: lavender;"
                ...
                <tr style="text-align: center">
                    <td colspan="9" class="auto-style1" style="color: #CC6600; background-color:#FFCCFF">Godown Wise CMR Deposit Details
                ...
                <tr>
                    ...
                    <td class="auto-style4">
                        <strong>IssueCentre</strong></td>
                    <td>
                        <asp:DropDownList ID="ddlIC" runat="server" Width="137px" AutoPostBack="True" OnSelectedIndexChanged="ddlIC_SelectedIndexChanged" >
                    ...
                    <td class="auto-style4">
                        <strong style="text-align: right">Godown</strong></td>
                    <td>
