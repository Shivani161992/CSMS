...
public partial class ReportForms_District_CMRDeposit_Miller : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    public void GetMillName()
    {
        ...
        using (con = new SqlConnection(strcon))
        {
            try
            {
                con.Open();
                string select = "";
                if(ddlCropYear.SelectedItem.ToString()=="2015-2016")
                {
                ...
                else if ((ddlCropYear.SelectedItem.ToString() == "2016-2017") || (ddlCropYear.SelectedItem.ToString() == "2017-2018"))
                {
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        {
            Page.RegisterClientScriptBlock("mymsg1", "<script language=javascript> alert('Please Select Miller'); </script> ");
            return;
        }
        else
        {
    ...
    private void getDistData(string CropYear, string MillCode)
    {
        string DistCode = Session["dist_id"].ToString();
        string DistName = hdfDistName.Value;
        string MillName = ddlDist.SelectedItem.ToString();
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "CMRDeposit_Miller";
        ReportViewer1.ServerReport.ReportServerCredentials = new ReportServerNetworkCredentials();
        ReportParameterInfoCollection pInfo = default(ReportParameterInfoCollection);
        System.Collections.Generic.List<ReportParameter> paramList = new System.Collections.Generic.List<ReportParameter>();

        paramList.Add(new ReportParameter("MillCode", MillCode, false));
