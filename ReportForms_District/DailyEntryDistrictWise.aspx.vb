...
Partial Class ReportForms_District_DailyEntryDistrictWise
...
#End Region
    ...
    Private Sub get_Data(ByVal From_Date As String, ByVal To_Date As String, ByVal Dist_ID As String)
        ...
        ReportViewer1.ServerReport.ReportPath = folder & "DailyEntryStatusOfDistricts"
        ...
        paramList.Add(New ReportParameter("districtId", Dist_ID, False))
