<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Details_DO_comm_rpt.aspx.vb" Inherits="Details_DO_comm_rpt" %>
...
<body>
    <form id="form1" runat="server">
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 856px; background-color: #ece9d8;" id="">
            ...
            <tr>
                <td style="vertical-align: middle; width: 173px; height: 24px">
                ...
                <td align="left" style="height: 24px; width: 222px;">
                    </td>
            ...
            <tr>
                <td style="width: 173px; height: 23px; vertical-align: middle;">
                    From Date</td>
                ...
                <td style="height: 23px;">
                     <asp:TextBox ID="tx_to_date" runat="server" Width="148px"></asp:TextBox>
                                 <script type  ="text/javascript">
                                                	new tcal ({
				'formname': 'form1',
