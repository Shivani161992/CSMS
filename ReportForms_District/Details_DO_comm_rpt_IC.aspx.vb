...
Partial Class Details_DO_comm_rpt_IC
...
#End Region
    ...
    Private Sub get_Data(ByVal from_date As String, ByVal to_date As String, ByVal IssueID As String)
        ' For Report
        ...
        ReportViewer1.ServerReport.ReportPath = folder & "LiftedDoCommodity_IC"
        ...
        paramList.Add(New ReportParameter("IssueID", IssueID, False))
    ...
    Protected Sub get_issuename()
        ddl_issuename.Items.Clear()
        Dim dist As String = "23" + Session("dist_id").ToString()
        cmd.CommandText = "select * from dbo.tbl_MetaData_DEPOT where DistrictId='" + dist + "'"
        cmd.Connection = con
        con.Open()
        ...
        While (dr.Read())
            ...
            ddl_issuename.Items.Add(lst)
        End While
        ddl_issuename.Items.Insert(0, "Select")
        dr.Close()
        con.Close()
    End Sub
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim icCode As String = ddl_issuename.SelectedValue
        get_Data(from_date, to_date, icCode)
    End Sub
