<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Dispatch_Truck_Details.aspx.vb" Inherits="ReportForms_District_Dispatch_Truck_Details" %>
...
<body>
    <form id="form1" runat="server">
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 800px; background-color: #ece9d8;" id="">
            <tr>
                <td align="center" colspan="5" style="font-weight: bolder; font-size: 15pt; color: teal">
                    Dispatched &nbsp;Truck Details (Transfer to Other Godown)</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="right" style="vertical-align: middle; width: 93px; height: 23px">
                    To Date</td>
                <td style="height: 23px">
                    <asp:TextBox ID="tx_to_date" runat="server" Width="143px"></asp:TextBox>
                                <script type  ="text/javascript">
                                                	new tcal ({
				'formname': 'form1',
            ...
            <tr>
                ...
                <td style="width: 231px; height: 25px;">
                    </td>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="800px" Height="400px">
        </rsweb:ReportViewer>
    </form>
</body>
</html>
