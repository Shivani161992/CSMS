...
Partial Class ReportForms_District_Dispatch_Truck_Details
...
#End Region
    ...
    Private Sub get_Data(ByVal From_Date As String, ByVal To_Date As String, ByVal DistID As String, ByVal Commodity As String)
        ...
        ReportViewer1.ServerReport.ReportPath = folder & "TruckChallan_Dispatch_rpt"
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        get_Data(fdate, tdate, Distid, comdty)
