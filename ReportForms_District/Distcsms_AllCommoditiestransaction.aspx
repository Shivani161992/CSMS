<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Distcsms_AllCommoditiestransaction.aspx.cs" Inherits="ReportForms_District_Distcsms_AllCommoditiestransaction_withoutscheme" %>
...
<body>
    ...
    <center>
                <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3;
                    ...
                    <tr>
                        <td align="left" style="height: 1px; font-size: 10pt; " colspan="2">
                        ...
                        <td style="font-size: 12pt; " align="left" class="style1">
                            &nbsp;Select Scheme</td>
				...
				'controlname': 'txtDate'
                        ...
                        <td align="left" style="font-size: 10pt; " class="style1">
