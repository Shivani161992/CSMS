<%@ Page Language="C#" AutoEventWireup="true" CodeFile="District_DispatchbyRack.aspx.cs" Inherits="ReportForms_District_District_DispatchbyRack" %>
                    ...
                    <tr>
                        <td align="center" colspan="5" style="font-weight: bolder; font-size: 12pt; color:Black">
                            <span style="font-weight: 700; font-size: 11pt; color: #00008b; font-style: normal;
                                font-family: Arial; text-decoration: none">Issue Center Wise - Dispatch by Rack
                                Details</span></td>
