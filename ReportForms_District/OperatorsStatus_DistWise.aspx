<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OperatorsStatus_DistWise.aspx.cs" Inherits="ReportForms_District_OperatorsStatus_DistWise" %>
                    ...
                    <tr>
                        <td align="center" colspan="5" style="font-weight: bolder; font-size: 12pt; color:Black">
                            <span style="font-weight: 700; font-size: 11pt; color: #cc0033; font-style: normal;
                                font-family: Arial; text-decoration: none">District Wise Operators Status as per
