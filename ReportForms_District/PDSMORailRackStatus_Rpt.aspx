<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PDSMORailRackStatus_Rpt.aspx.cs" Inherits="ReportForms_District_PDSMORailRackStatus_Rpt" %>
        ...
        <div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3; padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%; background-color: lavender;"
                ...
                <tr style="text-align: center">
                    <td colspan="11" class="auto-style1" style="color: #CC6600; background-color: #FFCCFF">PDS Movement Order Status (By Rail Rack)</td>
                </tr>
                <tr>
                    <td>
