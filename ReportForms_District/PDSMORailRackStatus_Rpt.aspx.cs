...
public partial class ReportForms_District_PDSMORailRackStatus_Rpt : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    private void getData(string Comdty, string FrmDate, string ToDate, string DistCode)
    {
        ...
        {
            ReportViewer1.ServerReport.ReportPath = folder + "MOSendDistByRailRack";
        }
        else
        {
            ReportViewer1.ServerReport.ReportPath = folder + "MORecdDistByRailRack";
        }
    ...
    protected void lnkbtnBack_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("~/District/PDSMORailRackStatusHome_Rpt.aspx");
        }
    }
