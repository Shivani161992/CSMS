<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PendingAcptKharif2016_Dist.aspx.cs" Inherits="ReportForms_District_PendingAcptKharif2016_Dist" %>
        ...
        <div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3; padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%; background-color: lavender;"
                ...
                <tr style="text-align: center">
                    <td colspan="6" class="auto-style1" style="color: #CC6600; background-color:#FFCCFF">Pending Acceptence Note Details (Procurement 2016)</td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td style="text-align: center">
                        <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" ForeColor="#CC3300" Style="text-align: center" OnClick="LinkButton1_Click">Back</asp:LinkButton></td>
                </tr>
                <tr>
                    <td colspan="6">
