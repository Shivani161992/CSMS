...
Partial Class District_food_rpt_Rack_statement_dispatch
...
#End Region
    ...
    Private Sub get_Data(ByVal FromDate As String, ByVal Todate As String, ByVal Dist_Id As String)
        ...
        ReportViewer1.ServerReport.ReportPath = folder & "Rack_Statement_SD"
