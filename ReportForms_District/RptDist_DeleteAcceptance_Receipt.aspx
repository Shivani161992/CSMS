<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptDist_DeleteAcceptance_Receipt.aspx.cs" Inherits="ReportForms_District_RptDist_DeleteAcceptance_Receipt" %>
...
<head runat="server">
    <title>Del Acceptance & Receipt</title>
    <style type="text/css">
        .auto-style1 {
            width: 505px;
        }
                    ...
                    <table cellpadding="0" cellspacing="0" style="background-color: #ecf5d5; width: 100%; border: double; border-color: #868f6f">
                        <tr>
                            <td colspan="7" style="font-weight: bold; font-size: 9pt; color: #595f4a; font-family: Verdana; height: 20px; text-align: center">
                                <span style="font-size: 11pt">जिले की निरस्त किये हुए प्राप्ति एवं स्वीकृति
                    पत्रक की जानकारी</span></td>
                        </tr>
                        <tr>
                            ...
                            <td style="font-weight: bold; font-size: 9pt; color: #595f4a; font-family: Verdana; text-align: left;" class="style4"></td>
                            <td style="font-weight: bold; font-size: 9pt; color: #595f4a; font-family: Verdana; text-align: left; width: 65px;"
                                class="style7"></td>
