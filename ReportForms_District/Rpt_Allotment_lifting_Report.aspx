<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_Allotment_lifting_Report.aspx.cs" Inherits="Reports_State_Ho_CropYear_IC" %>
...
<head id="Head1" runat="server">
    <title>Allotment,Lifting and Distribution  Report</title>
    ...
    <form id="form1" runat="server">
     <center>
                <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3;
                    ...
                    <tr>
                        <td align="right" colspan="6" class="style2">
                            Allotment,Lifting and Delivery Report</td>
             ...
             <asp:ListItem Value="2012">2012</asp:ListItem>
                    ...
                    <tr style="font-size: 12pt">
                        <td align="right" 
                            style="width: 161px; font-size: medium; height: 43px; font-weight: 700;">
                            Commodity</td>
