                ...
                <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3;
                    ...
                    <tr style="font-size: 12pt">
                        <td align="right" style="width: 24px; font-size: 10pt; height: 43px;">
                            &nbsp;</td>
                        <td style="width: 170px; font-size: 10pt; height: 43px; text-align: center;" 
                            align="left">
                            
                          

                            <asp:Label ID="lbl_date" runat="server" Text="Crop Year"  Width="100px" 
                        ...
                        <td align="right" 
                            style="width: 256px; font-size: 10pt; height: 43px; text-align: left;">
                                            <asp:DropDownList ID="ddlcropyear" runat="server"  
                                Width="161px" Visible="true" 
                            >
