<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_Suspened_FPS.aspx.cs" Inherits="ReportForms_District_Rpt_Suspened_FPS" %>
...
<head id="Head1" runat="server">
    <title>Suspended FPS Details</title>
    <style type="text/css">
        .style1
        {
            height: 1px;
                ...
                <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3;
                    ...
                    <tr>
                        <td align="center" colspan="5" style="font-weight: bolder; font-size: 12pt; color:Black">
                            Suspended Fair Price Shop Details</td>
