<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_linksocietywise_bill.aspx.cs" Inherits="Reports_State_Rpt_csms_distwise_compliedreport" %>
...
<head runat="server">
    <title>Linkwise payment detail bill</title>
                    ...
                    <tr>
                        <td align="center" colspan="5" style="font-weight: bolder; font-size: 12pt; color:Black; background-color: lavender; text-align: center;">
                            <span style="font-weight: 700; font-size: 11pt; color: #00008b; font-style: normal;
                                font-family: Arial; text-decoration: none">Linksociety wise Bill Generation Report</span></td>
             ...
             <asp:ListItem Value="2012">2012</asp:ListItem>
                    ...
                    <tr style="font-size: 12pt">
                        <td align="right" style="width: 24px; font-size: 10pt; height: 43px;">
                            <asp:Label ID="lbl_date" runat="server" Text="Bill No."  Width="100px" 
                        ...
                        <td style="width: 170px; font-size: 10pt; height: 43px;" align="left">
                            ...
                            <asp:DropDownList ID="ddl_billno" runat="server" 
                               Width="200px" >
                            </asp:DropDownList>
