<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Stock_Register_rpt.aspx.vb" Inherits="ReportForms_District_Stock_Register_rpt" %>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 823px; background-color: #ece9d8;" id="">
            ...
            <tr>
                ...
                <td style="width: 92px; height: 23px;">
                     <asp:DropDownList ID="ddlallotyear" runat="server" Width="120px">
                                </asp:DropDownList>
                </td>
            ...
            <tr>
                <td style="width: 228px; height: 25px;">
                    Commodity</td>
                <td style="width: 100px; height: 25px;"><asp:DropDownList ID="ddlcommodity" runat="server"  Width ="136px">
                    
                </asp:DropDownList></td>
                <td style="width: 93px; height: 25px;" align="right">
                    Scheme</td>
                <td style="width: 92px; height: 25px;"><asp:DropDownList ID="ddlscheme" runat="server"  Width ="122px">
                </asp:DropDownList></td>
