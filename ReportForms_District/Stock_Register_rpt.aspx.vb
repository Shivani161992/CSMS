...
Partial Class ReportForms_District_Stock_Register_rpt
...
#End Region
    ...
    Private Sub get_Data(ByVal Month As String, ByVal Year As String, ByVal Commodity As String, ByVal Scheme As String, ByVal DistID As String)
        ...
        ReportViewer1.ServerReport.ReportPath = folder & "Stock_Registor_rpt"
        ...
        paramList.Add(New ReportParameter("Scheme_ID", Scheme, False))
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        get_Data(month, year, Commodity, Scheme, DistID)
    End Sub
    Protected Sub get_Commodity()
        cmd.CommandText = "select * from dbo.tbl_MetaData_STORAGE_COMMODITY where Status='Y' "
        cmd.Connection = con
        con.Open()
        ...
        con.Close()
    End Sub
    Protected Sub get_Scheme()
        cmd.CommandText = "select * from dbo.tbl_MetaData_SCHEME  where Status='Y'"
        cmd.Connection = con
        con.Open()
        dr = cmd.ExecuteReader()
        While (dr.Read())
    ...
    Protected Sub ddlcommodity_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlcommodity.SelectedIndexChanged

    End Sub

    Protected Sub ddlscheme_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlscheme.SelectedIndexChanged
