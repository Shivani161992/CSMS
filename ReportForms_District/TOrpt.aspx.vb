...
Partial Class ReportForms_District_TOrpt
...
#End Region
    ...
    Private Sub get_Data(ByVal FromDate As String, ByVal Todate As String, ByVal Distt_Id As String)
        ...
        ReportViewer1.ServerReport.ReportPath = folder & "Transport_Order_rpt"
        ...
        paramList.Add(New ReportParameter("Distt_Id", Distt_Id, False))
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        get_Data(fdate, todate, dist_code)
