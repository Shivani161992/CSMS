<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_rpt_Procurment_Commodity_CntrWis.aspx.cs" Inherits="ReportForms_District_frm_rpt_Procurment_Commodity_CntrWis" %>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 100%; background-color: #ece9d8;" id="">
            ...
            <tr>
                <td style="width: 185px; height: 15px" colspan="2">
                    District Logged In--<asp:Label ID="Label3" runat="server" Font-Bold="True" ForeColor="MediumBlue"></asp:Label></td>
