...
Partial Class ReportForms_District_scheme_transfer_rpt
...
#End Region
    ...
    Private Sub get_Data(ByVal Month As String, ByVal Year As String, ByVal District_Id As String)
        ...
        ReportViewer1.ServerReport.ReportPath = folder & "Scheme_Transfer_rpt"
        ...
        paramList.Add(New ReportParameter("DistID", District_Id, False))
