<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AllDistrictCommoditiesbetweenDates.aspx.vb" Inherits="Reports_State_AllDistrictCommoditiesbetweenDates" %>
...
<head id="Head1" runat="server">
    <title>Summary Report(CommodityWise)</title>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 823px; background-color: #ece9d8;" id="">
            ...
            <tr>
                ...
                <td align="center" colspan="4" style="height: 23px; color: teal;">
                    <strong>Summary Report(CommodityWise) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; </strong>
                </td>
            ...
            <tr>
                ...
                <td style="width: 201px; height: 23px; color: maroon;">
                    &nbsp;Head Office
                </td>
            ...
            <tr>
                ...
                <td align="right" style="vertical-align: middle; width: 93px; height: 23px">
                    ToDate</td>
                <td style="width: 201px; color: maroon; height: 23px">
                    <asp:TextBox ID="tx_to_date" runat="server" Width="104px"></asp:TextBox>
                    <script type  ="text/javascript">
                                                	new tcal ({
				'formname': 'form1',
