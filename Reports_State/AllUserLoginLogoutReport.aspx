<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AllUserLoginLogoutReport.aspx.vb" Inherits="Reports_State_AllUserLoginLogoutReport" %>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 823px; background-color: #ece9d8;" id="">
            ...
            <tr>
                ...
                <td align="center" colspan="4" style="height: 23px; color: teal;">
                    <strong>User Login-Logout Report &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
            ...
            <tr>
                <td style="width: 228px; height: 25px;" align="right">
                    <asp:Label ID="Label3" runat="server" Text="Login Type"></asp:Label></td>
                <td style="height: 25px;" colspan="2">
                    <asp:DropDownList ID="ddllogintype" runat="server" Width="240px">
                    </asp:DropDownList></td>
