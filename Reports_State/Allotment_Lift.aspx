<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Allotment_Lift.aspx.vb" Inherits="Reports_State_Allotment_Lift" %>
...
<head id="Head1" runat="server">
    <title>Allotment and Lifting</title>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 823px; background-color: #ece9d8;" id="">
            <tr>
                <td align="center" colspan="5" style="font-weight: bolder; font-size: 15pt; color: teal">
                    Release Order Analysis Report (Against Allotment)</td>
            </tr>
            <tr>
                <td style="vertical-align: middle; width: 107px; height: 23px">
                    Division </td>
                <td style="height: 23px" colspan="3">
                 <asp:DropDownList ID="ddlregion" runat="server" Width="132px">
      </asp:DropDownList>
                    </td>
            ...
            <tr>
                <td style="width: 107px; height: 23px; vertical-align: middle;">
                    Month</td>
            ...
            <tr>
                <td colspan="3" style="height: 25px">
                    <asp:Label ID="lbldiv" runat="server" ForeColor="Red" Visible="False" Width="278px"></asp:Label></td>
