...
public partial class Reports_State_CMR_Other_District : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    private void getData(string CropYear, string Fdate, string Tdate)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "CMR_Other_District";
    ...
    private void getDataDist(string CropYear, string Fdate, string Tdate, string district)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "CMR_Other_District_byDist";
        ReportViewer1.ServerReport.ReportServerCredentials = new ReportServerNetworkCredentials();
        ReportParameterInfoCollection pInfo = default(ReportParameterInfoCollection);
        System.Collections.Generic.List<ReportParameter> paramList = new System.Collections.Generic.List<ReportParameter>();
