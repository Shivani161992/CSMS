...
Partial Class Reports_State_DailyReceipt_statement
...
#End Region
    ...
    Private Sub get_Data(ByVal FromDate As String, ByVal Todate As String, ByVal Division As String)
        Dim folder As String = ConfigurationManager.ConnectionStrings("rptfolder").ProviderName


        ' For Report
        If ReportViewer1.ServerReport.ReportPath = folder & "DailyReceipt_Dist" Or ReportViewer1.ServerReport.ReportPath = folder & "DailyReceiptRegistor" Then
        ...
        Else
            ...
            If ddlsource.SelectedItem.Text = "From FCI" Then
                ReportViewer1.ServerReport.ReportPath = folder & "DailyReceipt_Region"
            Else
                ReportViewer1.ServerReport.ReportPath = folder & "DailyReceiprReg_Procurement"
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        divcode = ddlregion.SelectedValue

        get_Data(fdate, todate, divcode)
    ...
    Protected Sub get_Source()
        ...
        cmd.CommandText = "select * from dbo.Source_Arrival_Type"
        cmd.Connection = con
        con.Open()
        dr = cmd.ExecuteReader()
        While dr.Read()
    ...
    Protected Sub LinkButton1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LinkButton1.Click
        ...
        Else
            ...
            Dim user As String = CType(Session.Item("st_id"), String)


            If Session("st_id") = "4" Then
