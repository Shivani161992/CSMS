<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Date_Wise_rpt..aspx.cs" Inherits="Reports_State_Date_Wise_rpt_" %>
        ...
        <div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3; padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%; background-color: lavender;"
                ...
                <tr style="text-align: center">
                    <td colspan="4" class="auto-style1" style="color: #CC6600; background-color:#FFCCFF">Paddy CMR Days wise</td>
                </tr>
                <tr>
