<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FIN_DistibutBPL_RiceDCP.aspx.cs" Inherits="Reports_State_RPT_FIN_DistibutBPL_RiceDCP" %>
...
<body>
    ...
    <table cellpadding="0" cellspacing="0"   style="background-color:#ecf5d5; width:100%; border:double;border-color:#868f6f">
        ...
        संभाग वार जिले की एपीएल से बीपीएल अंतर्गत वितरण की जानकारी (चावल)</span></td>
        </tr>
    <tr style="font-size: 12pt">
    <td style="width: 198px" > 
        <span style="font-size: 10pt; color: #3300ff"><span style="color: #000000"></span><span
            style="font-size: 10pt; color: #3300ff">वर्ष चुने &nbsp;&nbsp; </span>
            <asp:DropDownList ID="ddlYear" runat="server" Height="19px" Width="130px">
    ...
    <td style="font-weight: bold;font-size: 9pt;color: #595f4a;font-family: Verdana;text-align: center; width: 36px;" 
                                  class="style1"> 
        <asp:DropDownList ID="ddlDivision" runat="server" Width="177px" Height="19px">
    ...
    <td style="font-weight: bold;font-size: 9pt;color: #595f4a;font-family: Verdana;text-align: left; width: 224px;" class="style4">
        ...
        <td style="font-weight: bold; font-size: 9pt; color: #595f4a; font-family: Verdana;
            text-align: left; width: 97px;" class="style7">
    ...
    <td style="font-weight: bold;font-size: 9pt;color: #595f4a;font-family: Verdana;height: 20px;text-align: left;">
        &nbsp; &nbsp; &nbsp;
    <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" Font-Size="10pt" Width="127px" OnClick="LinkButton1_Click" >पिछले पृष्ठ पर जाये</asp:LinkButton></td>
    </tr>
    </table>
