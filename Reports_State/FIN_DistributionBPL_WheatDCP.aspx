<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FIN_DistributionBPL_WheatDCP.aspx.cs" Inherits="Reports_State_Rpt_FIN_DistributionBPL_WheatDCP" %>
...
<body>
    ...
    <table cellpadding="0" cellspacing="0"   style="background-color:#ecf5d5; width:100%; border:double;border-color:#868f6f">
        ...
        संभाग वार जिले की एपीएल से बीपीएल अंतर्गत वितरण की जानकारी (गेहूँ)</span></td>
        </tr>
    <tr>
