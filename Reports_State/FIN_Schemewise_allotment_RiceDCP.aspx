<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FIN_Schemewise_allotment_RiceDCP.aspx.cs" Inherits="Reports_State_Rpt_FIN_Schemewise_allotment_RiceDCP" %>
...
<body>
    ...
    <table cellpadding="0" cellspacing="0"   style="background-color:#ecf5d5; width:100%; border:double;border-color:#868f6f">
        ...
        संभाग वार जिले की स्कीम अनुसार आवंटन की जानकारी (चावल)</span></td>
        </tr>
    <tr>
