<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FIN_WheatDCP_PackingWiseTotal.aspx.cs" Inherits="Reports_State_FIN_WheatDCP_PackingWiseTotal" %>
...
<body>
    ...
    <table cellpadding="0" cellspacing="0"   style="background-color:#ecf5d5; width:100%; border:double;border-color:#868f6f">
        ...
        संभाग वार जिले की स्टॉक की जानकारी (गेहूँ)(new)</span></td>
        </tr>
    <tr>
