...
public partial class Reports_State_GunnyBags_IndentCreation_Report : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        getDistData(ddlCropYear.SelectedValue.ToString());

    }
    private void getDistData(string CropYear)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "GunnyBags_IndentCreation";
