...
public partial class Reports_State_GunnyBags_IndentCreation_Report_Dist : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["st_id"] != null || Session["Region_id"] != null || Session["dist_id"] != null)
        {
            if (!IsPostBack)
            {
                DistId = Session["dist_name"].ToString();
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        getDistData(ddlCropYear.SelectedValue.ToString(), DistId);
    ...
    private void getDistData(string CropYear, string District)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "GunnyBags_IndentCreationDist";
        ...
        // paramList.Add(new ReportParameter("ADistrict", DistCode, false));
    ...
    protected void lnkbtnBack_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            if (Session["st_id"] != null)  //For HO
            {
                ...
                {
                    Response.Redirect("~/State/GunnyBagsReports_StateHome.aspx");
                }
                else
                {
                    Response.Redirect("~/State/GunnyBagsReports_StateHome.aspx");
