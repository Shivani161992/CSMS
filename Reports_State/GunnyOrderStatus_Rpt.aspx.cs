...
public partial class Reports_State_GunnyOrderStatus_Rpt : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        getData(ConvertFromDate, ConvertToDate);

    }

    private void getData(string FrmDate, string ToDate)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "GunnyOrderStatus";
