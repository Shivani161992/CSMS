...
public partial class Reports_State_HO_DataEntryStatus : System.Web.UI.Page
{
    ...
    private void get_Data(string fdate)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "ho_DataEntryStatus";
