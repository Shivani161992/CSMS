<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LoginReportofOperators_District.aspx.vb" Inherits="Reports_State_LoginReportofOperators_District" %>
...
<head id="Head1" runat="server">
    <title>Login Report of Operators </title>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 823px; background-color: #ece9d8;" id="">
            ...
            <tr>
                ...
                <td align="center" colspan="4" style="height: 23px; color: teal;">
                    <strong>Login Report of Operators of Districts &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; </strong>
                </td>
