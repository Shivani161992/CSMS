<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MillerRegistration_rpt.aspx.cs" Inherits="Reports_State_MillerRegistration_rpt" %>
        ...
        <div>
            ...
            <table style="width: 100%; background-color: white;" align="center">
                ...
                <tr style="text-align: center">
                    <td colspan="5" class="column">Paddy Milling Miller's Registration (CropYear Wise)</td>
                </tr>
                    ...
                    <td class="columncolumn">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <asp:Label ID="Label4" runat="server" Style="font-weight: 700; font-size: large;" Text="District"></asp:Label>

                                    <asp:DropDownList ID="ddlDist" runat="server" class="tddl" Width="173px" Style="margin-left: 20px">
