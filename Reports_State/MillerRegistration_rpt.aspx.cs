...
public partial class Reports_State_MillerRegistration_rpt : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    private void getData(string CropYear)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "Miller_Registration_CropYear";
    ...
    private void getDistData(string CropYear, string DistID)
    {
        while (this.ReportViewer1.ServerReport.IsDrillthroughReport)
        {
            this.ReportViewer1.PerformBack();
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "Miller_Registration_CropYear_Dist";
        ReportViewer1.ServerReport.ReportServerCredentials = new ReportServerNetworkCredentials();
        ReportParameterInfoCollection pInfo = default(ReportParameterInfoCollection);
        System.Collections.Generic.List<ReportParameter> paramList = new System.Collections.Generic.List<ReportParameter>();
