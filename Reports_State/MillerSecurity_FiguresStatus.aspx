<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MillerSecurity_FiguresStatus.aspx.cs" Inherits="Reports_State_MillerSecurity_FiguresStatus" %>
        ...
        <div>
            ...
            <table style="width: 100%; background-color: white;" align="center">
                ...
                <tr style="text-align: center">
                    <td colspan="4" class="column">Miller Security  Figures Status Report
                        ...
                        <table style="width: 100%;">
                            <tr>
                                <td style="text-align: left;">
                                    <asp:Label ID="Label3" runat="server" Style="font-weight: 700; font-size: large;" Text="CropYear"></asp:Label>
                                    ...
                                    <asp:DropDownList ID="ddlDist" class="tddl" runat="server" Width="473px" Style="margin-left: 20px">
                                    </asp:DropDownList>
                                </td>
                                <td style="text-align: right;">
                                    <asp:Button ID="btnReport" runat="server" Text="View Report" Style="font-weight: 700; font-size: small;" CssClass="bttn w3-grey" OnClick="btnReport_Click" />
                                </td>
                                <td style="text-align: center;">
                                    <asp:LinkButton ID="lnkbtnBack" runat="server" Font-Bold="True" ForeColor="#6B8E23" Style="text-align: center; font-size: medium;" OnClick="lnkbtnBack_Click">Back</asp:LinkButton>
