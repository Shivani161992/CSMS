...
public partial class Reports_State_MillerSecurity_FiguresStatus : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    private void getDistData(string CropYear, string MillCode)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "MillerSecurityStatus";
        ReportViewer1.ServerReport.ReportServerCredentials = new ReportServerNetworkCredentials();
        ReportParameterInfoCollection pInfo = default(ReportParameterInfoCollection);
        System.Collections.Generic.List<ReportParameter> paramList = new System.Collections.Generic.List<ReportParameter>();

        paramList.Add(new ReportParameter("MillName", MillCode, false));
