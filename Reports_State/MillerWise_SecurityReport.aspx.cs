...
public partial class Reports_State_MillerWise_SecurityReport : System.Web.UI.Page
{
    ...
    private void getDistData(string CropYear, string MillCode)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "PM_Miller_SecurityStatusRpt";
