...
public partial class Reports_State_MovmtOrderStatus_Rpt_Percentage : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    private void getData(string Comdty, string FrmDate, string ToDate)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "MovmtOrderStatus_Rpt_Percentage";
