<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MovntOrderStatus_OnChallan_Perc_Rpt.aspx.cs" Inherits="Reports_State_MovntOrderStatus_OnChallan_Perc_Rpt" %>
        ...
        <div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3; padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%; background-color: lavender;"
                ...
                <tr style="text-align: center">
                    <td colspan="9" class="auto-style1" style="color: #CC6600; background-color:#FFCCFF">PDS Movement Order Status  Delivery Challan  (By Road) Percentage</td>
                </tr>
                <tr>
                    <td>
