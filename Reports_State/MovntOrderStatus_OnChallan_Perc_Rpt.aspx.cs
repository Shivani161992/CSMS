...
public partial class Reports_State_MovntOrderStatus_OnChallan_Perc_Rpt : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    private void getData(string Comdty, string FrmDate, string ToDate)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "MovementOrder_ChallanQty_Betwdates";
