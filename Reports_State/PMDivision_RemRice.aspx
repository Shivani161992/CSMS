<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PMDivision_RemRice.aspx.cs" Inherits="Reports_State_PMDivision_RemRice" %>
        ...
        <div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3; padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%; background-color: lavender;"
                ...
                <tr style="text-align: center">
                    <td colspan="4" class="auto-style1" style="color: #CC6600; background-color: #FFCCFF">Paddy Milling Status By Rem. Rice Qty.(CropYear & Division Wise)</td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:Label ID="Label2" runat="server" Style="font-weight: 700; font-size: large;" Text="Division"></asp:Label>
