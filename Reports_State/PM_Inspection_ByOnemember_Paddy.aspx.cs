...
public partial class Reports_State_PM_Inspection_ByOnemember_Paddy : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    private void getData(string CropYear)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "PM_Inspection_ByOnemember_Paddy";
