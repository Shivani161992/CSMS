...
public partial class Reports_State_PM_Inspection_Team_rpt : System.Web.UI.Page
{
    ...
    private void getData(string CropYear, string TeamID)
    {
       // string DistCode = Session["dist_id"].ToString();
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "PM_Inspection_Team";
    ...
    public void GetTeamName()
    {
        ...
        using (con = new SqlConnection(strcon))
        {
            try
            {
                ...
                string select = "";
                select = "select distinct GM.TeamName,IM.Team_ID from Inspector_Master_Team as IM inner join PM_Ins_GroupName_Master as GM on GM.TeamID=IM.Team_ID where IM.Season='Kharif' order by TeamName";
