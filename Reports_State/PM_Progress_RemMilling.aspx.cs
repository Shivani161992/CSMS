...
public partial class Reports_State_PM_Progress_RemMilling : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    private void getData(string CropYear)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "PM_Progress_RemMilling";
    ...
    private void getDistData(string CropYear, string DistCode)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "PM_Progressive_Dist";
        ReportViewer1.ServerReport.ReportServerCredentials = new ReportServerNetworkCredentials();
        ReportParameterInfoCollection pInfo = default(ReportParameterInfoCollection);
        System.Collections.Generic.List<ReportParameter> paramList = new System.Collections.Generic.List<ReportParameter>();

        paramList.Add(new ReportParameter("CropYear", CropYear, false));
        paramList.Add(new ReportParameter("DistID", DistCode, false));
