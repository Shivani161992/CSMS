...
public partial class Reports_State_PM_Recvng_Frm_Sending_OD : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        {
            getData(Cropyear, ConvertFromDate, ConvertToDate);
        }
        else
        {
            getDataDist(Cropyear, ConvertFromDate, ConvertToDate, ddlDist.SelectedValue.ToString());

        }
    }

    private void getData(string CropYear, string Fdate, string Tdate)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "PM_Recvng_Frm_Sending_OD";
        ...
        paramList.Add(new ReportParameter("Tdate", Tdate, false));
    ...
    private void getDataDist(string CropYear, string Fdate, string Tdate, string district)
    {
        while (this.ReportViewer1.ServerReport.IsDrillthroughReport)
        {
            this.ReportViewer1.PerformBack();
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "PM_Recvng_Frm_Sending_OD_ByDist";
        ReportViewer1.ServerReport.ReportServerCredentials = new ReportServerNetworkCredentials();
        ReportParameterInfoCollection pInfo = default(ReportParameterInfoCollection);
        System.Collections.Generic.List<ReportParameter> paramList = new System.Collections.Generic.List<ReportParameter>();
