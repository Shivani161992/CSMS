...
public partial class Reports_State_PM_RemainingCMRDetails_Rpt : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    private void getData(string CropYear, string DistId)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "PM_RemainingCMRDetails_Rpt";
