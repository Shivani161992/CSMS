...
public partial class Reports_State_PMillingStatus_Division : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    private void getData(string CropYear)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "PMillingStatus_ALL";
    ...
    private void getDistData(string CropYear, string DistCode)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "PMillingStatus_Division";
        ReportViewer1.ServerReport.ReportServerCredentials = new ReportServerNetworkCredentials();
        ReportParameterInfoCollection pInfo = default(ReportParameterInfoCollection);
        System.Collections.Generic.List<ReportParameter> paramList = new System.Collections.Generic.List<ReportParameter>();
