<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaddyLift_Godown.aspx.cs" Inherits="Reports_State_PaddyLift_Godown" %>
        ...
        <div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3; padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%; background-color: lavender;"
                ...
                <tr style="text-align: center">
                    <td colspan="9" class="auto-style1" style="color: #CC6600; background-color:#FFCCFF">Godown Wise Paddy Lifting Position
                </tr>
                <tr>
                    <td>
