...
public partial class Reports_State_PaddyMilling_Status_MRFD : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    {
        if (rdbCivil.Checked == true)
        {
            getDataSCSC(ddlCropYear.SelectedValue.ToString());
        }
        else if(rdbMFD.Checked==true)
        {
            getDataMFD(ddlCropYear.SelectedValue.ToString());
        }

        else if (rdbMer.Checked == true)
        {
            getDataMer(ddlCropYear.SelectedValue.ToString());
        }
    }

    private void getDataSCSC(string CropYear)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "PaddyMilling_Status";
    ...
    private void getDataMFD(string CropYear)
    {
        while (this.ReportViewer1.ServerReport.IsDrillthroughReport)
        {
            this.ReportViewer1.PerformBack();
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "PaddyMilling_Status_MRFD";
        ReportViewer1.ServerReport.ReportServerCredentials = new ReportServerNetworkCredentials();
        ReportParameterInfoCollection pInfo = default(ReportParameterInfoCollection);
        System.Collections.Generic.List<ReportParameter> paramList = new System.Collections.Generic.List<ReportParameter>();
    ...
    private void getDataMer(string CropYear)
    {
        while (this.ReportViewer1.ServerReport.IsDrillthroughReport)
        {
            this.ReportViewer1.PerformBack();
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "PaddyMilling_Status_Corp_MRFD";
        ReportViewer1.ServerReport.ReportServerCredentials = new ReportServerNetworkCredentials();
        ReportParameterInfoCollection pInfo = default(ReportParameterInfoCollection);
        System.Collections.Generic.List<ReportParameter> paramList = new System.Collections.Generic.List<ReportParameter>();
