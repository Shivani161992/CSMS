...
public partial class Reports_State_Paddy_Issued_Distance : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    private void getData(string CropYear)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "Paddy_Issued_Distance_All";
    ...
    private void getDistData(string CropYear, string District)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "Paddy_Issued_Distance";
        ReportViewer1.ServerReport.ReportServerCredentials = new ReportServerNetworkCredentials();
        ReportParameterInfoCollection pInfo = default(ReportParameterInfoCollection);
        System.Collections.Generic.List<ReportParameter> paramList = new System.Collections.Generic.List<ReportParameter>();
