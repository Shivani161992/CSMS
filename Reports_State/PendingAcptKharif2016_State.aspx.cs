...
public partial class Reports_State_PendingAcptKharif2016_State : System.Web.UI.Page
{
    SqlConnection con;
    SqlDataAdapter da;
    DataSet ds;
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        {
            getPaddyData(ddlComdty.SelectedValue.ToString(), ddlComdty.SelectedItem.ToString());
        }
    }

    private void getPaddyData(string Comdty, string CmodtyName)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "PendingAcptKharif2016_State";
