...
public partial class Reports_State_QualityInspection_HOLevelInspWise : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    private void getData(string CropYear, string Fromdate, string ToDate)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "QualityInspection_HOLevelInspWise";
