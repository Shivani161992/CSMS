<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Quality_Ins_CMR_wise.aspx.cs" Inherits="Reports_State_Quality_Ins_CMR_wise" %>
        ...
        <div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3; padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%; background-color: lavender;"
                ...
                <tr style="text-align: center">
                    <td colspan="4" class="auto-style1" style="color: #CC6600; background-color:#FFCCFF">Quality Inspection Report</td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style2">
                        ...
                        <asp:DropDownList ID="ddlDist" runat="server" Width="173px" style="margin-left:20px" Autopostback='true' OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged">
                 ...
                 <tr>
                    <td class="auto-style2">
                        <asp:Label ID="Label3" runat="server" Style="font-weight: 700; font-size: large;" Text="Issue Center"></asp:Label>
                        <asp:DropDownList ID="ddlIC" runat="server" Width="173px" style="margin-left:20px">
