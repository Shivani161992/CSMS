...
public partial class Reports_State_Quality_Ins_CMR_wise : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    private void getDistData(string CropYear, string DistCode)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "Quality_Ins_CMR_wise";
        ReportViewer1.ServerReport.ReportServerCredentials = new ReportServerNetworkCredentials();
        ReportParameterInfoCollection pInfo = default(ReportParameterInfoCollection);
        System.Collections.Generic.List<ReportParameter> paramList = new System.Collections.Generic.List<ReportParameter>();
    ...
    private void getICData(string CropYear, string DistCode, string Icenter)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "Quality_Ins_CMR_IC_wise";
        ReportViewer1.ServerReport.ReportServerCredentials = new ReportServerNetworkCredentials();
        ReportParameterInfoCollection pInfo = default(ReportParameterInfoCollection);
        System.Collections.Generic.List<ReportParameter> paramList = new System.Collections.Generic.List<ReportParameter>();
