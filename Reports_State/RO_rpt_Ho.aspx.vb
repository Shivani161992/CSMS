...
Partial Class Reports_State_RO_rpt_Ho
...
#End Region
    ...
    Private Sub get_Data(ByVal Month As String, ByVal Year As String)
        Dim folder As String = ConfigurationManager.ConnectionStrings("rptfolder").ProviderName


        ' For Report
        If ReportViewer1.ServerReport.ReportPath = folder & "Release_Order_ROwise_rpt" Or ReportViewer1.ServerReport.ReportPath = folder & "Release_Order_rpt" Then
        ...
        Else
            ...
            If (chkan.Checked = True) Then
                ReportViewer1.ServerReport.ReportPath = folder & "Total_allot_Lift_RO_HO"
            Else
                ReportViewer1.ServerReport.ReportPath = folder & "Release_Order_HO_rpt"
            End If
