<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rackreport_Commoditywise.aspx.cs" Inherits="Reports_State_Rackreport_Commoditywise" %>
...
<head runat="server">
    <title>Rack Report Commodity wise</title>
                ...
                <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3;
                    ...
                    <tr>
                        <td align="center" colspan="5" style="font-weight: bolder; font-size: 12pt; color:Black; background-color: lavender; text-align: center;">
                            <span style="font-weight: 700; font-size: 11pt; color: #00008b; font-style: normal;
                                font-family: Arial; text-decoration: none">Commodity Wise Rack Dispatch Report</span></td>
                    ...
                    <tr style="font-size: 12pt">
                        ...
                        <td style="width: 182px; font-size: 10pt; height: 43px;" align="left">
                            <asp:TextBox ID="txtDate" runat="server" Width="100px" >16-09-2013</asp:TextBox>
