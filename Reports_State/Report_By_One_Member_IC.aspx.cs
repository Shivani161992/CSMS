...
public partial class Reports_State_Report_By_One_Member_IC : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    {
        if (Session["st_id"] != null || Session["Region_id"] != null || Session["dist_id"] != null || Session["issue_id"] != null)
        {
            if (!IsPostBack)
            {
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        ICID = Session["issue_id"].ToString();
        DistId = Session["dist_id"].ToString();
        getData(ddlCropYear.SelectedValue.ToString(), DistId, ICID);
        //// }
        //// else
        //// {
    ...
    private void getData(string CropYear, string DistId, string ICID)
    {
        ...
        ReportViewer1.ServerReport.ReportPath = folder + "Report_By_One_Member_IC";
        ...
        paramList.Add(new ReportParameter("ICID", ICID, false));
    ...
    protected void lnkbtnBack_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                Response.Redirect("~/IssueCenters/frmReports.aspx");
            }
        }
    }
