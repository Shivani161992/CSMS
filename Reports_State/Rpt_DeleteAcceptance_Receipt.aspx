<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_DeleteAcceptance_Receipt.aspx.cs" Inherits="Reports_State_Rpt_DeleteAcceptance_Receipt" %>
...
<body>
    ...
    <table cellpadding="0" cellspacing="0"   style="background-color:#ecf5d5; width:100%; border:double;border-color:#868f6f">
        ...
        संभाग वार जिले की निरस्त किये हुए प्राप्ति एवं स्वीकृति
