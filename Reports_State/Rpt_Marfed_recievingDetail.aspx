<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_Marfed_recievingDetail.aspx.cs" Inherits="Reports_State_Rpt_csms_distwise_compliedreport" %>
...
<head runat="server">
    <title>Marfed Status District Wise</title>
                    ...
                    <tr>
                        <td align="center" colspan="5" style="font-weight: bolder; font-size: 12pt; color:Black; background-color: lavender; text-align: center;">
                            <span style="font-weight: 700; font-size: 11pt; color: #00008b; font-style: normal;
                                font-family: Arial; text-decoration: none">Marketing federation Receiving Datewise Report</span></td>
