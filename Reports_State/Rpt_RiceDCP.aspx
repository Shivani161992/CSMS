<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_RiceDCP.aspx.cs" Inherits="Admin_HOMPSCSC_Rpt_RiceDCP" %>
...
<body>
    ...
    <span style="font-size: 10pt; color: #3300ff">वर्ष चुने</span>
        <asp:DropDownList ID="ddlYear" runat="server" Width="130px" Height="19px">
    ...
    <td style="font-weight: bold;font-size: 9pt;color: #595f4a;font-family: Verdana;text-align: center;"> 
        <asp:DropDownList ID="ddlDivision" runat="server" Width="195px" Height="19px">
    ...
    <td style="font-weight: bold;font-size: 9pt;color: #595f4a;font-family: Verdana;text-align: left;" >
        <asp:DropDownList ID="ddlMonth" runat="server" Width="180px" Height="18px">
