<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_WheatDCP.aspx.cs" Inherits="Admin_HOMPSCSC_Rpt_WheatDCP" %>
...
<body>
    ...
    <td style="font-weight: bold;font-size: 9pt;color: #595f4a;font-family: Verdana;text-align: left;" class="style4">
        ...
        <td style="font-weight: bold; font-size: 9pt; color: #595f4a; font-family: Verdana;
            ...
            <asp:Button ID="Button1" runat="server" Text="Generate Report" Width="106px" 
