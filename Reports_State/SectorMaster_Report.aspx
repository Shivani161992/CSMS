<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SectorMaster_Report.aspx.cs" Inherits="Reports_State_SectorMaster_Report" %>
...
<head id="Head1" runat="server">
    <title>Sector Master Report</title>
</head>
<body>
    ...
    <table cellpadding="0" cellspacing="0"   style="background-color:#ecf5d5; width:100%; border:double;border-color:#868f6f">
        <tr>
            <td colspan="7" style="font-weight: bold; font-size: 9pt; color: #595f4a; font-family: Verdana;
                ...
                List of Sector Name District and Issue Center Wise</td>
        </tr>
    <tr>
