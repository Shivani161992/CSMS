<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StateAllocation_rpt_Ho.aspx.vb" Inherits="Reports_State_StateAllocation_rpt_Ho" %>
    ...
    <form id="form1" runat="server">
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 823px; background-color: #ece9d8;" id="">
            ...
            <tr>
                ...
                <td align="right" style="width: 123px; height: 23px; vertical-align: middle;">
                    Allocation
                    Year&nbsp;
                </td>
