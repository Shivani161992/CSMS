...
Partial Class Reports_State_Stock_Register_Graph
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            ...
            ddlalotmm.SelectedIndex = DateTime.Today.Month - 1S
        End If
...
#End Region
    ...
    Private Sub get_Data(ByVal Month As String, ByVal Year As String, ByVal Commodity As String)
