<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Stock_rpt_HO.aspx.vb" Inherits="Reports_State_Stock_rpt_HO" %>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 823px; background-color: #ece9d8;" id="">
            ...
            <tr>
                ...
                <td style="width: 92px; height: 23px;">
                     <asp:DropDownList ID="ddlallotyear" runat="server" Width="119px">
                                </asp:DropDownList>
                </td>
            ...
            <tr>
                ...
                <td style="width: 92px; height: 25px;">
                    <asp:DropDownList ID="ddlscheme" runat="server" Width="122px">
                    </asp:DropDownList></td>
            ...
            <tr>
                ...
                <td style="width: 100px; height: 25px">
                    <asp:CheckBox ID="chkan" runat="server" /></td>
