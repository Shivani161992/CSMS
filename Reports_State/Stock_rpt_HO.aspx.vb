...
Partial Class Reports_State_Stock_rpt_HO
...
#End Region
    ...
    Private Sub get_Data(ByVal Month As String, ByVal Year As String, ByVal Commodity As String, ByVal Scheme As String)
        Dim folder As String = ConfigurationManager.ConnectionStrings("rptfolder").ProviderName

        If ReportViewer1.ServerReport.ReportPath = folder & "Stock_Register_ROwise_rpt" Or ReportViewer1.ServerReport.ReportPath = folder & "Stock_Registor_rpt" Then
        ...
        Else
            ...
            If (chkan.Checked = True) Then
                ReportViewer1.ServerReport.ReportPath = folder & "Total_StockPostion_HO"
            ...
            Else
                ReportViewer1.ServerReport.ReportPath = folder & "Stock_Registor_HO"
                ReportViewer1.ServerReport.ReportServerCredentials = New MyReportServerCredentials
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        get_Data(month, year, Commodity, Scheme)
