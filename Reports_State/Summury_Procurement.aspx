<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Summury_Procurement.aspx.vb" Inherits="Reports_State_Summury_Procurement" %>
...
<head id="Head1" runat="server">
    <title>Summury Report (Procurement )</title>
    ...
    <form id="form1" runat="server">
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 887px; background-color: #ece9d8;" id="">
            ...
            <tr>
                ...
                <td>
                       <asp:TextBox ID="tx_to_date" runat="server" Width="127px"></asp:TextBox>
                                <script type  ="text/javascript">
                                                	new tcal ({
				'formname': 'form1',
