...
Partial Class Reports_State_TO_rpt_HO
...
#End Region
    ...
    Private Sub get_Data(ByVal FromDate As String, ByVal Todate As String)
        ...
        ' For Report
        If ReportViewer1.ServerReport.ReportPath = folder & "Transport_Order_Regional_rpt" Or ReportViewer1.ServerReport.ReportPath = folder & "Transport_Order_rpt" Then
        ...
        Else
            ...
            ReportViewer1.ServerReport.ReportPath = folder & "Transport_Order_HO_rpt"
