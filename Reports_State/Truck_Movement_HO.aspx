<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Truck_Movement_HO.aspx.vb" Inherits="Reports_State_Truck_Movement_HO" %>
...
<body>
    <form id="form1" runat="server">
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 887px; background-color: #ece9d8;" id="">
            ...
            <tr>
                <td style="width: 228px; height: 25px; vertical-align: middle;">
                    From Date</td>
                <td style="width: 172px; height: 25px;">
                    <asp:TextBox ID="tx_from_date" runat="server" Width="124px"></asp:TextBox>
                ...
                <td align="right" style="width: 93px; height: 25px; vertical-align: middle;">
                    To Date&nbsp;
                </td>
                ...
                <td style="width: 417px; height: 25px;" align="right">
