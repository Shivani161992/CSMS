...
Partial Class Reports_State_Truck_Movement_HO
...
#End Region
    ...
    Private Sub get_Data(ByVal FromDate As String, ByVal Todate As String)
        Dim folder As String = ConfigurationManager.ConnectionStrings("rptfolder").ProviderName


        ' For Report
        If ReportViewer1.ServerReport.ReportPath = folder & "Truck_Movement" Or ReportViewer1.ServerReport.ReportPath = folder & "Truck_Movement_Region" Then
        ...
        Else
            ...
            ReportViewer1.ServerReport.ReportPath = folder & "Truck_Movement_HO"
    ...
    Protected Sub LinkButton1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LinkButton1.Click
        Dim folder As String = ConfigurationManager.ConnectionStrings("rptfolder").ProviderName
        If ReportViewer1.ServerReport.ReportPath = folder & "Truck_Movement" Or ReportViewer1.ServerReport.ReportPath = folder & "Truck_Movement_Region" Or ReportViewer1.ServerReport.ReportPath = folder & "Truck_Movement_analysis" Then
            ReportViewer1.PerformBack()
        Else
