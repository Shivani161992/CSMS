<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Wheat_Inspection_Team_rpt.aspx.cs" Inherits="Reports_State_Wheat_Inspection_Team_rpt" %>
        ...
        <div>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3; padding: 1; border-collapse: collapse; border-color: Maroon; width: 100%; background-color: lavender;"
                ...
                <tr style="text-align: center">
                    <td colspan="4" class="auto-style1" style="color: #CC6600; background-color:#FFCCFF">CMR Team Inspection Report</td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:Label ID="Label2" runat="server" Style="font-weight: 700; font-size: large;" Text="Team Name"></asp:Label>
                        <asp:DropDownList ID="ddlTeamName" runat="server" Width="173px" style="margin-left:20px"  >
