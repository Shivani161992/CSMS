<%@ Page Language="VB" AutoEventWireup="false" CodeFile="graphical_Do_DivIssuerpt.aspx.vb" Inherits="graphical_Do_DivIssuerpt" %>
    ...
    <form id="form1" runat="server">
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 808px; background-color: #ece9d8;" id="">
            ...
            <tr>
                ...
                <td align="right" style="vertical-align: middle; width: 256px; height: 24px">
                </td>
            ...
            <tr>
                <td style="vertical-align: middle; width: 83px; height: 23px">
                    Month</td>
                ...
                <td align="right" style="vertical-align: middle; width: 256px; height: 23px">
                    Year&nbsp;
                </td>
