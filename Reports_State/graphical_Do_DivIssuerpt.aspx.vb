...
Partial Class graphical_Do_DivIssuerpt
...
#End Region
    ...
    Private Sub get_Data()
        ...
        'If ReportViewer1.ServerReport.ReportPath = folder & "divisionGraphRptIssue" Or ReportViewer1.ServerReport.ReportPath = folder & "divisionGraphRptLift" Then
        '    ReportViewer1.PerformBack()
        'Else
        Dim div_code As String = ddl_division.SelectedItem.Value
        ' For Report
        ...
        ReportViewer1.ServerReport.ReportPath = folder & "divisionGraphRptIssue"
        ...
        paramList.Add(New ReportParameter("divCode", div_code, False))
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        If ddl_division.SelectedItem.Text = "Select" Then
            Page.RegisterClientScriptBlock("asdsad", " <script language=javascript > alert('Please Select Division ...');</script>")
        Else
