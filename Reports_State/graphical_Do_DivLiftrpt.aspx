<%@ Page Language="VB" AutoEventWireup="false" CodeFile="graphical_Do_DivLiftrpt.aspx.vb" Inherits="graphical_Do_DivLiftrpt" %>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 808px; background-color: #ece9d8;" id="">
            <tr>
                <td align="center" colspan="5" style="font-weight: bolder; font-size: 15pt; color: teal; height: 23px;">
                    Graphical Representation of Lifting Against Issued DO</td>
            </tr>
            <tr>
                ...
                <td align="right" style="vertical-align: middle; width: 174px; height: 24px">
                </td>
            ...
            <tr>
                <td style="vertical-align: middle; width: 100px; height: 23px">
                    Month</td>
                ...
                <td align="right" style="vertical-align: middle; width: 174px; height: 23px">
                    Year&nbsp;
                </td>
