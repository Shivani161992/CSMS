<%@ Page Language="VB" AutoEventWireup="false" CodeFile="graphical_Do_liftedrpt.aspx.vb" Inherits="graphical_Do_liftedrpt" %>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-style:double; border-width:3; padding:1; BORDER-COLLAPSE: collapse; border-color :Maroon  ; width: 808px; background-color: #ece9d8;" id="">
            <tr>
                <td align="center" colspan="5" style="font-weight: bolder; font-size: 15pt; color: teal; height: 23px;">
                    &nbsp;Graphical Representation of Lifted Delivery Order</td>
            </tr>
            <tr>
                <td style="vertical-align: middle; width: 47px; height: 23px">
                    Month</td>
            ...
            <tr>
                <td style="vertical-align: middle; width: 47px; height: 24px">
                    </td>
