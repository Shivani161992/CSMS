...
Partial Class liftingDetails_DO_divisionRpt
...
#End Region
    ...
    Private Sub get_Data(ByVal from_date As String, ByVal to_date As String)
        ...
        If ReportViewer1.ServerReport.ReportPath = folder & "liftedDO_againstDO" Or ReportViewer1.ServerReport.ReportPath = folder & "drilldownDoRpt" Then
        ...
        Else
            ...
            ReportViewer1.ServerReport.ReportPath = folder & "divisionRpt"
