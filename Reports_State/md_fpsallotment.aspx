<%@ Page Language="C#" AutoEventWireup="true" CodeFile="md_fpsallotment.aspx.cs" Inherits="Reports_State_md_fpsallotment" %>
...
<body>
    ...
    <td style="font-weight: bold;font-family: Verdana;text-align: center; width: 84px;" 
        ...
        <span style="font-size: 10pt">
            <asp:Button ID="Button1" runat="server" Text="Generate Report" Width="120px" OnClick="Button1_Click" />
            <%-- <asp:Button ID="Button1" runat="server" Text="Generate Report" Width="120px"  Height="26px"  />--%></span></td>
    ...
    <td style="font-weight: bold;font-size: 9pt;color: #595f4a;font-family: Verdana;height: 20px;text-align: left;">
        <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">पिछले पृष्ठ पर जाये</asp:LinkButton>
   <%-- <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" Font-Size="10pt" Width="163px"  >पिछले पृष्ठ पर जाये</asp:LinkButton>--%>
    </td>
    </tr>
    </table>
