<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_Pending_Acceptance_Note_Details.aspx.cs" Inherits="Reports_State_rpt_Pending_Acceptance_Note_Details" %>
    ...
    <div>
     <center>
                <table border="1" cellpadding="0" cellspacing="0" style="border-style: double; border-width: 3;
                    ...
                    <tr>
                        <td align="center" colspan="5" style="font-weight: bolder; font-size: 12pt; color:Black">
                            <span style="font-family: Calibri; font-size: 14pt; font-weight: 700; font-style: normal; text-decoration: underline;">
                            Pending Acceptance Note Detail(Division Wise)</span></td>
               ...
               <script type="text/javascript">
                ...
                <asp:Panel ID="pnlreport" runat="server" Visible="false" Width="1252px">
                   <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="520px" ProcessingMode="Remote"
                      Width="100%"  Font-Names="Verdana" Font-Size="9pt" ShowCredentialPrompts="False"
