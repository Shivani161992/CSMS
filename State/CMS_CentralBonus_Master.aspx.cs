...
public partial class State_CMS_CentralBonus_Master : System.Web.UI.Page
{
    ...
    protected void btAdd_Click(object sender, EventArgs e)
    {
        ...
        using (con = new SqlConnection(strcon))
            ...
            {
                con.Open();
                string qrey = "select max(CentralBonusID) as CentralBonusID  from CMS_CentralCost_Master where  LEN(CentralBonusID)<15  ";
                ...
                gatepass = ds.Tables[0].Rows[0]["CentralBonusID"].ToString();
        ...
        using (con = new SqlConnection(strcon))
            try
            {
                ...
                string strselect = "insert into CMS_CentralCost_Master( CentralBonusID, Commodity, Rate_Rs, FromDate, ToDate, Createddate, IP) values ('" + gatepass + "','" + ddlcommodities.SelectedValue.ToString() + "','" + txtRate.Text + "','" + ConvertFromDate + "','" + ConvertToDate + "',getdate(),'" + ip + "')";
    ...
    void Fillgrid()
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            string select = "select C.Commodity_Name, Rate_Rs, CONVERT(varchar(10), FromDate , 103) as FromDate, CONVERT(varchar(10), ToDate , 103) as ToDate   From CMS_CentralCost_Master as NC inner join tbl_MetaData_STORAGE_COMMODITY as C on C.Commodity_Id=NC.Commodity order by Commodity_Name, NC.Createddate ";
