<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/State_MPSCSC.master" AutoEventWireup="true" CodeFile="CMS_CommisionToSociety_Master.aspx.cs" Inherits="State_CMS_CommisionToSociety_Master" %>
        ...
        <table style="width: 1100px; font-size: 12px;">
            <tr>
                ...
                <td style="text-align: center; width: 700px">
                    <h2 style="color: #e74c3c; font-size: 20px; font-family: 'Bellefair'; letter-spacing: 4px; text-align:center;">Commission To Society Master</h2>
                      <input type="hidden" runat="server" id="hdfID" />
                </td>

                <td style="text-align: right; width: 200px">
                    <a href="CMS_CommisionToSociety_Master.aspx" class="sign">&#8635 New
                    </a>
                </td>
            </tr>
            ...
            <tr>
                <td class="InspColumn" style="padding-left: 20px; text-align: left">Commodity
                 ...
                 <td class="InspColumn" style="padding-left: 20px; text-align: left">
                    ...
                    <asp:TextBox ID="txtNackedCost" CssClass="insptxt" runat="server" ReadOnly="true" ></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Style="font-size: 12px;"
                        ControlToValidate="txtNackedCost" ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>
                </td>
                 <td class="InspColumn" style="padding-left: 20px; text-align: left">
                     Nacked From Date
                    <br />

                    <asp:TextBox ID="txtNackedFromdate" CssClass="insptxt" runat="server" ReadOnly="true"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Style="font-size: 12px;"
                        ControlToValidate="txtNackedFromdate" ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>
                </td>
                </tr>
             ...
             <tr>
                ...
                <td class="InspColumn" style="padding-left: 20px; text-align: left">
                    ...
                    <asp:TextBox ID="txtNackedTodate" CssClass="insptxt" runat="server"  ReadOnly="true"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" Style="font-size: 12px;"
                        ControlToValidate="txtNackedTodate" ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>
                </td>
                 <td class="InspColumn" style="padding-left: 20px; text-align: left"> 
                      Percentage
                    <br />

                    <asp:TextBox ID="txtPercantage" CssClass="insptxt" runat="server" AutoPostBack="true" OnTextChanged="txtPercantage_TextChanged" ></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" Style="font-size: 12px;"
                        ControlToValidate="txtPercantage" ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>
                </td>
                 <td class="InspColumn" style="padding-left: 20px; text-align: left">
                </td>
                </tr>
             ...
             <tr>
              ...
              <tr>
                <td class="InspColumn" style="padding-left: 20px; text-align: left">Rate (Rs.)
                    ...
                    <asp:TextBox ID="txtRate" CssClass="insptxt" runat="server" ReadOnly="true" ></asp:TextBox>
                    ...
                    <div style="width: 100%; height: 150px; overflow: scroll">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Percentage" HeaderText="Percentage" HeaderStyle-CssClass="GridHeader">
                                    <HeaderStyle Font-Names="Arial" Font-Size="12px" />
                                </asp:BoundField>
                            ...
                            <RowStyle BackColor="#ffffff" ForeColor="#000000" Font-Size="12px" HorizontalAlign="Center" />
