...
public partial class State_CMS_CommisionToSociety_Master : System.Web.UI.Page
{
    ...
    protected void btAdd_Click(object sender, EventArgs e)
    {
        ...
        using (con = new SqlConnection(strcon))
            ...
            {
                con.Open();
                string qrey = "select max(RateID) as RateID  from CMS_CommisssionToSociety where  LEN(RateID)<15  ";
    ...
    void Fillgrid()
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            string select = "select C.Commodity_Name, Rate_Rs, CONVERT(varchar(10), FromDate , 103) as FromDate, CONVERT(varchar(10), ToDate , 103) as ToDate, Percentage   From CMS_CommisssionToSociety as NC inner join tbl_MetaData_STORAGE_COMMODITY as C on C.Commodity_Id=NC.Commodity order by Commodity_Name, NC.Createddate ";
