<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/State_MPSCSC.master" AutoEventWireup="true" CodeFile="CMS_LabourChargesMaster.aspx.cs" Inherits="State_CMS_LabourChargesMaster" %>
        ...
        <table style="width: 1100px; font-size: 12px;">
            <tr>
                ...
                <td style="text-align: center; width: 700px">
                    <h2 style="color: #e74c3c; font-size: 20px; font-family: 'Bellefair'; letter-spacing: 4px; text-align:center;">Labour Charges Master</h2>
                      <input type="hidden" runat="server" id="hdfID" />
                </td>

                <td style="text-align: right; width: 200px">
                    <a href="CMS_LabourChargesMaster.aspx" class="sign">&#8635 New
                    </a>
                </td>
            </tr>
                    ...
                    <div style="width: 100%; height: 150px; overflow: scroll">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Rate_Rs" HeaderText="Rate(Rs.)">
                                    <HeaderStyle Font-Names="Arial" Font-Size="12px" />
                                </asp:BoundField>
