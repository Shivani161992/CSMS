...
public partial class State_CMS_NackedCost : System.Web.UI.Page
{
    ...
    protected void btAdd_Click(object sender, EventArgs e)
    {
        ...
        using (con = new SqlConnection(strcon))
            ...
            {
                con.Open();
                string qrey = "select max(RateID) as RateID  from CMS_NackedCostMaster where  LEN(RateID)<15  ";
        ...
        using (con = new SqlConnection(strcon))
            try
            {
                ...
                string strselect = "insert into CMS_NackedCostMaster( RateID, Commodity, Rate_Rs, FromDate, ToDate, Createddate, IP) values ('" + gatepass + "','" + ddlcommodities.SelectedValue.ToString() + "','" + txtRate.Text + "','" + ConvertFromDate + "','" +ConvertToDate + "',getdate(),'" + ip + "')";
    ...
    void Fillgrid()
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            string select = "select C.Commodity_Name, Rate_Rs, CONVERT(varchar(10), FromDate , 103) as FromDate, CONVERT(varchar(10), ToDate , 103) as ToDate   From CMS_NackedCostMaster as NC inner join tbl_MetaData_STORAGE_COMMODITY as C on C.Commodity_Id=NC.Commodity order by Commodity_Name, NC.Createddate ";
