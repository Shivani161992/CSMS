<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/State_MPSCSC.master" AutoEventWireup="true" CodeFile="CSM_NirashritShulka.aspx.cs" Inherits="State_CSM_NirashritShulka" %>
        ...
        <table style="width: 1100px; font-size: 12px;">
            <tr>
                ...
                <td style="text-align: center; width: 700px">
                    <h2 style="color: #e74c3c; font-size: 20px; font-family: 'Bellefair'; letter-spacing: 4px; text-align:center;">Nirashrit Shulka Master</h2>
                      <input type="hidden" runat="server" id="hdfID" />
                </td>

                <td style="text-align: right; width: 200px">
                    <a href="CSM_NirashritShulka.aspx" class="sign">&#8635 New
                    </a>
                </td>
            </tr>
