<%@ Page Language="C#" MasterPageFile="~/MasterPage/State_MPSCSC.master" AutoEventWireup="true" CodeFile="Change_Password_HO.aspx.cs" Inherits="State_Change_Password_HO" Title="Change Password HO" %>
...
<td align="left">
    ...
    <tr>
        <td>
            &nbsp; &nbsp; &nbsp;&nbsp;
    <asp:Button ID="btnadd" runat="server" Text="Save" OnClick="btnadd_Click" Width="80px" ValidationGroup="1" /></td>
        <td align="left">
