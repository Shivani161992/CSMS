<%@ Page Language="C#" MasterPageFile="~/MasterPage/State_MPSCSC.master" AutoEventWireup="true" CodeFile="Commodity_Master.aspx.cs" Inherits="Commodity_Master" Title="Commodity Master" %>
 
 
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<div style="font-weight: bold; color: green; font-style: italic"> Commodity Master</div>
<div id ="ronewmargin">
     ...
     <tr>
         <td rowspan ="5" style="border-right: 1px solid; border-top: 1px solid; border-left: 1px solid;
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Commodity_ID" HeaderText="Comdty_ID" SortExpression="Commodity_ID" >
        ...
        <tr>
         ...
         <td align="left" style="border-right: 1px solid; border-top: 1px solid; font-weight: bold;
             ...
             font-style: italic">
             <asp:Button ID="btnsubmit" runat="server" Text="Add Commodity" OnClick="btnsubmit_Click" ValidationGroup="1" Width="124px" /><br />
             <asp:Button ID="btnremove" runat="server" Text="Remove Commodity" OnClick="btnremove_Click" Width="125px" /><br />
       ...
       <asp:Button ID="btnclose" runat="server" Text="Close" OnClick="btnclose_Click" Width="127px" /></td>
         <td valign="top" rowspan="2">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Commodity_ID" HeaderText="Comdty_ID" SortExpression="Commodity_ID" Visible="False" >
                    <ItemStyle CssClass="griditemlaro" />
                    <HeaderStyle CssClass="gridlarohead" />
                </asp:BoundField>
            </Columns>
