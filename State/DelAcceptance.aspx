<%@ Page Language="C#" MasterPageFile="~/MasterPage/State_MPSCSC.master" AutoEventWireup="true" CodeFile="DelAcceptance.aspx.cs" Inherits="State_DelAcceptance" Title="Untitled Page" %>
...
<center>
    <table style="border: thin groove black; width: 676px; height: 388px; ">
        <tr>
            <td colspan="2" 
                style="border: thin groove black; width: 600px; text-align: left; color: #000099;">
                डिलीट से पहले Search by Issue Id Option&nbsp; से भुगतान की स्थति देख कर डिलीट 
                करें |</td>
        </tr>
        <tr>
            <td colspan="2" style="border-right: black thin groove; border-top: black thin groove; border-left: black thin groove; width: 600px; border-bottom: black thin groove; text-align: left;">
                <span style="font-size: 11pt; color: #cc0033">अगर वेयर हाउस में एवं भुगतान की एंट्री नहीं हुई
                    है तो डिलीट करें , अन्यथा डिलीट ना करे |</span></td>
        </tr>
        <tr>
            ...
            <td style="border-right: black thin groove; border-top: black thin groove; border-left: black thin groove;
                ...
                <asp:DropDownList ID="ddlcommodtiy" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged" Width="221px">
                </asp:DropDownList></td>
        </tr>
        <tr>
	...
	new tcal ({
        ...
        <tr>
            <td style="width: 38px; text-align: left; border-right: black thin groove; border-top: black thin groove; border-left: black thin groove; border-bottom: black thin groove;">
                <asp:Label ID="lblDis" runat="server" Text="Select District" Width="191px"></asp:Label></td>
            <td style="width: 339px; text-align: left; border-right: black thin groove; border-top: black thin groove; border-left: black thin groove; border-bottom: black thin groove;">
                <asp:DropDownList ID="ddlDistrict" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged" Width="204px">
                </asp:DropDownList></td>
        </tr>
        <tr>
            <td style="width: 38px; text-align: left; border-right: black thin groove; border-top: black thin groove; border-left: black thin groove; border-bottom: black thin groove;">
