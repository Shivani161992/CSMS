<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/State_MPSCSC.master" AutoEventWireup="true" CodeFile="Master_StandingCommitee_TransRates.aspx.cs" Inherits="State_Master_StandingCommitee_TransRates" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <html>
        ...
        <tr>
            <td  colspan="4" style="width:800px; flex-align:center; font-family:Cambria; font-size:large; color:#004E4E;">
                <strong>

              
                Standing Committee Transporter Rates (Master)
                      </strong>
            </td>
        ...
        <tr>
            ...
            <td colspan="4" style="width:700px; background-color:#004E4E; height:20px; flex-align:center">
            ...
            <td colspan="4" style="width:700px; background-color:#004E4E; height:20px; flex-align:center">
                   ...
                   >
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Rates" HeaderText="Rate (per Ton/Km)" ></asp:BoundField>
