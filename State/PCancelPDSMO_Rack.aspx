<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PCancelPDSMO_Rack.aspx.cs" Inherits="State_PCancelPDSMO_Rack" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Cancel MO</title>
    ...
    <form id="form1" runat="server">
        <div class="A4">
            <table align="center" class="auto-style1">
                ...
                <tr>
                    <td style="text-align: center" class="auto-style3"><strong>&lt;&lt; <span class="auto-style2">CANCELLED <asp:Label ID="lblPDS" runat="server" Text=""></asp:Label> MOVEMENT ORDER</span> &gt;&gt;
            ...
            <table align="center" class="auto-style1">
                ...
                <tr>
                    <td style="text-align: left">
                        <asp:Label ID="lblDistMode" runat="server" Text="" Style="font-weight: 700"></asp:Label></td>
