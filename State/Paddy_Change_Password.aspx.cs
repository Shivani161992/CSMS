...
public partial class State_Paddy_Change_Password : System.Web.UI.Page
{
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (mpwd == moldpwd)
            {
                ...
                string qryins = "Insert into  dbo.Login_MP_Log(Login_ID,Password,updated_By,updated_date,HostName,DynamicIP,UserAgent,Role)values('" + stid + "','" + mnewpwd + "','" + ip + "',getdate(),'" + HostName + "','" + addr[0].ToString() + "','" + useragent + "','Paddy/Rice')";
                cmd.Connection = con;
