...
public partial class Rate_master : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string qrey = "Select * from dbo.SCSC_MSP_rate where Commodity_ID='" + mcomdty + "'and Scheme_ID='" + scheme + "' and Year='" + myear + "' and Purchase_From='"+ddlsource.SelectedValue +"'";
             ...
             if (ds.Tables[0].Rows.Count==0)
            {
                ...
                string qryInsert = "insert into dbo.SCSC_MSP_rate(Purchase_From,Scheme_ID,Commodity_ID,Crop_Year,M_Season,MSP_rate,Incidental,Bonus,Rate,Gunny_Capacity,Effective_From,Created_By,Created_Date,year)values('" +mpurfrom +"','"+ mscheme  + "','" + mcommdty+ "','" + mcrop + "','" + mseason + "'," + mmsp + "," + minsd + "," + mbonous + "," + rate + "," + mgcap + ",getdate(),'" + dstid + "','" + medate + "','" + year + "'" + ")";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (ddlsource.SelectedItem.Text == "From FCI")
        {
            string update = "Update dbo.SCSC_MSP_rate set MSP_rate=" + rate + ",Rate="+ rate +",Gunny_Capacity=" + gcaps + " where Purchase_From='" + mSource + "' and Commodity_ID='" + mcomdty + "' and Scheme_ID='" + mscheme + "'";
        ...
        else
        {
            ...
            string updatePr = "Update dbo.SCSC_MSP_rate set MSP_rate=" + rate + ",Gunny_Capacity=" + gcaps + ",Incidental=" + incident + ",Bonus=" + bonus + ",Rate="+ mprate +" where Purchase_From='" + mSource + "' and Commodity_ID='" + mcomdty + "' and Scheme_ID='" + mscheme + "'";
