...
public partial class State_Reprint_PDSMOCancelled : System.Web.UI.Page
{
    SqlConnection con;
    SqlDataAdapter da;
    DataSet ds;
    ...
    public void Search()
    {
        ...
        using (con = new SqlConnection(strcon))
        {
            try
            {
                ...
                string select = "SELECT distinct MoveOrdernum FROM StateMovementOrder where CancelledDate between '" + ConvertFromDate + " 00:00:00' and '" + ConvertToDate + " 23:59:59' and IsAccepted='Y' and IsCancelled='Y' order by MoveOrdernum";
