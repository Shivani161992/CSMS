<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/State_MPSCSC.master" AutoEventWireup="true" CodeFile="Reprint_PDSMovementOrder.aspx.cs" Inherits="State_Reprint_PDSMovementOrder" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table align="center" style="width: 600px; border-style: solid; border-width: 1px; text-align: left" border="1" cellspacing="0" cellpadding="6">
        <tr>
            <td colspan="5" style="text-align: center; font-size: large; text-decoration: underline; color: #CC6600; font-weight: bold">Reprint Movement Order</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"><strong>Movement Order Number</strong>
                <asp:DropDownList ID="ddlMvmtNumber" runat="server" Width="150px" Style="margin-left: 10px" AutoPostBack="True" OnSelectedIndexChanged="ddlMvmtNumber_SelectedIndexChanged">
                </asp:DropDownList>
                <asp:HiddenField ID="hdfModeofDispatch" runat="server" />
                <asp:HiddenField ID="hdfSMS_frmDist" runat="server" />
            </td>
            <td>
