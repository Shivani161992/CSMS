<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/State_MPSCSC.master" AutoEventWireup="true" CodeFile="SMSCommodities_SurveyorMaster.aspx.cs" Inherits="State_SMSCommodities_SurveyorMaster" %>
        ...
        <table style="width: 1100px; font-size: 12px;">
            <tr>
                ...
                <td style="text-align: right; width: 200px">
                    <a href="SMSCommodities_SurveyorMaster.aspx" class="sign">&#8635 New
                    </a>
                </td>
            </tr>
