<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FarmerQualityInspection.aspx.cs" Inherits="SurveyorLogin_Uparjan_FarmerQualityInspection" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            $("#<%= txtdateofpurchase.ClientID %> ").datepicker(
              {
                  dateFormat: 'dd-mm-yy'
              }
            );
        ...
        <table style="width: 1100px; font-size: 12px;">
            <tr>
                ...
                <td style="text-align: center; width: 700px">
                    <h2 style="color: #e74c3c; font-size: 20px; font-family: 'Bellefair'; letter-spacing: 4px;">Farmer Quality Inspection</h2>
        ...
        <table class="InspecTable">
            ...
            <tr runat="server" id="trNumber" visible="false">
                <td colspan="3" style="height: 10px;">
                 ...
                 <tr>
                <td class="InspColumn" style="padding-left: 20px; text-align: left">Date Of Purchase 
                    <br />

                     <asp:TextBox ID="txtdateofpurchase" CssClass="insptxt" ReadOnly="true"  runat="server" AutoComplete="off" ></asp:TextBox>

                    <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="txtdateofpurchase" ErrorMessage="RequiredFieldValidator" SetFocusOnError="True">*</asp:RequiredFieldValidator>
             ...
             <tr>
                <td class="InspColumn" style="padding-left: 20px; text-align: left">किसान का कोड
                    <br />

                     <asp:DropDownList ID="ddlfarmercode" runat="server" CssClass="inspddl" OnSelectedIndexChanged="ddlfarmercode_SelectedIndexChanged" AutoPostBack="true">
                    </asp:DropDownList>

                     <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" Style="font-size: 12px;"
                        ControlToValidate="ddlfarmercode" ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>    
                </td>
                <td class="InspColumn" style="padding-left: 20px; text-align: left">
                 किसान का नाम
                    <br />
                    <asp:TextBox ID="txtfarmerName" CssClass="insptxt" runat="server" ReadOnly="true"></asp:TextBox>

                      <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" Style="font-size: 12px;"
                        ControlToValidate="txtfarmerName" ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>
                </td>
                <td class="InspColumn" style="padding-left: 20px; text-align: left">
                  ग्राम
                    <br />
                    <asp:TextBox ID="txtfarmervillage" CssClass="insptxt" runat="server" ReadOnly="true"></asp:TextBox>

                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Style="font-size: 12px;"
                        ControlToValidate="txtfarmervillage" ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>
                </td>
            </tr>
             ...
             <tr>
                ...
                <td class="InspColumn" style="padding-left: 20px; text-align: left">
                 Quantity (Qtls)
                    <br />
                    <asp:TextBox ID="txtqty" CssClass="insptxt" runat="server" ></asp:TextBox>
                ...
                Quality Inspection
                    <br />
                     ...
                     <asp:DropDownList ID="ddlqualityinspection" runat="server" CssClass="inspddl" OnSelectedIndexChanged="ddlqualityinspection_SelectedIndexChanged" AutoPostBack="true">
                   
                                   <asp:ListItem Text="--Select--" Value="0" Selected="True"></asp:ListItem>

                    <asp:ListItem Text="FAQ" Value="FAQ"></asp:ListItem>

                    <asp:ListItem Text="Non FAQ" Value="NonFAQ"></asp:ListItem>   
                          </asp:DropDownList>

                     <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Style="font-size: 12px;"
                        ControlToValidate="ddlqualityinspection" ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>  
                </td>
            </tr>
            <tr>
                <td colspan="3" style="height: 10px;"></td>
            ...
            <tr id="trgram" runat="server" visible="false">
             ...
             <tr>
                                <td colspan="3" style="text-align: center;">
                                                                 <asp:Button ID="btnsubmit" runat="server" Text="Submit" CssClass="bttsub" Visible="true" OnClick="btnsubmit_Click" Enabled="false" />
    </td>
                            </tr>
