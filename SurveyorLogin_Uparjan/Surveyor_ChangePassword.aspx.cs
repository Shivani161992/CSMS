...
public partial class SurveyorLogin_Uparjan_Surveyor_ChangePassword : System.Web.UI.Page
{
    ...
    protected void bttsub_Click(object sender, EventArgs e)
    {
        ...
        Username = Session["user"].ToString();
        string qry = "SELECT Password FROM Uparjan_SurveyorLogin where Username='" + Username + "'";
        ...
        else
        {
            ...
            if (mpwd == moldpwd)
            {
                ...
                string qryupdate = "Update  Uparjan_SurveyorLogin set Password='" + mnewpwd + "' where Username='" + Username + "'";
