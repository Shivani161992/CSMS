<%@ Page Language="C#" AutoEventWireup="true" CodeFile="April.aspx.cs" Inherits="salaryslip_April" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="A4">
            <table align="center" class="auto-style1">
                ...
                <tr>
                    <td style="width:100%; height:40px; text-align:center;">
                         <asp:Image ID="Image1" ImageUrl="~/SalImg/1A.png" Width="750px"  CssClass="image" runat="server" />
                    </td>
                </tr>
                  <tr>
                    <td style="width:100%; height:40px; text-align:center;">
