// For Password TextBoxes
 function checksqlkey_psw(e,tx)
    {     
       ...
       else if (AsciiCode=="36" || AsciiCode=="37" || AsciiCode=="38" || AsciiCode=="40" || AsciiCode=="41" || AsciiCode=="43" || AsciiCode=="92" || AsciiCode=="124" || AsciiCode=="34" || AsciiCode=="39" || AsciiCode=="60" || AsciiCode=="62" || AsciiCode=="64" || AsciiCode=="44" ||  AsciiCode=="61")
        {
...
{	
    ...
    else if (txtval=="$" || txtval=="+" || txtval=="(" || txtval==")" || txtval=="|")
    {
    txt_ctrl.value="";
    alert('Do not use SQL Key-Words, Semi Colon(;) and Special Characters(&,%,$)..etc');
	return false;
